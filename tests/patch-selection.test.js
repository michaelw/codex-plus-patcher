...
test("user message patch applies variant-specific bubble colors with default fallback", () => {
  ...
  assert.match(bubblePlugin, /\[data-codex-plus-user-entry\] \[data-composer-attachment-pill\]\{background-color:color-mix\(in srgb,var\(--codex-plus-user-bubble-light-fg\) 14%,var\(--codex-plus-user-bubble-light-bg\)\)!important.*opacity:1!important/);
  ...
  assert.match(bubblePlugin, /\[data-codex-plus-user-entry\] \[data-composer-attachment-pill\].*background-color:color-mix\(in srgb,var\(--codex-plus-user-bubble-dark-fg\) 14%,var\(--codex-plus-user-bubble-dark-bg\)\)!important.*opacity:1!important/);
