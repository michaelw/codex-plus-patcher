(function () {
  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      required: true,
      styles: ':root[data-codex-plus-sidebar-names-blurred="true"] :is([data-thread-title],[data-codex-plus-sidebar-name],[data-app-action-sidebar-project-row],[data-app-action-sidebar-thread-row]){filter:blur(4px);user-select:none}',
      commands: [
        {
