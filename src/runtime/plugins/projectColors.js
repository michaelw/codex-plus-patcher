  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      styles:
        ...
        ":root:not(.dark):not(.electron-dark) :is([data-app-action-sidebar-thread-row][data-codex-plus-project-sidebar-color],[data-app-action-sidebar-project-list-id][data-codex-plus-project-sidebar-color] [data-app-action-sidebar-thread-row]) [class~=\"bg-token-charts-blue/15\"][class~=\"text-token-charts-blue\"]{background-color:#111827!important;color:#fff!important;opacity:1!important;-webkit-text-fill-color:currentColor!important}" +
        ":is(:root.dark,:root.electron-dark) :is([data-app-action-sidebar-thread-row][data-codex-plus-project-sidebar-color],[data-app-action-sidebar-project-list-id][data-codex-plus-project-sidebar-color] [data-app-action-sidebar-thread-row]) [class~=\"bg-token-charts-blue/15\"][class~=\"text-token-charts-blue\"]{background-color:#f8fafc!important;color:#111827!important;opacity:1!important;-webkit-text-fill-color:currentColor!important}" +
        ":is([data-app-action-sidebar-thread-row][data-codex-plus-project-sidebar-color],[data-app-action-sidebar-project-list-id][data-codex-plus-project-sidebar-color] [data-app-action-sidebar-thread-row]) [class~=\"bg-token-charts-blue/15\"][class~=\"text-token-charts-blue\"] *{color:inherit!important;opacity:1!important;-webkit-text-fill-color:currentColor!important}" +
