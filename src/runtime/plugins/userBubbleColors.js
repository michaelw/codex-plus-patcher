  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      styles:
        ...
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-light-fg)!important;-webkit-text-fill-color:currentColor!important}' +
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill]:is(:hover,:focus-visible,:active,[data-state="open"],[aria-expanded="true"]){background-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-light-fg)!important;-webkit-text-fill-color:currentColor!important}' +
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill] :is([role="button"],[role="button"] span,[class*="bg-token-menu-background"]){background-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 22%,var(--codex-plus-user-bubble-light-bg))!important;color:var(--codex-plus-user-bubble-light-fg)!important;border-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 28%,transparent)!important;-webkit-text-fill-color:currentColor!important}' +
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill] [role="button"]::before{background:linear-gradient(to right,transparent,color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg)) 55%,color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg)))!important}' +
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill] *{color:inherit!important;stroke:currentColor!important;-webkit-text-fill-color:currentColor!important}' +
        ...
        ':root.dark [data-codex-plus-user-entry] :is(button,[role="button"]):is([class*="rounded-full"],[class*="rounded-"]):is([class*="bg-token-foreground"],[class*="bg-token-input"],[class*="bg-token-dropdown"]):not([class*="bg-token-foreground-inverse"]):not([class*="bg-token-foreground-primary"]):not([class*="bg-token-foreground-button"]) *,:root.electron-dark [data-codex-plus-user-entry] :is(button,[role="button"]):is([class*="rounded-full"],[class*="rounded-"]):is([class*="bg-token-foreground"],[class*="bg-token-input"],[class*="bg-token-dropdown"]):not([class*="bg-token-foreground-inverse"]):not([class*="bg-token-foreground-primary"]):not([class*="bg-token-foreground-button"]) *{color:inherit!important;stroke:currentColor!important;-webkit-text-fill-color:currentColor!important}' +
        ':root.dark [data-codex-plus-user-entry] [data-composer-attachment-pill],:root.electron-dark [data-codex-plus-user-entry] [data-composer-attachment-pill]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 14%,var(--codex-plus-user-bubble-dark-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-dark-fg)!important;-webkit-text-fill-color:currentColor!important}' +
        ':root.dark [data-codex-plus-user-entry] [data-composer-attachment-pill]:is(:hover,:focus-visible,:active,[data-state="open"],[aria-expanded="true"]),:root.electron-dark [data-codex-plus-user-entry] [data-composer-attachment-pill]:is(:hover,:focus-visible,:active,[data-state="open"],[aria-expanded="true"]){background-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 14%,var(--codex-plus-user-bubble-dark-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-dark-fg)!important;-webkit-text-fill-color:currentColor!important}' +
        ':root.dark [data-codex-plus-user-entry] [data-composer-attachment-pill] :is([role="button"],[role="button"] span,[class*="bg-token-menu-background"]),:root.electron-dark [data-codex-plus-user-entry] [data-composer-attachment-pill] :is([role="button"],[role="button"] span,[class*="bg-token-menu-background"]){background-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 22%,var(--codex-plus-user-bubble-dark-bg))!important;color:var(--codex-plus-user-bubble-dark-fg)!important;border-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 28%,transparent)!important;-webkit-text-fill-color:currentColor!important}' +
        ...
        ':root.dark [data-codex-plus-user-entry] [data-composer-attachment-pill] *,:root.electron-dark [data-codex-plus-user-entry] [data-composer-attachment-pill] *{color:inherit!important;stroke:currentColor!important;-webkit-text-fill-color:currentColor!important}' +
