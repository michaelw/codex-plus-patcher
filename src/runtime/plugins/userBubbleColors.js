  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      styles:
        ...
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-code-block-toolbar]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-light-fg)!important}' +
        ...
        ':root.dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar],:root.electron-dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 14%,var(--codex-plus-user-bubble-dark-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-dark-fg)!important}' +
