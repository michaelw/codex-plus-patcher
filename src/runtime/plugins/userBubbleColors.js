  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      styles:
        ...
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-attachment-pill]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-light-fg) 14%,var(--codex-plus-user-bubble-light-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-light-fg)!important;opacity:1!important;-webkit-text-fill-color:currentColor!important}' +
        ...
        ':root.dark [data-codex-plus-user-entry] :is(button,[role="button"]):is([class*="rounded-full"],[class*="rounded-"]):is([class*="bg-token-foreground"],[class*="bg-token-input"],[class*="bg-token-dropdown"]):not([class*="bg-token-foreground-inverse"]):not([class*="bg-token-foreground-primary"]):not([class*="bg-token-foreground-button"]) *,:root.electron-dark [data-codex-plus-user-entry] :is(button,[role="button"]):is([class*="rounded-full"],[class*="rounded-"]):is([class*="bg-token-foreground"],[class*="bg-token-input"],[class*="bg-token-dropdown"]):not([class*="bg-token-foreground-inverse"]):not([class*="bg-token-foreground-primary"]):not([class*="bg-token-foreground-button"]) *{color:inherit!important;stroke:currentColor!important;-webkit-text-fill-color:currentColor!important}' +
        ':root.dark [data-codex-plus-user-entry] [data-composer-attachment-pill],:root.electron-dark [data-codex-plus-user-entry] [data-composer-attachment-pill]{background-color:color-mix(in srgb,var(--codex-plus-user-bubble-dark-fg) 14%,var(--codex-plus-user-bubble-dark-bg))!important;background-image:none!important;color:var(--codex-plus-user-bubble-dark-fg)!important;opacity:1!important;-webkit-text-fill-color:currentColor!important}' +
