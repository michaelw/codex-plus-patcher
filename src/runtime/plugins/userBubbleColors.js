  ...
  CodexPlus.registerPlugin(
    CodexPlus.definePlugin({
      ...
      styles:
        ...
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-code-block-toolbar]{background-color:var(--codex-plus-user-bubble-light-bg)!important;background-image:none!important;color:var(--codex-plus-user-bubble-light-fg)!important}' +
        ':root:not(.dark):not(.electron-dark) [data-codex-plus-user-entry] [data-composer-code-block-toolbar] button{background-color:var(--codex-plus-user-bubble-light-bg)!important;background-image:none!important;color:inherit!important;-webkit-text-fill-color:currentColor!important}' +
        ...
        ':root.dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar],:root.electron-dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar]{background-color:var(--codex-plus-user-bubble-dark-bg)!important;background-image:none!important;color:var(--codex-plus-user-bubble-dark-fg)!important}' +
        ':root.dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar] button,:root.electron-dark [data-codex-plus-user-entry] [data-composer-code-block-toolbar] button{background-color:var(--codex-plus-user-bubble-dark-bg)!important;background-image:none!important;color:inherit!important;-webkit-text-fill-color:currentColor!important}' +
