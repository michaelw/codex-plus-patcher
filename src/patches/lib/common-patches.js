...
const { composerSurfaceElementHook, messageComposerHook } = require("./hooks/message-composer");
...
function buildCodexPlusPatchSet(config) {
  ...
  const oldTitle = config.anchors?.title || "<title>Codex</title>";
...
function patchAboutDialog(text, context = {}) {
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),a=l.app.getVersion(),o=AFe(a),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,a=l.app.getVersion(),o=AFe(a),`,
      "901.20858 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "g=d.formatMessage({messageId:wFe,defaultMessage:TFe}),_=[`Powered by Codex & OWL`,h,...jFe(a)].join(`\n`),",
      "g=d.formatMessage({messageId:wFe,defaultMessage:TFe}),CPXAboutLines=CPXAbout.buildInfoLines,_=[`Powered by Codex & OWL`,h,...jFe(a),...CPXAboutLines].join(`\n`),",
      "901.20858 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "PFe({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "PFe({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "901.20858 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function PFe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function PFe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" + aboutMetadataRequire() + ",q=CPXAboutMetadata.disclaimerMarkup({escape:xz.default,heading:D,body:O}),s=r==null?``:",
      "901.20858 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "901.20858 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "901.20858 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "901.20858 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,xz.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,xz.default)(t)}">${(0,xz.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,xz.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,xz.default)(t)}">${(0,xz.default)(n)}</pre>',
      "901.20858 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),a=l.app.getVersion(),o=kFe(a),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,a=l.app.getVersion(),o=kFe(a),`,
      "901.41600 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "g=d.formatMessage({messageId:CFe,defaultMessage:wFe}),_=[`Powered by Codex & OWL`,h,...AFe(a)].join(`\n`),",
      "g=d.formatMessage({messageId:CFe,defaultMessage:wFe}),CPXAboutLines=CPXAbout.buildInfoLines,_=[`Powered by Codex & OWL`,h,...AFe(a),...CPXAboutLines].join(`\n`),",
      "901.41600 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "NFe({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "NFe({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "901.41600 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function NFe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function NFe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" + aboutMetadataRequire() + ",q=CPXAboutMetadata.disclaimerMarkup({escape:Sz.default,heading:D,body:O}),s=r==null?``:",
      "901.41600 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "901.41600 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "901.41600 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "901.41600 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,Sz.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,Sz.default)(t)}">${(0,Sz.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,Sz.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,Sz.default)(t)}">${(0,Sz.default)(n)}</pre>',
      "901.41600 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),a=l.app.getVersion(),o=pAe(a),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,a=l.app.getVersion(),o=pAe(a),`,
      "41651 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "g=d.formatMessage({messageId:sAe,defaultMessage:cAe}),_=[`Powered by Codex & OWL`,h,...mAe(a)].join(`\n`),",
      "g=d.formatMessage({messageId:sAe,defaultMessage:cAe}),CPXAboutLines=CPXAbout.buildInfoLines,_=[`Powered by Codex & OWL`,h,...mAe(a),...CPXAboutLines].join(`\n`),",
      "41651 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "_Ae({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "_Ae({appDisplayName:i,buildInfoLabel:g,buildInfoText:_,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:f.htmlIconDataUrl,isDark:y,okLabel:m,title:p})",
      "41651 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function _Ae({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function _Ae({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" + aboutMetadataRequire() + ",q=CPXAboutMetadata.disclaimerMarkup({escape:ML.default,heading:D,body:O}),s=r==null?``:",
      "41651 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "41651 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "41651 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "41651 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,ML.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,ML.default)(t)}">${(0,ML.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,ML.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,ML.default)(t)}">${(0,ML.default)(n)}</pre>',
      "41651 about dialog disclaimer insertion anchor",
    );
  }
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=GDe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=GDe(o),`,
      "41705 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:zDe,defaultMessage:BDe}),v=KDe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:zDe,defaultMessage:BDe}),v=KDe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "41705 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "YDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "YDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "41705 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function YDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function YDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:yU.default,heading:D,body:O}),s=r==null?``:",
      "41705 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "41705 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "41705 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "41705 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,yU.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,yU.default)(t)}">${(0,yU.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,yU.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,yU.default)(t)}">${(0,yU.default)(n)}</pre>',
      "41705 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(
      ...
      "let i=l.app.getName(),o=l.app.getVersion(),s=UDe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=UDe(o),`,
      "21641 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:LDe,defaultMessage:RDe}),v=WDe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:LDe,defaultMessage:RDe}),v=WDe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "21641 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "qDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "qDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "21641 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function qDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function qDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:_U.default,heading:D,body:O}),s=r==null?``:",
      "21641 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "21641 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "21641 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "21641 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,_U.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,_U.default)(t)}">${(0,_U.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,_U.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,_U.default)(t)}">${(0,_U.default)(n)}</pre>',
      "21641 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41957")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=EDe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=EDe(o),`,
      "41957 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:bDe,defaultMessage:xDe}),v=DDe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:bDe,defaultMessage:xDe}),v=DDe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "41957 about dialog build information anchor",
    );
    patched = replaceOnce(patched, "ADe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})", "ADe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})", "41957 about dialog renderer call anchor");
    patched = replaceOnce(
      patched,
      "function ADe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function ADe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" + aboutMetadataRequire() + ",q=CPXAboutMetadata.disclaimerMarkup({escape:jU.default,heading:D,body:O}),s=r==null?``:",
      "41957 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "41957 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "41957 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "41957 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,jU.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,jU.default)(t)}">${(0,jU.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,jU.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,jU.default)(t)}">${(0,jU.default)(n)}</pre>',
      "41957 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(
      ...
      "let i=l.app.getName(),o=l.app.getVersion(),s=gDe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=gDe(o),`,
      "41407 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:uDe,defaultMessage:dDe}),v=_De(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:uDe,defaultMessage:dDe}),v=_De(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "41407 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "bDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "bDe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "41407 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function bDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function bDe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:bU.default,heading:D,body:O}),s=r==null?``:",
      "41407 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "41407 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "41407 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "41407 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,bU.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,bU.default)(t)}">${(0,bU.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,bU.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,bU.default)(t)}">${(0,bU.default)(n)}</pre>',
      "41407 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=OEe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=OEe(o),`,
      "52044 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:SEe,defaultMessage:CEe}),v=kEe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:SEe,defaultMessage:CEe}),v=kEe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "52044 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "MEe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "MEe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "52044 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function MEe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function MEe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:vU.default,heading:D,body:O}),s=r==null?``:",
      "52044 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "52044 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "52044 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "52044 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,vU.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,vU.default)(t)}">${(0,vU.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,vU.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,vU.default)(t)}">${(0,vU.default)(n)}</pre>',
      "52044 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=OSe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=OSe(o),`,
      "41515 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:SSe,defaultMessage:CSe}),v=kSe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:SSe,defaultMessage:CSe}),v=kSe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "41515 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "MSe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "MSe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "41515 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function MSe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function MSe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:oU.default,heading:D,body:O}),s=r==null?``:",
      "41515 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "41515 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "41515 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "41515 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,oU.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,oU.default)(t)}">${(0,oU.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,oU.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,oU.default)(t)}">${(0,oU.default)(n)}</pre>',
      "41515 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=Yxe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=Yxe(o),`,
      "61309 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:Uxe,defaultMessage:Wxe}),v=Xxe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:Uxe,defaultMessage:Wxe}),v=Xxe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "61309 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "$xe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "$xe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "61309 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function $xe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function $xe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:YH.default,heading:D,body:O}),s=r==null?``:",
      "61309 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "61309 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "61309 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "61309 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,YH.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,YH.default)(t)}">${(0,YH.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,YH.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,YH.default)(t)}">${(0,YH.default)(n)}</pre>',
      "61309 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "let i=l.app.getName(),o=l.app.getVersion(),s=ixe(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),i=CPXAbout.appDisplayName,o=l.app.getVersion(),s=ixe(o),`,
      "40816 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:Qbe,defaultMessage:$be}),v=axe(o),y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:Qbe,defaultMessage:$be}),v=axe(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...a.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "40816 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "cxe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "cxe({appDisplayName:i,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "40816 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function cxe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function cxe({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:SH.default,heading:D,body:O}),s=r==null?``:",
      "40816 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "40816 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "40816 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "40816 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,SH.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,SH.default)(t)}">${(0,SH.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,SH.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,SH.default)(t)}">${(0,SH.default)(n)}</pre>',
      "40816 about dialog disclaimer insertion anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "let r=l.app.getName(),o=l.app.getVersion(),s=e_e(o),",
      `let CPXAbout=${aboutMetadataRequire()}.aboutPayload(${JSON.stringify(aboutContext)}),r=CPXAbout.appDisplayName,o=l.app.getVersion(),s=e_e(o),`,
      "30844 about dialog app name anchor",
    );
    patched = replaceOnce(
      patched,
      "_=f.formatMessage({messageId:Jge,defaultMessage:Yge}),v=t_e(o),y=[...i.o()?[`Powered by Codex & OWL`]:[],g,...v].join(`\n`),",
      "_=f.formatMessage({messageId:Jge,defaultMessage:Yge}),v=t_e(o),CPXAboutLines=CPXAbout.buildInfoLines,y=[...i.o()?[`Powered by Codex & OWL`]:[],g,...v,...CPXAboutLines].join(`\n`),",
      "30844 about dialog build information anchor",
    );
    patched = replaceOnce(
      patched,
      "i_e({appDisplayName:r,buildInfoLabel:_,buildInfoText:y,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "i_e({appDisplayName:r,buildInfoLabel:_,buildInfoText:y,codexPlusDisclaimerHeading:CPXAbout.disclaimerHeading,codexPlusDisclaimerBody:CPXAbout.disclaimerBody,iconDataUrl:p.htmlIconDataUrl,isDark:x,okLabel:h,title:m})",
      "30844 about dialog renderer call anchor",
    );
    patched = replaceOnce(
      patched,
      "function i_e({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let s=r==null?``:",
      "function i_e({appDisplayName:e,buildInfoLabel:t,buildInfoText:n,codexPlusDisclaimerHeading:D,codexPlusDisclaimerBody:O,iconDataUrl:r,isDark:i,okLabel:a,title:o}){let CPXAboutMetadata=" +
        aboutMetadataRequire() +
        ",q=CPXAboutMetadata.disclaimerMarkup({escape:AB.default,heading:D,body:O}),s=r==null?``:",
      "30844 about dialog renderer signature anchor",
    );
    patched = replaceOnce(patched, "    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "${CPXAboutMetadata.disclaimerStyles()}\n\n    .build-info {\n      width: 100%;\n      margin: 0;\n      line-height: 1.45;", "30844 about dialog disclaimer styles anchor");
    patched = replaceOnce(patched, "      color: var(--muted-text);\n      white-space: pre-wrap;", "      color: var(--muted-text);\n      text-align: left;\n      white-space: pre-wrap;", "30844 about dialog build info left align anchor");
    patched = replaceOnce(patched, "    .app-name,\n    .build-info,\n    .copyright {", "    .app-name,\n    .codex-plus-disclaimer,\n    .build-info,\n    .copyright {", "30844 about dialog selectable disclaimer anchor");
    return replaceOnce(
      patched,
      '      <div class="app-name" id="app-name">${(0,AB.default)(e)}</div>\n      <pre class="build-info" aria-label="${(0,AB.default)(t)}">${(0,AB.default)(n)}</pre>',
      '      <div class="app-name" id="app-name">${(0,AB.default)(e)}</div>\n      ${q}\n      <pre class="build-info" aria-label="${(0,AB.default)(t)}">${(0,AB.default)(n)}</pre>',
      "30844 about dialog disclaimer insertion anchor",
    );
  }
...
function patchWorker(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(text, "var L0=`Git is unavailable`,", `${workerHook()}var L0=\`Git is unavailable\`,`, "901.41600 worker helper insertion anchor");
    patched = replaceOnce(patched, "function G0({requestKind:e,source:t}){return Oue.has(e??``)||Aue(t)}", "function G0({requestKind:e,source:t}){return Oue.has(e??``)||Aue(t)||CPXW.isReadOnlyBranchRequest(e,t)}", "901.41600 branch picker git allowlist anchor");
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await fB(Yme(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await hhe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await fB(Yme(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,hhe));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await hhe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "901.41600 repository-targets worker switch anchor",
    );
    return replaceOnce(patched, "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:", "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:", "901.41600 repository-targets worker readonly method anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "var q0=`Git is unavailable`,", `${workerHook()}var q0=\`Git is unavailable\`,`, "41651 worker helper insertion anchor");
    patched = replaceOnce(patched, "function t2({requestKind:e,source:t}){return Cle.has(e??``)||Tle(t)}", "function t2({requestKind:e,source:t}){return Cle.has(e??``)||Tle(t)||CPXW.isReadOnlyBranchRequest(e,t)}", "41651 branch picker git allowlist anchor");
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await kB(Wpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await ume(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await kB(Wpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,ume));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await ume(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "41651 repository-targets worker switch anchor",
    );
    return replaceOnce(patched, "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:", "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:", "41651 repository-targets worker readonly method anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "var n2=`Git is unavailable`,", `${workerHook()}var n2=\`Git is unavailable\`,`, "21641 worker helper insertion anchor");
    patched = replaceOnce(patched, "function u2({requestKind:e,source:t}){return Lce.has(e??``)||zce(t)}", "function u2({requestKind:e,source:t}){return Lce.has(e??``)||zce(t)||CPXW.isReadOnlyBranchRequest(e,t)}", "21641 branch picker git allowlist anchor");
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await oV(rpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await Spe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await oV(rpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,Spe));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await Spe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "21641 repository-targets worker switch anchor",
    );
    return replaceOnce(patched, "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:", "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:", "21641 repository-targets worker readonly method anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "var t2=`Git is unavailable`,", `${workerHook()}var t2=\`Git is unavailable\`,`, "41407 worker helper insertion anchor");
    patched = replaceOnce(patched, "function l2({requestKind:e,source:t}){return Rce.has(e??``)||Bce(t)}", "function l2({requestKind:e,source:t}){return Rce.has(e??``)||Bce(t)||CPXW.isReadOnlyBranchRequest(e,t)}", "41407 branch picker git allowlist anchor");
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await aV(ipe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await Cpe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await aV(ipe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,Cpe));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await Cpe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "41407 repository-targets worker switch anchor",
    );
    return replaceOnce(patched, "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:", "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:", "41407 repository-targets worker readonly method anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "var a2=`Git is unavailable`,",
      `${workerHook()}var a2=\`Git is unavailable\`,`,
      "52044 worker helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "function p2({requestKind:e,source:t}){return Mce.has(e??``)||Pce(t)}",
      "function p2({requestKind:e,source:t}){return Mce.has(e??``)||Pce(t)||CPXW.isReadOnlyBranchRequest(e,t)}",
      "52044 branch picker git allowlist anchor",
    );
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await rV(Jfe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await ppe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await rV(Jfe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,ppe));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await ppe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "52044 repository-targets worker switch anchor",
    );
    return replaceOnce(
      patched,
      ...
      "52044 repository-targets worker readonly method anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "var d2=`Git is unavailable`,",
      `${workerHook()}var d2=\`Git is unavailable\`,`,
      "41515 worker helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "function y2({requestKind:e,source:t}){return gce.has(e??``)||vce(t)}",
      "function y2({requestKind:e,source:t}){return gce.has(e??``)||vce(t)||CPXW.isReadOnlyBranchRequest(e,t)}",
      "41515 branch picker git allowlist anchor",
    );
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=Z(await _G(hpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=Z({paths:await Ppe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=Z(await _G(hpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=Z(CPXW.traceRequest(e.params));break;case`repository-targets`:p=Z(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,Ppe));break;case`codex-plus-branches`:p=Z(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=Z(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=Z({paths:await Ppe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "41515 repository-targets worker switch anchor",
    );
    return replaceOnce(
      patched,
      "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:",
      "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:",
      "41515 repository-targets worker readonly method anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${workerHook()}var u2=\`Git is unavailable\`,`,
      "61309 worker helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "function v2({requestKind:e,source:t}){return pce.has(e??``)||hce(t)}",
      "function v2({requestKind:e,source:t}){return pce.has(e??``)||hce(t)||CPXW.isReadOnlyBranchRequest(e,t)}",
      "61309 branch picker git allowlist anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "case`commit-message-diff`:p=Z(await g3(fpe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=Z(CPXW.traceRequest(e.params));break;case`repository-targets`:p=Z(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,jpe));break;case`codex-plus-branches`:p=Z(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=Z(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=Z({paths:await jpe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "61309 repository-targets worker switch anchor",
    );
    return replaceOnce(
      patched,
      "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:",
      "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:",
      "61309 repository-targets worker readonly method anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "var g2=`Git is unavailable`,",
      `${workerHook()}var g2=\`Git is unavailable\`,`,
      "40816 worker helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "function S2({requestKind:e,source:t}){return ace.has(e??``)||sce(t)}",
      "function S2({requestKind:e,source:t}){return ace.has(e??``)||sce(t)||CPXW.isReadOnlyBranchRequest(e,t)}",
      "40816 branch picker git allowlist anchor",
    );
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=Z(await b3(ipe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=Z({paths:await Cpe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=Z(await b3(ipe(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=Z(CPXW.traceRequest(e.params));break;case`repository-targets`:p=Z(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,Cpe));break;case`codex-plus-branches`:p=Z(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=Z(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=Z({paths:await Cpe(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "40816 repository-targets worker switch anchor",
    );
    return replaceOnce(
      patched,
      "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:",
      "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:",
      "40816 repository-targets worker readonly method anchor",
    );
  }
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "var P0=`Git is unavailable`,",
      `${workerHook()}var P0=\`Git is unavailable\`,`,
      "30844 worker helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "function W0({requestKind:e,source:t}){return B0.has(e??``)||G0(t)}",
      "function W0({requestKind:e,source:t}){return B0.has(e??``)||G0(t)||CPXW.isReadOnlyBranchRequest(e,t)}",
      "30844 branch picker git allowlist anchor",
    );
    patched = replaceOnce(
      patched,
      "case`commit-message-diff`:p=X(await z3(Jle(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`submodule-paths`:p=X({paths:await pue(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "case`commit-message-diff`:p=X(await z3(Jle(e.params.cwd,e.params.includeUnstaged,this.gitManager,o),i.signal));break;case`codex-plus-trace`:p=X(CPXW.traceRequest(e.params));break;case`repository-targets`:p=X(await CPXW.repositoryTargetsFromHost(this.gitManager,e.params,o,i.signal,pue));break;case`codex-plus-branches`:p=X(await CPXW.listBranches(e.params,i.signal));break;case`codex-plus-current-branch`:p=X(await CPXW.currentBranch(e.params,i.signal));break;case`submodule-paths`:p=X({paths:await pue(this.gitManager.getWorktreeRepositoryForRoot(e.params.root,o),i.signal)});break;",
      "30844 repository-targets worker switch anchor",
    );
    return replaceOnce(
      patched,
      "case`review-patch`:case`commit-message-diff`:case`submodule-paths`:case`cat-file`:",
      "case`review-patch`:case`commit-message-diff`:case`codex-plus-trace`:case`repository-targets`:case`codex-plus-branches`:case`codex-plus-current-branch`:case`submodule-paths`:case`cat-file`:",
      "30844 repository-targets worker readonly method anchor",
    );
  }
...
function patchThreadSidePanelTabs(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(text, "function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[$,gs,null,null,null,null,null,null,null,null,null,_o,null,null,null,null,null,Or,o,u,Ur]")}function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "901.20858 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,$.jsx)(tr,{children:(0,$.jsx)(_o,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,$.jsx)(tr,{children:(0,$.jsx)(CPXRM,{mainReviewContent:(0,$.jsx)(_o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "901.20858 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(text, "function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[$,ho,null,null,null,null,null,null,null,null,null,vo,null,null,null,null,null,Or,c,f,Wr]")}function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "901.22334 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,$.jsx)(nr,{children:(0,$.jsx)(vo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,$.jsx)(nr,{children:(0,$.jsx)(CPXRM,{mainReviewContent:(0,$.jsx)(vo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "901.22334 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(text, "function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[$,gs,null,null,null,null,null,null,null,null,null,_o,null,null,null,null,null,Or,T,c,Ur]")}function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "901.31953 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,$.jsx)(tr,{children:(0,$.jsx)(_o,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,$.jsx)(tr,{children:(0,$.jsx)(CPXRM,{mainReviewContent:(0,$.jsx)(_o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "901.31953 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(text, "function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[$,go,null,null,null,null,null,null,null,null,null,yo,null,null,null,null,null,Ar,P,o,Gr]")}function Ms(e){let t=(0,Rs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "901.41600 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,$.jsx)(ir,{children:(0,$.jsx)(yo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,$.jsx)(ir,{children:(0,$.jsx)(CPXRM,{mainReviewContent:(0,$.jsx)(yo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "901.41600 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(text, importAnchor, `${importAnchor}import{t as CPXBranchPickerDropdownContent}from"./${branchPickerDropdownContentFile}";`, "61809 review dependency import anchor");
    patched = replaceOnce(patched, "function N1s(e){let t=(0,z1s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[u1,FWs,null,null,null,null,null,null,null,null,null,RWs,null,null,null,null,null,CPXBranchPickerDropdownContent,Iva,SO,yHs]")}function N1s(e){let t=(0,z1s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "61809 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,u1.jsx)(cAi,{children:(0,u1.jsx)(RWs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,u1.jsx)(cAi,{children:(0,u1.jsx)(CPXRM,{mainReviewContent:(0,u1.jsx)(RWs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "61809 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(text, importAnchor, `${importAnchor}import{t as CPXBranchPickerDropdownContent}from"./${branchPickerDropdownContentFile}";`, "22352 review dependency import anchor");
    patched = replaceOnce(patched, "function t$s(e){let t=(0,s$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[s1,rUs,null,null,null,null,null,null,null,null,null,oUs,null,null,null,null,null,CPXBranchPickerDropdownContent,m_a,MO,VBs]")}function t$s(e){let t=(0,s$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "22352 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,s1.jsx)(FOi,{children:(0,s1.jsx)(oUs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,s1.jsx)(FOi,{children:(0,s1.jsx)(CPXRM,{mainReviewContent:(0,s1.jsx)(oUs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "22352 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(text, importAnchor, `${importAnchor}import{t as CPXBranchPickerDropdownContent}from"./${branchPickerDropdownContentFile}";`, "31338 review dependency import anchor");
    patched = replaceOnce(patched, "function c$s(e){let t=(0,m$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[s1,aUs,null,null,null,null,null,null,null,null,null,pUs,null,null,null,null,null,CPXBranchPickerDropdownContent,l_a,EO,JBs]")}function c$s(e){let t=(0,m$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "31338 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,s1.jsx)(zOi,{children:(0,s1.jsx)(pUs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,s1.jsx)(zOi,{children:(0,s1.jsx)(CPXRM,{mainReviewContent:(0,s1.jsx)(pUs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "31338 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(text, importAnchor, `${importAnchor}import{t as CPXBranchPickerDropdownContent}from"./${branchPickerDropdownContentFile}";`, "32112 review dependency import anchor");
    patched = replaceOnce(patched, "function l$s(e){let t=(0,h$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[o1,oUs,null,null,null,null,null,null,null,null,null,mUs,null,null,null,null,null,CPXBranchPickerDropdownContent,h_a,kO,YBs]")}function l$s(e){let t=(0,h$s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "32112 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,o1.jsx)(LOi,{children:(0,o1.jsx)(mUs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,o1.jsx)(LOi,{children:(0,o1.jsx)(CPXRM,{mainReviewContent:(0,o1.jsx)(mUs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "32112 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(text, importAnchor, `${importAnchor}import{t as CPXBranchPickerDropdownContent}from"./${branchPickerDropdownContentFile}";`, "41705 review dependency import anchor");
    patched = replaceOnce(patched, "function j1s(e){let t=(0,L1s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[u1,OWs,null,null,null,null,null,null,null,null,null,IWs,null,null,null,null,null,CPXBranchPickerDropdownContent,Pva,SO,_Hs]")}function j1s(e){let t=(0,L1s.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "41705 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,u1.jsx)(oAi,{children:(0,u1.jsx)(IWs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,u1.jsx)(oAi,{children:(0,u1.jsx)(CPXRM,{mainReviewContent:(0,u1.jsx)(IWs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "41705 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    const importAnchor = 'import{a as e,i as t,n,o as r,r as i,t as a}from"./rolldown-runtime-DAXXjFlN.js";';
    let patched = replaceOnce(
      ...
      "21641 review dependency import anchor",
    );
    patched = replaceOnce(patched, "function oQs(e){let t=(0,fQs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[o1,rHs,null,null,null,null,null,null,null,null,null,dHs,null,null,null,null,null,CPXBranchPickerDropdownContent,o_a,jO,Kzs]")}function oQs(e){let t=(0,fQs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "21641 review host hook insertion anchor");
    return replaceOnce(
      patched,
      "c=(0,o1.jsx)(AOi,{children:(0,o1.jsx)(dHs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,o1.jsx)(AOi,{children:(0,o1.jsx)(CPXRM,{mainReviewContent:(0,o1.jsx)(dHs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "21641 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function nzs(e){let t=(0,czs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", `${reviewHook("[F$,fzs,null,null,null,null,null,null,null,null,null,KDs,null,null,null,null,null,bLs,Ffa,CF,ETs]")}function nzs(e){let t=(0,czs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`, "41407 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,F$.jsx)(tTi,{children:(0,F$.jsx)(KDs,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,F$.jsx)(tTi,{children:(0,F$.jsx)(CPXRM,{mainReviewContent:(0,F$.jsx)(KDs,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "41407 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function x4o(e){let t=(0,T4o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", "var CPXRM=e=>self.CodexPlusHost.adapters.review.renderBodyFromHost(e,[H$,xKo,null,null,null,null,null,null,null,null,null,xqo,null,null,null,null,null,null,null,dB,dWo]);function x4o(e){let t=(0,T4o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", "26.803.61601 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,H$.jsx)(NZa,{children:(0,H$.jsx)(wKo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,H$.jsx)(NZa,{children:(0,H$.jsx)(CPXRM,{mainReviewContent:(0,H$.jsx)(wKo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "26.803.61601 review body mux anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function qls(e){let t=(0,$ls.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", "var CPXRM=e=>self.CodexPlusHost.adapters.review.renderBodyFromHost(e,[E$,xQ,null,null,null,null,null,null,null,null,null,M7o,null,null,null,null,null,null,null,GB,p8o]);function qls(e){let t=(0,$ls.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e", "26.810.41047 review host hook insertion anchor");
    return replaceOnce(patched, "c=(0,E$.jsx)(aOa,{children:(0,E$.jsx)(M7o,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "c=(0,E$.jsx)(aOa,{children:(0,E$.jsx)(CPXRM,{mainReviewContent:(0,E$.jsx)(M7o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];", "26.810.41047 review body mux anchor");
  }
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    ...
    return replaceOnce(
      ...
      "c=(0,xQ.jsx)(LOa,{children:(0,xQ.jsx)(CPXRM,{mainReviewContent:(0,xQ.jsx)(R9o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "52044 review body mux anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      ...
      `${reviewHook("[H$,gKo,null,null,null,null,null,null,null,null,null,yKo,null,null,null,null,null,null,null,_B,oWo]")}function S4o(e){let t=(0,E4o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "81509 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,H$.jsx)(OZa,{children:(0,H$.jsx)(yKo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,H$.jsx)(OZa,{children:(0,H$.jsx)(CPXRM,{mainReviewContent:(0,H$.jsx)(yKo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "81509 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function l3o(e){let t=(0,p3o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e",
      `${reviewHook("[e$,vqo,null,null,null,null,null,null,null,null,null,xqo,null,null,null,null,null,null,null,aB,cGo]")}function l3o(e){let t=(0,p3o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "41515 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,e$.jsx)(AQa,{children:(0,e$.jsx)(xqo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,e$.jsx)(AQa,{children:(0,e$.jsx)(CPXRM,{mainReviewContent:(0,e$.jsx)(xqo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "41515 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function wes(e){let t=(0,Des.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e",
      `${reviewHook("[Uq,OQo,null,null,null,null,null,null,null,null,null,jQo,null,null,null,null,null,null,null,RI,_Xo]")}function wes(e){let t=(0,Des.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "61639 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,Uq.jsx)(Y7a,{children:(0,Uq.jsx)(jQo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,Uq.jsx)(Y7a,{children:(0,Uq.jsx)(CPXRM,{mainReviewContent:(0,Uq.jsx)(jQo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "61639 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${reviewHook("[Wq,EQo,null,null,null,null,null,null,null,null,null,kQo,null,null,null,null,null,null,null,RI,hXo]")}function Ses(e){let t=(0,Tes.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "61309 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,Wq.jsx)(K7a,{children:(0,Wq.jsx)(kQo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,Wq.jsx)(K7a,{children:(0,Wq.jsx)(CPXRM,{mainReviewContent:(0,Wq.jsx)(kQo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "61309 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function zrs(e){let t=(0,Hrs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e",
      `${reviewHook("[wJ,T2o,null,null,null,null,null,null,null,null,null,O2o,null,null,null,null,null,null,null,cI,m1o]")}function zrs(e){let t=(0,Hrs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "51351 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,wJ.jsx)(Seo,{children:(0,wJ.jsx)(O2o,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,wJ.jsx)(Seo,{children:(0,wJ.jsx)(CPXRM,{mainReviewContent:(0,wJ.jsx)(O2o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "51351 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function Rrs(e){let t=(0,Vrs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e",
      `${reviewHook("[TJ,w2o,null,null,null,null,null,null,null,null,null,D2o,null,null,null,null,null,null,null,uI,p1o]")}function Rrs(e){let t=(0,Vrs.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "40816 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,TJ.jsx)(xeo,{children:(0,TJ.jsx)(D2o,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,TJ.jsx)(xeo,{children:(0,TJ.jsx)(CPXRM,{mainReviewContent:(0,TJ.jsx)(D2o,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "40816 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function x$o(e){let t=(0,w$o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e",
      `${reviewHook("[kY,sHo,null,null,null,null,null,null,null,null,null,uHo,null,null,null,null,null,null,null,WI,Xzo]")}function x$o(e){let t=(0,w$o.c)(16),{expandedActionsPortalTarget:n,setTabState:r,tabState:i}=e`,
      "30844 review host hook insertion anchor",
    );
    return replaceOnce(
      patched,
      "c=(0,kY.jsx)(XZa,{children:(0,kY.jsx)(uHo,{diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "c=(0,kY.jsx)(XZa,{children:(0,kY.jsx)(CPXRM,{mainReviewContent:(0,kY.jsx)(uHo,{diffMode:a,setTabState:r,tabState:i}),diffMode:a,setTabState:r,tabState:i})}),t[2]=a,t[3]=r,t[4]=i,t[5]=c):c=t[5];",
      "30844 review body mux anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31925")) {
    let patched = replaceOnce(
...
function patchAppShell(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    return replaceOnce(text, "function pBa(e){let t=(0,mBa.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function pBa(e){let t=(0,mBa.c)(9),{resetError:n}=e`, "901.20858 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    return replaceOnce(text, "function EBa(e){let t=(0,DBa.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function EBa(e){let t=(0,DBa.c)(9),{resetError:n}=e`, "901.22334 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    return replaceOnce(text, "function KBa(e){let t=(0,qBa.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function KBa(e){let t=(0,qBa.c)(9),{resetError:n}=e`, "901.31953 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    return replaceOnce(text, "function YBa(e){let t=(0,XBa.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function YBa(e){let t=(0,XBa.c)(9),{resetError:n}=e`, "901.41600 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    return replaceOnce(text, "function waa(e){let t=(0,Taa.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function waa(e){let t=(0,Taa.c)(9),{resetError:n}=e`, "41651 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    return replaceOnce(text, "function Gqi(e){let t=(0,Kqi.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function Gqi(e){let t=(0,Kqi.c)(9),{resetError:n}=e`, "61809 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    return replaceOnce(text, "function xKi(e){let t=(0,SKi.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function xKi(e){let t=(0,SKi.c)(9),{resetError:n}=e`, "22352 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    return replaceOnce(text, "function gKi(e){let t=(0,_Ki.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function gKi(e){let t=(0,_Ki.c)(9),{resetError:n}=e`, "31338 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    return replaceOnce(text, "function CKi(e){let t=(0,wKi.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function CKi(e){let t=(0,wKi.c)(9),{resetError:n}=e`, "32112 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    return replaceOnce(text, "function q1a(e){let t=(0,Y1a.c)(4),{onRetry:n}=e", `${diagnosticDetailsHook()}function q1a(e){let t=(0,Y1a.c)(4),{onRetry:n}=e`, "41705 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    return replaceOnce(text, "function pKi(e){let t=(0,mKi.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function pKi(e){let t=(0,mKi.c)(9),{resetError:n}=e`, "21641 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(text, "function HHi(e){let t=(0,UHi.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function HHi(e){let t=(0,UHi.c)(9),{resetError:n}=e`, "41407 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    return replaceOnce(text, "function pbr(e){let t=(0,mbr.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function pbr(e){let t=(0,mbr.c)(9),{resetError:n}=e`, "26.803.61601 app shell error fallback prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    return replaceOnce(text, "function xFr(e){let t=(0,SFr.c)(9),{resetError:n}=e", `${diagnosticDetailsHook()}function xFr(e){let t=(0,SFr.c)(9),{resetError:n}=e`, "26.810.41047 app shell error fallback prop anchor");
  }
  text = patchLocalThreadCatalogBootstrap(text);
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    return replaceOnce(
      text,
      "function KFr(e){let t=(0,qFr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function KFr(e){let t=(0,qFr.c)(9),{resetError:n}=e`,
      "52044 app shell error fallback prop anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    return replaceOnce(
      text,
      "function Jyr(e){let t=(0,Yyr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function Jyr(e){let t=(0,Yyr.c)(9),{resetError:n}=e`,
      "81509 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    return replaceOnce(
      text,
      "function mbr(e){let t=(0,hbr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function mbr(e){let t=(0,hbr.c)(9),{resetError:n}=e`,
      "41515 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    return replaceOnce(
      text,
      "function mjr(e){let t=(0,hjr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function mjr(e){let t=(0,hjr.c)(9),{resetError:n}=e`,
      "61639 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    return replaceOnce(
      ...
      `${diagnosticDetailsHook()}function _jr(e){let t=(0,vjr.c)(9),{resetError:n}=e`,
      "61309 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    return replaceOnce(
      text,
      "function hjr(e){let t=(0,gjr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function hjr(e){let t=(0,gjr.c)(9),{resetError:n}=e`,
      "51351 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    return replaceOnce(
      text,
      "function pjr(e){let t=(0,mjr.c)(9),{resetError:n}=e",
      `${diagnosticDetailsHook()}function pjr(e){let t=(0,mjr.c)(9),{resetError:n}=e`,
      "40816 app shell error fallback prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    return replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function v1o(){let e=(0,x1o.c)(3),t,n;",
      `${diagnosticDetailsHook()}function v1o(){let e=(0,x1o.c)(3),t,n;`,
      "30844 app shell error fallback prop anchor",
    );
    return replaceOnce(
      patched,
      "children:[t,n,(0,S1o.jsx)(Np,{onClick:y1o,children:(0,S1o.jsx)(Z,{id:`codex.errorBoundary.goHome`,defaultMessage:`Try again`,description:`Button label to navigate to the home page after an error`})})]",
      "children:[t,n,CPXDiagnosticDetails({jsx:S1o.jsx,error:null}),(0,S1o.jsx)(Np,{onClick:y1o,children:(0,S1o.jsx)(Z,{id:`codex.errorBoundary.goHome`,defaultMessage:`Try again`,description:`Button label to navigate to the home page after an error`})})]",
      "30844 app shell diagnostic details anchor",
    );
  }
...
function patchErrorBoundary(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(text, "function pBa(e){let t=(0,mBa.c)(9),{resetError:n}=e", "function pBa(e){let t=(0,mBa.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "901.20858 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "actions:(0,WQ.jsxs)(WQ.Fragment,{children:[o,s]})", "actions:(0,WQ.jsxs)(WQ.Fragment,{children:[o,s,CPXDiagnosticDetails({jsx:WQ.jsx,error:CPX_error,componentStack:CPX_componentStack})]})", "901.20858 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,WQ.jsx)(pBa,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,WQ.jsx)(pBa,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "901.20858 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(text, "function EBa(e){let t=(0,DBa.c)(9),{resetError:n}=e", "function EBa(e){let t=(0,DBa.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "901.22334 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "actions:(0,WQ.jsxs)(WQ.Fragment,{children:[o,s]})", "actions:(0,WQ.jsxs)(WQ.Fragment,{children:[o,s,CPXDiagnosticDetails({jsx:WQ.jsx,error:CPX_error,componentStack:CPX_componentStack})]})", "901.22334 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,WQ.jsx)(EBa,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,WQ.jsx)(EBa,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "901.22334 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(text, "function KBa(e){let t=(0,qBa.c)(9),{resetError:n}=e", "function KBa(e){let t=(0,qBa.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "901.31953 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "actions:(0,kQ.jsxs)(kQ.Fragment,{children:[o,s]})", "actions:(0,kQ.jsxs)(kQ.Fragment,{children:[o,s,CPXDiagnosticDetails({jsx:kQ.jsx,error:CPX_error,componentStack:CPX_componentStack})]})", "901.31953 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,kQ.jsx)(KBa,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,kQ.jsx)(KBa,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "901.31953 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(text, "function YBa(e){let t=(0,XBa.c)(9),{resetError:n}=e", "function YBa(e){let t=(0,XBa.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "901.41600 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "actions:(0,kQ.jsxs)(kQ.Fragment,{children:[o,s]})", "actions:(0,kQ.jsxs)(kQ.Fragment,{children:[o,s,CPXDiagnosticDetails({jsx:kQ.jsx,error:CPX_error,componentStack:CPX_componentStack})]})", "901.41600 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,kQ.jsx)(YBa,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,kQ.jsx)(YBa,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "901.41600 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function waa(e){let t=(0,Taa.c)(9),{resetError:n}=e", "function waa(e){let t=(0,Taa.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "41651 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,AW.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,AW.jsx)(hR,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:AW.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,AW.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,AW.jsx)(hR,{onClick:s,children:c})]})]", "41651 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,AW.jsx)(waa,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,AW.jsx)(waa,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "41651 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function Gqi(e){let t=(0,Kqi.c)(9),{resetError:n}=e", "function Gqi(e){let t=(0,Kqi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "61809 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,hR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,hR.jsx)(aX,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:hR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,hR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,hR.jsx)(aX,{onClick:s,children:c})]})]", "61809 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,hR.jsx)(Gqi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,hR.jsx)(Gqi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "61809 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function xKi(e){let t=(0,SKi.c)(9),{resetError:n}=e", "function xKi(e){let t=(0,SKi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "22352 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,dR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,dR.jsx)(KY,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:dR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,dR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,dR.jsx)(KY,{onClick:s,children:c})]})]", "22352 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,dR.jsx)(xKi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,dR.jsx)(xKi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "22352 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function gKi(e){let t=(0,_Ki.c)(9),{resetError:n}=e", "function gKi(e){let t=(0,_Ki.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "31338 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,gR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,gR.jsx)(nX,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:gR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,gR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,gR.jsx)(nX,{onClick:s,children:c})]})]", "31338 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,gR.jsx)(gKi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,gR.jsx)(gKi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "31338 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function CKi(e){let t=(0,wKi.c)(9),{resetError:n}=e", "function CKi(e){let t=(0,wKi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "32112 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,lR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,lR.jsx)(GY,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:lR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,lR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,lR.jsx)(GY,{onClick:s,children:c})]})]", "32112 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,lR.jsx)(CKi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,lR.jsx)(CKi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "32112 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function Wqi(e){let t=(0,Gqi.c)(9),{resetError:n}=e", "function Wqi(e){let t=(0,Gqi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "41705 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,mR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,mR.jsx)(aX,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:mR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,mR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,mR.jsx)(aX,{onClick:s,children:c})]})]", "41705 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,mR.jsx)(Wqi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,mR.jsx)(Wqi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "41705 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function pKi(e){let t=(0,mKi.c)(9),{resetError:n}=e", "function pKi(e){let t=(0,mKi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "21641 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,hR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,hR.jsx)(tX,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:hR.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,hR.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,hR.jsx)(tX,{onClick:s,children:c})]})]", "21641 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,hR.jsx)(pKi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,hR.jsx)(pKi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "21641 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function HHi(e){let t=(0,UHi.c)(9),{resetError:n}=e", "function HHi(e){let t=(0,UHi.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "41407 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,$R.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,$R.jsx)(_X,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:$R.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,$R.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,$R.jsx)(_X,{onClick:s,children:c})]})]", "41407 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,$R.jsx)(HHi,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,$R.jsx)(HHi,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "41407 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function pbr(e){let t=(0,mbr.c)(9),{resetError:n}=e", "function pbr(e){let t=(0,mbr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "26.803.61601 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,kj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,kj.jsx)(oh,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:kj.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,kj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,kj.jsx)(oh,{onClick:s,children:c})]})]", "26.803.61601 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,kj.jsx)(pbr,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,kj.jsx)(pbr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "26.803.61601 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function xFr(e){let t=(0,SFr.c)(9),{resetError:n}=e", "function xFr(e){let t=(0,SFr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e", "26.810.41047 webview error boundary fallback prop anchor");
    patched = replaceOnce(patched, "children:[i,a,(0,$M.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,$M.jsx)(ih,{onClick:s,children:c})]})]", "children:[i,a,CPXDiagnosticDetails({jsx:$M.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,$M.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,$M.jsx)(ih,{onClick:s,children:c})]})]", "26.810.41047 webview error boundary detail anchor");
    return replaceOnce(patched, "r=e??(e=>(0,$M.jsx)(xFr,{resetError:()=>e.resetError()}));", "r=e??(e=>(0,$M.jsx)(xFr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));", "26.810.41047 webview error boundary error prop anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function KFr(e){let t=(0,qFr.c)(9),{resetError:n}=e",
      "function KFr(e){let t=(0,qFr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "52044 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,kM.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,kM.jsx)(Pm,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:kM.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,kM.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,kM.jsx)(Pm,{onClick:s,children:c})]})]",
      "52044 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,kM.jsx)(KFr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,kM.jsx)(KFr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "52044 webview error boundary error prop anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function Jyr(e){let t=(0,Yyr.c)(9),{resetError:n}=e",
      "function Jyr(e){let t=(0,Yyr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "81509 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,Yj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Yj.jsx)(th,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:Yj.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,Yj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Yj.jsx)(th,{onClick:s,children:c})]})]",
      "81509 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,Yj.jsx)(Jyr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,Yj.jsx)(Jyr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "81509 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function mbr(e){let t=(0,hbr.c)(9),{resetError:n}=e",
      "function mbr(e){let t=(0,hbr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "41515 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,Oj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Oj.jsx)(th,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:Oj.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,Oj.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Oj.jsx)(th,{onClick:s,children:c})]})]",
      "41515 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,Oj.jsx)(mbr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,Oj.jsx)(mbr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "41515 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function mjr(e){let t=(0,hjr.c)(9),{resetError:n}=e",
      "function mjr(e){let t=(0,hjr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "61639 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,gk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,gk.jsx)(tm,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:gk.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,gk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,gk.jsx)(tm,{onClick:s,children:c})]})]",
      "61639 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,gk.jsx)(mjr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,gk.jsx)(mjr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "61639 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      text,
      "function _jr(e){let t=(0,vjr.c)(9),{resetError:n}=e",
      "function _jr(e){let t=(0,vjr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "61309 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "children:[i,a,CPXDiagnosticDetails({jsx:pk.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,pk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,pk.jsx)(Qp,{onClick:s,children:c})]})]",
      "61309 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,pk.jsx)(_jr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,pk.jsx)(_jr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "61309 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function hjr(e){let t=(0,gjr.c)(9),{resetError:n}=e",
      "function hjr(e){let t=(0,gjr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "51351 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,sk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,sk.jsx)(tm,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:sk.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,sk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,sk.jsx)(tm,{onClick:s,children:c})]})]",
      "51351 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,sk.jsx)(hjr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,sk.jsx)(hjr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "51351 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function pjr(e){let t=(0,mjr.c)(9),{resetError:n}=e",
      "function pjr(e){let t=(0,mjr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e",
      "40816 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,lk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,lk.jsx)(tm,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:lk.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,lk.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,lk.jsx)(tm,{onClick:s,children:c})]})]",
      "40816 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,lk.jsx)(pjr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,lk.jsx)(pjr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "40816 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function qxr(e){let t=(0,Jxr.c)(9),{resetError:n}=e,r=zw(),i,a;",
      `${diagnosticDetailsHook()}function qxr(e){let t=(0,Jxr.c)(9),{resetError:n,error:CPX_error,componentStack:CPX_componentStack}=e,r=zw(),i,a;`,
      "30844 webview error boundary fallback prop anchor",
    );
    patched = replaceOnce(
      patched,
      "children:[i,a,(0,Ik.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Ik.jsx)(Np,{onClick:s,children:c})]})]",
      "children:[i,a,CPXDiagnosticDetails({jsx:Ik.jsx,error:CPX_error,componentStack:CPX_componentStack}),(0,Ik.jsxs)(`div`,{className:`flex flex-wrap items-center justify-center gap-2`,children:[o,(0,Ik.jsx)(Np,{onClick:s,children:c})]})]",
      "30844 webview error boundary detail anchor",
    );
    return replaceOnce(
      patched,
      "r=e??(e=>(0,Ik.jsx)(qxr,{resetError:()=>e.resetError()}));",
      "r=e??(e=>(0,Ik.jsx)(qxr,{error:e.error,componentStack:e.componentStack,resetError:()=>e.resetError()}));",
      "30844 webview error boundary error prop anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) {
    let patched = replaceOnce(
...
function patchAppMainProjectColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function vDn(e){let t=(0,yDn.c)(36),",
      `${projectColorHook()}function vDn(e){let t=(0,yDn.c)(36),`,
      "26.901.20858 project color app main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "p=vo.sidebarProjectRow({collapsed:r,label:c,projectId:l})",
      "p={...vo.sidebarProjectRow({collapsed:r,label:c,projectId:l}),...CPXPR({projectId:l,label:c})}",
      "26.901.20858 project header row color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      text,
      "function WDn(e){let t=(0,GDn.c)(36),",
      `${projectColorHook()}function WDn(e){let t=(0,GDn.c)(36),`,
      "26.901.22334 project color app main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "p=je.sidebarProjectRow({collapsed:r,label:c,projectId:l})",
      "p={...je.sidebarProjectRow({collapsed:r,label:c,projectId:l}),...CPXPR({projectId:l,label:c})}",
      "26.901.22334 project header row color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "function fDn(e){let t=(0,pDn.c)(36),",
      `${projectColorHook()}function fDn(e){let t=(0,pDn.c)(36),`,
      "26.901.31953 project color app main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "p=os.sidebarProjectRow({collapsed:r,label:c,projectId:l})",
      "p={...os.sidebarProjectRow({collapsed:r,label:c,projectId:l}),...CPXPR({projectId:l,label:c})}",
      "26.901.31953 project header row color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "function yDn(e){let t=(0,bDn.c)(36),",
      `${projectColorHook()}function yDn(e){let t=(0,bDn.c)(36),`,
      "26.901.41600 project color app main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "p=xd.sidebarProjectRow({collapsed:r,label:c,projectId:l})",
      "p={...xd.sidebarProjectRow({collapsed:r,label:c,projectId:l}),...CPXPR({projectId:l,label:c})}",
      "26.901.41600 project header row color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function hPc(e){let t=(0,gPc.c)(36),", `${projectColorHook()}function hPc(e){let t=(0,gPc.c)(36),`, "41651 project color app main helper insertion anchor");
    return replaceOnce(patched, "p=px.sidebarProjectRow({collapsed:r,label:c,projectId:l})", "p={...px.sidebarProjectRow({collapsed:r,label:c,projectId:l}),...CPXPR({projectId:l,label:c})}", "41651 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function NDl(e){let t=(0,PDl.c)(57),", `${projectColorHook()}function NDl(e){let t=(0,PDl.c)(57),`, "61809 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "61809 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function vEl(e){let t=(0,yEl.c)(57),", `${projectColorHook()}function vEl(e){let t=(0,yEl.c)(57),`, "22352 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "22352 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function TEl(e){let t=(0,EEl.c)(57),", `${projectColorHook()}function TEl(e){let t=(0,EEl.c)(57),`, "31338 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "31338 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function EEl(e){let t=(0,DEl.c)(57),", `${projectColorHook()}function EEl(e){let t=(0,DEl.c)(57),`, "32112 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Ep.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "32112 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function jDl(e){let t=(0,MDl.c)(57),", `${projectColorHook()}function jDl(e){let t=(0,MDl.c)(57),`, "41705 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "41705 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function xTl(e){let t=(0,STl.c)(57),", `${projectColorHook()}function xTl(e){let t=(0,STl.c)(57),`, "21641 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Dp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "21641 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function wgl(e){let t=(0,Tgl.c)(57),", `${projectColorHook()}function wgl(e){let t=(0,Tgl.c)(57),`, "41407 project color app main helper insertion anchor");
    return replaceOnce(patched, "A=Mp.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...Mp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "41407 project header row color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function j$c(e){let t=(0,M$c.c)(57),", `${projectColorHook()}function j$c(e){let t=(0,M$c.c)(57),`, "26.810.41047 project color app main helper insertion anchor");
    patched = replaceOnce(patched, "A=am.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...am.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "26.810.41047 project header row color attributes anchor");
    return replaceOnce(patched, "let Ue=He,We=j$c,Ge=r?Se:void 0,Ke=", "let Ue=He,We=j$c,Ge={...(r?Se:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},Ke=", "26.810.41047 native local project identity anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function rNc(e){let t=(0,iNc.c)(57),", `${projectColorHook()}function rNc(e){let t=(0,iNc.c)(57),`, "26.803.61601 project color app main helper insertion anchor");
    patched = replaceOnce(patched, "A=mm.sidebarProjectRow({collapsed:a,label:g,projectId:b})", "A={...mm.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}", "26.803.61601 project header row color attributes anchor");
    return replaceOnce(patched, "let We=Ue,Ge=rNc,Ke=r?Ce:void 0,qe=", "let We=Ue,Ge=rNc,Ke={...(r?Ce:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},qe=", "26.803.61601 native local project identity anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) return text;
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function P$c(e){let t=(0,F$c.c)(57),",
      `${projectColorHook()}function P$c(e){let t=(0,F$c.c)(57),`,
      "52044 project color app main helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "A=Rp.sidebarProjectRow({collapsed:a,label:g,projectId:b})",
      "A={...Rp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}",
      "52044 project header row color attributes anchor",
    );
    return replaceOnce(
      patched,
      "let Ue=He,We=P$c,Ge=r?Se:void 0,Ke=",
      "let Ue=He,We=P$c,Ge={...(r?Se:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},Ke=",
      "52044 native local project identity anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function SNc(e){let t=(0,CNc.c)(57),",
      `${projectColorHook()}function SNc(e){let t=(0,CNc.c)(57),`,
      "81509 project color app main helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "A=im.sidebarProjectRow({collapsed:a,label:g,projectId:b})",
      "A={...im.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}",
      "81509 project header row color attributes anchor",
    );
    return replaceOnce(
      patched,
      "let We=Ue,Ge=SNc,Ke=r?Ce:void 0,qe=",
      "let We=Ue,Ge=SNc,Ke={...(r?Ce:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},qe=",
      "81509 native local project identity anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function tNc(e){let t=(0,nNc.c)(57),",
      `${projectColorHook()}function tNc(e){let t=(0,nNc.c)(57),`,
      "41515 project color app main helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "A=cm.sidebarProjectRow({collapsed:a,label:g,projectId:b})",
      "A={...cm.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}",
      "41515 project header row color attributes anchor",
    );
    return replaceOnce(
      patched,
      "let We=Ue,Ge=tNc,Ke=r?Ce:void 0,qe=",
      "let We=Ue,Ge=tNc,Ke={...(r?Ce:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},qe=",
      "41515 native local project identity anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function cRc(e){let t=(0,lRc.c)(57),",
      `${projectColorHook()}function cRc(e){let t=(0,lRc.c)(57),`,
      "61639 project color app main helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "A=tp.sidebarProjectRow({collapsed:a,label:g,projectId:b})",
      "A={...tp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}",
      "61639 project header row color attributes anchor",
    );
    return replaceOnce(
      patched,
      "let We=Ue,Ge=cRc,Ke=r?Ce:void 0,qe=",
      "let We=Ue,Ge=cRc,Ke={...(r?Ce:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},qe=",
      "61639 native local project identity anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${projectColorHook()}function lRc(e){let t=(0,uRc.c)(57),`,
      "61309 project color app main helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "61309 project header row color attributes anchor",
    );
    return replaceOnce(
      patched,
      "let We=Ue,Ge=lRc,Ke=r?Ce:void 0,qe=",
      "let We=Ue,Ge=lRc,Ke={...(r?Ce:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},qe=",
      "61309 native local project identity anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function t9l(e){let t=(0,n9l.c)(57),",
      `${projectColorHook()}function t9l(e){let t=(0,n9l.c)(57),`,
      "40816 project color app main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "A=tp.sidebarProjectRow({collapsed:a,label:g,projectId:b})",
      "A={...tp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}",
      "40816 project header row color attributes anchor",
    );
  }
  if (
...
function patchAppMainSidebarBlur(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    return replaceOnce(
      text,
      "v=i==null?c:(0,YX.jsx)(`span`,{className:i,children:c})",
      "v=i==null?c:(0,YX.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:i,children:c})",
      "26.901.20858 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    return replaceOnce(
      text,
      "v=i==null?c:(0,$X.jsx)(`span`,{className:i,children:c})",
      "v=i==null?c:(0,$X.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:i,children:c})",
      "26.901.22334 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    return replaceOnce(
      text,
      "v=i==null?c:(0,FZ.jsx)(`span`,{className:i,children:c})",
      "v=i==null?c:(0,FZ.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:i,children:c})",
      "26.901.31953 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    return replaceOnce(
      text,
      "v=i==null?c:(0,BZ.jsx)(`span`,{className:i,children:c})",
      "v=i==null?c:(0,BZ.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:i,children:c})",
      "26.901.41600 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    return replaceOnce(text, "v=i==null?c:(0,_Pc.jsx)(`span`,{className:i,children:c})", "v=i==null?c:(0,_Pc.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:i,children:c})", "41651 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    return replaceOnce(text, "U=(0,Q8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,Q8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "31338 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    return replaceOnce(text, "U=(0,Z8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,Z8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "32112 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    return replaceOnce(text, "U=(0,Q8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,Q8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "21641 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(text, "U=(0,Z8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,Z8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "41407 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    return replaceOnce(text, "U=(0,J8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,J8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "26.810.41047 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    return replaceOnce(text, "U=(0,J8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})", "U=(0,J8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})", "26.803.61601 project header sidebar blur label anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) return text;
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    return replaceOnce(
      text,
      "U=(0,q8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})",
      "U=(0,q8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})",
      "52044 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    return replaceOnce(
      text,
      "U=(0,Y8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})",
      "U=(0,Y8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})",
      "41515 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    return replaceOnce(
      ...
      "U=(0,a0.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})",
      "61309 project header sidebar blur label anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    return replaceOnce(
      text,
      "U=(0,W8.jsx)(`span`,{className:`text-fade-truncate pe-1`,children:g})",
      "U=(0,W8.jsx)(`span`,{\"data-codex-plus-sidebar-name\":``,className:`text-fade-truncate pe-1`,children:g})",
      "40816 project header sidebar blur label anchor",
    );
  }
...
function patchHeader(text, context = {}) {
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      ...
      "function sr(e){let t=(0,cr.c)(5),{conversationId:n}=e,",
      `${threadHeaderHook()}function sr(e){let t=(0,cr.c)(5),{conversationId:n}=e,`,
      "30844 thread shell header accessory helper insertion anchor",
    );
    return replaceOnce(
      patched,
      ...
      "let s=o,CPX_headerContext={cwd:i.cwd,hostId:r?.id??null,header:{surface:`thread-shell`,conversationId:n??null}},CPX_headerAccessories=CPXThreadHeaderAccessories({context:CPX_headerContext,deps:{jsx:lr.jsx,jsxs:lr.jsxs,useSyncExternalStore:ir.useSyncExternalStore}}),CPX_headerAction=CPX_headerAccessories==null?null:(0,lr.jsx)(G.HeaderAction,{actionId:`codex-plus-project-path`,align:`start`,order:90,children:CPX_headerAccessories});if(s==null||!a||i.kind!==`git`||r.kind===`remote-control`)return CPX_headerAction;let c;return t[2]!==s||t[3]!==r?(c=(0,lr.jsx)(G.HeaderAction,{actionId:`thread-local-project-actions`,align:`end`,order:100,children:(0,lr.jsx)(Xn,{cwd:s,hostConfig:r})}),t[2]=s,t[3]=r,t[4]=c):c=t[4],CPX_headerAction==null?c:(0,lr.jsxs)(lr.Fragment,{children:[CPX_headerAction,c]})}",
      "30844 thread shell header accessory mount anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31925")) {
...
function patchThreadTitle(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function Fo(e){let t=(0,Io.c)(64),",
      "function CPXBindThreadHeaderContext(e){return CPXH.context.bindActive(e)}function CPXThreadHeaderTitle(e){return CPXH.threadHeader.title(e)}function Fo(e){let t=(0,Io.c)(64),",
      "26.901.20858 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:f,title:p,titleSuffix:m,cwd:h,canPin:_,identityInSummaryPanel:v}=e",
      "projectName:f,title:CPX_nativeTitle,titleSuffix:m,cwd:h,canPin:_,identityInSummaryPanel:v}=e,p=CPXThreadHeaderTitle(CPX_nativeTitle)",
      "26.901.20858 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let M=j,N=Y(He,n),P=Y(mt,a),F=Y(Ar,a),I=Y(jt,n)??n,L=P??N,R=Ri(M,xt(L).id),z;",
      "let M=j,N=Y(He,n),P=Y(mt,a),F=Y(Ar,a),I=Y(jt,n)??n,L=P??N,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:h,workspaceRoot:h,gitRoot:M??h,hostId:xt(L).id,sourceProject:{id:h,label:typeof f==`string`?f:``,cwd:h}}),R=Ri(M,xt(L).id),z;",
      "26.901.20858 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      "function CPXBindThreadHeaderContext(e){return CPXH.context.bindActive(e)}function CPXThreadHeaderTitle(e){return CPXH.threadHeader.title(e)}function Fo(e){let t=(0,Io.c)(64),",
      "26.901.22334 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:f,title:p,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:_}=e",
      "projectName:f,title:CPX_nativeTitle,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:_}=e,p=CPXThreadHeaderTitle(CPX_nativeTitle)",
      "26.901.22334 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let P=N,F=k(Ue,n),I=k(ht,a),L=k(Tr,a),R=k(jt,n)??n,z=I??F,B=zi(P,Tt(z).id),V;",
      "let P=N,F=k(Ue,n),I=k(ht,a),L=k(Tr,a),R=k(jt,n)??n,z=I??F,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:h,workspaceRoot:h,gitRoot:P??h,hostId:Tt(z).id,sourceProject:{id:h,label:typeof f==`string`?f:``,cwd:h}}),B=zi(P,Tt(z).id),V;",
      "26.901.22334 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      "function CPXBindThreadHeaderContext(e){return CPXH.context.bindActive(e)}function CPXThreadHeaderTitle(e){return CPXH.threadHeader.title(e)}function Fo(e){let t=(0,Io.c)(64),",
      "26.901.31953 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:f,title:p,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:_}=e",
      "projectName:f,title:CPX_nativeTitle,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:_}=e,p=CPXThreadHeaderTitle(CPX_nativeTitle)",
      "26.901.31953 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let te=M,N=X(Ge,n),P=X(ht,o),F=X(Or,o),I=X(Mt,n)??n,L=P??N,R=zi(te,Wt(L).id),ne;",
      "let te=M,N=X(Ge,n),P=X(ht,o),F=X(Or,o),I=X(Mt,n)??n,L=P??N,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:h,workspaceRoot:h,gitRoot:te??h,hostId:Wt(L).id,sourceProject:{id:h,label:typeof f==`string`?f:``,cwd:h}}),R=zi(te,Wt(L).id),ne;",
      "26.901.31953 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      "function CPXBindThreadHeaderContext(e){return CPXH.context.bindActive(e)}function CPXThreadHeaderTitle(e){return CPXH.threadHeader.title(e)}function Fo(e){let t=(0,Io.c)(64),",
      "26.901.41600 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:f,title:p,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:v}=e",
      "projectName:f,title:CPX_nativeTitle,titleSuffix:m,cwd:h,canPin:g,identityInSummaryPanel:v}=e,p=CPXThreadHeaderTitle(CPX_nativeTitle)",
      "26.901.41600 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let I=F,L=X(lr,n),R=X(sn,o),z=X(de,o),B=X(wn,n)??n,V=R??L,H=zi(I,mn(V).id),te;",
      "let I=F,L=X(lr,n),R=X(sn,o),z=X(de,o),B=X(wn,n)??n,V=R??L,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:h,workspaceRoot:h,gitRoot:I??h,hostId:mn(V).id,sourceProject:{id:h,label:typeof f==`string`?f:``,cwd:h}}),H=zi(I,mn(V).id),te;",
      "26.901.41600 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function eo(e){let t=(0,to.c)(62),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("qa")}function eo(e){let t=(0,to.c)(62),`, "41651 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:u,titleSuffix:d,cwd:f,canPin:p,hideIdentity:m}=e", "projectName:l,title:CPX_nativeTitle,titleSuffix:d,cwd:f,canPin:p,hideIdentity:m}=e,u=CPXThreadHeaderTitle(CPX_nativeTitle)", "41651 thread title adapter mount anchor");
    return replaceOnce(patched, "let E=T,D=J(Wn,n),k=J(Se,a),ee=J(ke,a),te=J(j,n)??n,A=k??D,M=C(E,xt(A).id),N;", "let E=T,D=J(Wn,n),k=J(Se,a),ee=J(ke,a),te=J(j,n)??n,A=k??D,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:f,workspaceRoot:f,gitRoot:E??f,hostId:xt(A).id,sourceProject:{id:f,label:typeof l==`string`?l:``,cwd:f}}),M=C(E,xt(A).id),N;", "41651 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function Xa(e){let t=(0,$a.c)(63),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("Ja")}function Xa(e){let t=(0,$a.c)(63),`, "22352 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:d,titleSuffix:f,cwd:p,canPin:m}=e,h=s!==void 0&&s,", "projectName:l,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),h=s!==void 0&&s,", "22352 thread title adapter mount anchor");
    return replaceOnce(patched, "let C=S,w=J(Me,n),E=J(cr,a),D=J(wr,a),O=J(ve,n)??n,k=E??w,A=Be(C,On(k).id),j;", "let C=S,w=J(Me,n),E=J(cr,a),D=J(wr,a),O=J(ve,n)??n,k=E??w,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:C??p,hostId:On(k).id,sourceProject:{id:p,label:typeof l==`string`?l:``,cwd:p}}),A=Be(C,On(k).id),j;", "22352 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function Xa(e){let t=(0,$a.c)(63),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("Ja")}function Xa(e){let t=(0,$a.c)(63),`, "32112 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:d,titleSuffix:f,cwd:p,canPin:m}=e,h=s!==void 0&&s,", "projectName:l,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),h=s!==void 0&&s,", "32112 thread title adapter mount anchor");
    return replaceOnce(patched, "let C=S,w=J(Me,n),E=J(cr,a),D=J(wr,a),O=J(ve,n)??n,k=E??w,A=Be(C,On(k).id),j;", "let C=S,w=J(Me,n),E=J(cr,a),D=J(wr,a),O=J(ve,n)??n,k=E??w,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:C??p,hostId:On(k).id,sourceProject:{id:p,label:typeof l==`string`?l:``,cwd:p}}),A=Be(C,On(k).id),j;", "32112 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function Qa(e){let t=(0,to.c)(66),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("Xa")}function Qa(e){let t=(0,to.c)(66),`, "41705 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:u,titleSuffix:d,cwd:p,canPin:m}=e,h=s!==void 0&&s,", "projectName:l,title:CPX_nativeTitle,titleSuffix:d,cwd:p,canPin:m}=e,u=CPXThreadHeaderTitle(CPX_nativeTitle),h=s!==void 0&&s,", "41705 thread title adapter mount anchor");
    return replaceOnce(patched, "let C=S,w=Y(T,n),E=Y(Tr,a),D=Y(dr,a),O=Y(Jn,n)??n,k=E??w,A=Ve(C,jn(k).id),j;", "let C=S,w=Y(T,n),E=Y(Tr,a),D=Y(dr,a),O=Y(Jn,n)??n,k=E??w,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:C??p,hostId:jn(k).id,sourceProject:{id:p,label:typeof l==`string`?l:``,cwd:p}}),A=Ve(C,jn(k).id),j;", "41705 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function Xa(e){let t=(0,$a.c)(63),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("Ja")}function Xa(e){let t=(0,$a.c)(63),`, "21641 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:u,titleSuffix:d,cwd:f,canPin:p}=e,m=s!==void 0&&s,", "projectName:l,title:CPX_nativeTitle,titleSuffix:d,cwd:f,canPin:p}=e,u=CPXThreadHeaderTitle(CPX_nativeTitle),m=s!==void 0&&s,", "21641 thread title adapter mount anchor");
    return replaceOnce(patched, "let x=b,S=Y(Sn,n),C=Y(_t,a),w=Y(ne,a),E=Y(Jt,n)??n,D=C??S,O=se(x,ut(D).id),k;", "let x=b,S=Y(Sn,n),C=Y(_t,a),w=Y(ne,a),E=Y(Jt,n)??n,D=C??S,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:f,workspaceRoot:f,gitRoot:x??f,hostId:ut(D).id,sourceProject:{id:f,label:typeof l==`string`?l:``,cwd:f}}),O=se(x,ut(D).id),k;", "21641 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function za(e){let t=(0,Ha.c)(59),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("_o")}function za(e){let t=(0,Ha.c)(59),`, "41407 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:l,title:u,titleSuffix:d,cwd:f,canPin:p}=e,m=s!==void 0&&s,", "projectName:l,title:CPX_nativeTitle,titleSuffix:d,cwd:f,canPin:p}=e,u=CPXThreadHeaderTitle(CPX_nativeTitle),m=s!==void 0&&s,", "41407 thread title adapter mount anchor");
    return replaceOnce(patched, "let b=y,x=K(hr,n),S=K(Nr,a),C=K(rr,a),w=K(zt,n)??n,T=S??x,E=Pe(b,Ae(T).id),D;", "let b=y,x=K(hr,n),S=K(Nr,a),C=K(rr,a),w=K(zt,n)??n,T=S??x,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:f,workspaceRoot:f,gitRoot:b??f,hostId:Ae(T).id,sourceProject:{id:f,label:typeof l==`string`?l:``,cwd:f}}),E=Pe(b,Ae(T).id),D;", "41407 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function co(e){let t=(0,fo.c)(53),", `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("oo")}function co(e){let t=(0,fo.c)(53),`, "26.810.41047 thread title context helper insertion anchor");
    patched = replaceOnce(patched, "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m}=e,h=c!==void 0&&c,", "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),h=c!==void 0&&c,", "26.810.41047 thread title adapter mount anchor");
    return replaceOnce(patched, "let S=x,C=G(Ei,n),w=G(Te,o),T=G(Ie,o),E=G(et,n)??n,D=w??C,O=Yt(S,xr(D).id),k;", "let S=x,C=G(Ei,n),w=G(Te,o),T=G(Ie,o),E=G(et,n)??n,D=w??C,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:S??p,hostId:xr(D).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),O=Yt(S,xr(D).id),k;", "26.810.41047 thread title native context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function co(e){let t=(0,fo.c)(53),",
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("oo")}function co(e){let t=(0,fo.c)(53),`,
      "52044 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m}=e,h=c!==void 0&&c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),h=c!==void 0&&c,",
      "52044 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let x=b,S=K(it,n),C=K(Ve,a),T=K(A,a),E=K(w,n)??n,D=C??S,O=$t(x,ri(D).id),k;",
      "let x=b,S=K(it,n),C=K(Ve,a),T=K(A,a),E=K(w,n)??n,D=C??S,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:x??p,hostId:ri(D).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),O=$t(x,ri(D).id),k;",
      "52044 thread title native context anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function mo(e){let t=(0,_o.c)(56),",
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("fo")}function mo(e){let t=(0,_o.c)(56),`,
      "81509 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,g=c!==void 0&&c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),g=c!==void 0&&c,",
      "81509 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let S=x,C=B(Nn,n),w=B(Un,n)??n,T=r??C,E=ma(S,pi(T).id),D;",
      "let S=x,C=B(Nn,n),w=B(Un,n)??n,T=r??C,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:S??p,hostId:pi(T).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),E=ma(S,pi(T).id),D;",
      "81509 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      ...
      "function mo(e){let t=(0,_o.c)(56),",
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("fo")}function mo(e){let t=(0,_o.c)(56),`,
      "41515 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,g=c!==void 0&&c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),g=c!==void 0&&c,",
      "41515 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let S=x,C=U(Un,n),w=U(Xn,n)??n,T=r??C,E=ha(S,dn(T).id),D;",
      "let S=x,C=U(Un,n),w=U(Xn,n)??n,T=r??C,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:S??p,hostId:dn(T).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),E=ha(S,dn(T).id),D;",
      "41515 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("t(It(),1)")}function Ro(e){let t=(0,Vo.c)(56),`,
      "61309 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:h,hideForkActions:g}=e,_=c!==void 0&&c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:h,hideForkActions:g}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),_=c!==void 0&&c,",
      "61309 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let C=S,T=U(Se,n),E=U(m,n)??n,D=r??T,k=Aa(C,Kr(D).id),A;",
      "let C=S,T=U(Se,n),E=U(m,n)??n,D=r??T,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:C??p,hostId:Kr(D).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),k=Aa(C,Kr(D).id),A;",
      "61309 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function no(e){let t=(0,ao.c)(49),",
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("Qa")}function no(e){let t=(0,ao.c)(49),`,
      "40816 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,g=c!==void 0&&c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),g=c!==void 0&&c,",
      "40816 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let S=x,C=W(ee,n),w=r??C,E=Ca(S,Ye(w).id),D;",
      "let S=x,C=W(ee,n),w=r??C,CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:S??p,hostId:Ye(w).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),E=Ca(S,Ye(w).id),D;",
      "40816 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function ou(e){let t=(0,lu.c)(43),",
      `${threadHeaderContextHook()}${threadHeaderBoundTitleHook("t(at(),1)")}function ou(e){let t=(0,lu.c)(43),`,
      "30844 thread title context helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "projectName:u,title:d,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,_=c===void 0?!1:c,",
      "projectName:u,title:CPX_nativeTitle,titleSuffix:f,cwd:p,canPin:m,hideForkActions:h}=e,d=CPXThreadHeaderTitle(CPX_nativeTitle),_=c===void 0?!1:c,",
      "30844 thread title adapter mount anchor",
    );
    return replaceOnce(
      patched,
      "let C=x,w=B($t,n),T=Ro(C,La(r??w).id),E;",
      "let C=x,w=B($t,n),CPXC=CPXBindThreadHeaderContext({routeId:n,threadId:n,cwd:p,workspaceRoot:p,gitRoot:C??p,hostId:La(r??w).id,sourceProject:{id:p,label:typeof u==`string`?u:``,cwd:p}}),T=Ro(C,La(r??w).id),E;",
      "30844 thread title native context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.21425")) {
    let patched = replaceOnce(
...
function patchThreadHeaderActionShell(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function Fo(e){let t=(0,Io.c)(64),",
      `${threadHeaderHook()}function Fo(e){let t=(0,Io.c)(64),`,
      "26.901.20858 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "let q;t[46]===D?q=t[47]:(q=null,t[46]=D,t[47]=q);",
      "let q=CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:Lo.jsx,jsxs:Lo.jsxs}});",
      "26.901.20858 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      `${threadHeaderHook()}function Fo(e){let t=(0,Io.c)(64),`,
      "26.901.22334 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "let J;t[46]===D?J=t[47]:(J=null,t[46]=D,t[47]=J);",
      "let J=CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:Lo.jsx,jsxs:Lo.jsxs}});",
      "26.901.22334 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      `${threadHeaderHook()}function Fo(e){let t=(0,Io.c)(64),`,
      "26.901.31953 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "let ie;t[46]===D?ie=t[47]:(ie=null,t[46]=D,t[47]=ie);",
      "let ie=CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:Lo.jsx,jsxs:Lo.jsxs}});",
      "26.901.31953 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      ...
      "function Fo(e){let t=(0,Io.c)(64),",
      `${threadHeaderHook()}function Fo(e){let t=(0,Io.c)(64),`,
      "26.901.41600 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "let ae;t[46]===O?ae=t[47]:(ae=null,t[46]=O,t[47]=ae);",
      "let ae=CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:Lo.jsx,jsxs:Lo.jsxs}});",
      "26.901.41600 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function eo(e){let t=(0,to.c)(62),", "function CPXThreadHeaderAccessories(e){return CPXH.threadHeader.accessories(e.context,e.deps)}function eo(e){let t=(0,to.c)(62),", "41651 thread header action-shell helper anchor");
    return replaceOnce(patched, "let U;t[45]===S?U=t[46]:(U=null,t[45]=S,t[46]=U);", "let U=CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:no.jsx,jsxs:no.jsxs,useSyncExternalStore:qa.useSyncExternalStore}});", "41651 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function h6a(e){let t=(0,L6a.c)(80),", `${threadHeaderHook()}function h6a(e){let t=(0,L6a.c)(80),`, "61809 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(S6a),a=f.filter(x6a),u=f.filter(b6a),g=", "let e=f.filter(S6a),a=f.filter(x6a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(b6a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:NW.jsx,jsxs:NW.jsxs,useSyncExternalStore:p6a.useSyncExternalStore}})),g=", "61809 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function B4a(e){let t=(0,c3a.c)(80),", `${threadHeaderHook()}function B4a(e){let t=(0,c3a.c)(80),`, "22352 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(q4a),a=f.filter(K4a),u=f.filter(G4a),g=", "let e=f.filter(q4a),a=f.filter(K4a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(G4a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:DW.jsx,jsxs:DW.jsxs,useSyncExternalStore:R4a.useSyncExternalStore}})),g=", "22352 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function H4a(e){let t=(0,u3a.c)(80),", `${threadHeaderHook()}function H4a(e){let t=(0,u3a.c)(80),`, "31338 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(Y4a),a=f.filter(J4a),u=f.filter(q4a),g=", "let e=f.filter(Y4a),a=f.filter(J4a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(q4a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:MW.jsx,jsxs:MW.jsxs,useSyncExternalStore:B4a.useSyncExternalStore}})),g=", "31338 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function q4a(e){let t=(0,h3a.c)(80),", `${threadHeaderHook()}function q4a(e){let t=(0,h3a.c)(80),`, "32112 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(e3a),a=f.filter($4a),u=f.filter(Q4a),g=", "let e=f.filter(e3a),a=f.filter($4a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(Q4a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:DW.jsx,jsxs:DW.jsxs,useSyncExternalStore:G4a.useSyncExternalStore}})),g=", "32112 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function p6a(e){let t=(0,F6a.c)(80),", `${threadHeaderHook()}function p6a(e){let t=(0,F6a.c)(80),`, "41705 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(b6a),a=f.filter(y6a),u=f.filter(v6a),g=", "let e=f.filter(b6a),a=f.filter(y6a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(v6a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:NW.jsx,jsxs:NW.jsxs,useSyncExternalStore:d6a.useSyncExternalStore}})),g=", "41705 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function J4a(e){let t=(0,t3a.c)(13),", `${threadHeaderHook()}function J4a(e){let t=(0,t3a.c)(13),`, "21641 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(B4a),a=f.filter(z4a),u=f.filter(R4a),g=", "let e=f.filter(B4a),a=f.filter(z4a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(R4a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:kW.jsx,jsxs:kW.jsxs,useSyncExternalStore:u3a.useSyncExternalStore}})),g=", "21641 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function a$a(e){let t=(0,E$a.c)(72),", `${threadHeaderHook()}function a$a(e){let t=(0,E$a.c)(72),`, "41407 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(d$a),a=f.filter(u$a),u=f.filter(l$a),_=e.length>0,", "let e=f.filter(d$a),a=f.filter(u$a),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(l$a),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:uG.jsx,jsxs:uG.jsxs,useSyncExternalStore:r$a.useSyncExternalStore}})),_=e.length>0,", "41407 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function pJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){", `${threadHeaderActiveHook()}function pJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`, "26.803.61601 thread header action-shell helper anchor");
    return replaceOnce(patched, "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,", "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(dJr.useSyncExternalStore,{jsx:jP.jsx,jsxs:jP.jsxs})),v=h.length>0,", "26.803.61601 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function P8r(e){let t=(0,t5r.c)(72),", `${threadHeaderHook()}function P8r(e){let t=(0,t5r.c)(72),`, "26.810.41047 thread header action-shell helper anchor");
    return replaceOnce(patched, "let e=f.filter(B8r),a=f.filter(z8r),u=f.filter(R8r),_=e.length>0,", "let e=f.filter(B8r),a=f.filter(z8r),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(R8r),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:NF.jsx,jsxs:NF.jsxs,useSyncExternalStore:M8r.useSyncExternalStore}})),_=e.length>0,", "26.810.41047 thread header native end-action anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function n5r(e){let t=(0,C5r.c)(72),",
      `${threadHeaderHook()}function n5r(e){let t=(0,C5r.c)(72),`,
      "52044 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "let e=f.filter(c5r),a=f.filter(s5r),u=f.filter(o5r),_=e.length>0,",
      "let e=f.filter(c5r),a=f.filter(s5r),u=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(f.filter(o5r),CPXThreadHeaderAccessories({context:CPXH.context.active(),deps:{jsx:fF.jsx,jsxs:fF.jsxs,useSyncExternalStore:e5r.useSyncExternalStore}})),_=e.length>0,",
      "52044 thread header native end-action anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function cJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){",
      `${threadHeaderActiveHook()}function cJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "81509 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(oJr.useSyncExternalStore,{jsx:LP.jsx,jsxs:LP.jsxs})),v=h.length>0,",
      "81509 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function sJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){",
      `${threadHeaderActiveHook()}function sJr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "41515 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(aJr.useSyncExternalStore,{jsx:LP.jsx,jsxs:LP.jsxs})),v=h.length>0,",
      "41515 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function c3r({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){",
      `${threadHeaderActiveHook()}function c3r({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "61639 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(o3r.useSyncExternalStore,{jsx:Yj.jsx,jsxs:Yj.jsxs})),v=h.length>0,",
      "61639 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${threadHeaderActiveHook()}function p3r({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "61309 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(d3r.useSyncExternalStore,{jsx:Wj.jsx,jsxs:Wj.jsxs})),v=h.length>0,",
      "61309 thread header native end-action anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351") && text.includes("function jqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){")) {
    let patched = replaceOnce(
      text,
      "function jqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){",
      `${threadHeaderActiveHook()}function jqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "51351 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(Eqr.useSyncExternalStore,{jsx:dj.jsx,jsxs:dj.jsxs})),v=h.length>0,",
      "51351 thread header native end-action anchor",
    );
  }
  if (text.includes("function Aqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){")) {
    let patched = replaceOnce(
      text,
      "function Aqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){",
      `${threadHeaderActiveHook()}function Aqr({isHeaderEdgeScroll:e,isApplicationMenuBarEnabled:t}){`,
      "40816 thread header action-shell helper anchor",
    );
    return replaceOnce(
      patched,
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=u.filter(({align:e})=>e===`end`),v=h.length>0,",
      "h=u.filter(({align:e})=>e===`start`),g=u.filter(({align:e})=>e===`center`),_=((e,t)=>t==null?e:[{actionId:`codex-plus-project-path`,align:`end`,node:t},...e])(u.filter(({align:e})=>e===`end`),CPXHA(Tqr.useSyncExternalStore,{jsx:fj.jsx,jsxs:fj.jsxs})),v=h.length>0,",
      "40816 thread header native end-action anchor",
    );
  }
...
function patchGeneralSettingsUserBubbleColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function Zi(e){let t=(0,oa.c)(74),{showCodeFont:r,showTranslucentSidebarToggle:i,variant:a}=e",
      `${appearanceSettingsHook("{React:sa,jsx:X.jsx,SettingRow:L,ColorInput:Si,Switch:ft}")}function Zi(e){let t=(0,oa.c)(74),{showCodeFont:r,showTranslucentSidebarToggle:i,variant:a}=e`,
      "26.901.20858 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[me,he,ge,be,we]",
      "children:[me,...CPXAppearanceRows(a),he,ge,be,we]",
      "26.901.20858 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      text,
      "function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e",
      `${appearanceSettingsHook("{React:sa,jsx:X.jsx,SettingRow:L,ColorInput:Si,Switch:ft}")}function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`,
      "26.901.22334 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[me,he,ge,be,Te]",
      "children:[me,...CPXAppearanceRows(i),he,ge,be,Te]",
      "26.901.22334 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      ...
      "function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e",
      `${appearanceSettingsHook("{React:sa,jsx:X.jsx,SettingRow:L,ColorInput:Si,Switch:ft}")}function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`,
      "26.901.31953 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[fe,pe,me,ve,Ce]",
      "children:[fe,...CPXAppearanceRows(i),pe,me,ve,Ce]",
      "26.901.31953 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      ...
      "function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e",
      `${appearanceSettingsHook("{React:sa,jsx:X.jsx,SettingRow:L,ColorInput:Si,Switch:ft}")}function Zi(e){let t=(0,oa.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`,
      "26.901.41600 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[pe,me,he,ye,we]",
      "children:[pe,...CPXAppearanceRows(i),me,he,ye,we]",
      "26.901.41600 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function qi(e){let t=(0,na.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:ra,jsx:Y.jsx,SettingRow:K,ColorInput:vi,Switch:fr}")}function qi(e){let t=(0,na.c)(74),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "41651 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[pe,me,he,ye,we]", "children:[pe,...CPXAppearanceRows(i),me,he,ye,we]", "41651 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:xi,jsx:Y.jsx,SettingRow:z,ColorInput:li,Switch:at}")}function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "22352 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[ue,de,fe,ge,xe]", "children:[ue,...CPXAppearanceRows(i),de,fe,ge,xe]", "22352 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:xi,jsx:Y.jsx,SettingRow:R,ColorInput:li,Switch:Se}")}function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "32112 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[ue,de,fe,ge,xe]", "children:[ue,...CPXAppearanceRows(i),de,fe,ge,xe]", "32112 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:xi,jsx:Y.jsx,SettingRow:R,ColorInput:li,Switch:Se}")}function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "41705 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[de,fe,pe,_e,Se]", "children:[de,...CPXAppearanceRows(i),fe,pe,_e,Se]", "41705 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:xi,jsx:Y.jsx,SettingRow:R,ColorInput:li,Switch:Se}")}function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "21641 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[ue,de,fe,ge,Ce]", "children:[ue,...CPXAppearanceRows(i),de,fe,ge,Ce]", "21641 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:i,variant:a}=e", `${appearanceSettingsHook("{React:xi,jsx:Y.jsx,SettingRow:V,ColorInput:li,Switch:Jt}")}function ri(e){let t=(0,bi.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:i,variant:a}=e`, "41407 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[de,fe,pe,_e,xe]", "children:[de,...CPXAppearanceRows(a),fe,pe,_e,xe]", "41407 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function li(e){let t=(0,Ei.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e", `${appearanceSettingsHook("{React:Di,jsx:Y.jsx,SettingRow:G,ColorInput:hi,Switch:ye}")}function li(e){let t=(0,Ei.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`, "26.810.41047 user bubble settings helper insertion anchor");
    return replaceOnce(patched, "children:[ue,de,fe,_e,Se]", "children:[ue,...CPXAppearanceRows(i),de,fe,_e,Se]", "26.810.41047 user bubble settings row anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function li(e){let t=(0,Ei.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e",
      `${appearanceSettingsHook("{React:Di,jsx:Y.jsx,SettingRow:G,ColorInput:hi,Switch:ye}")}function li(e){let t=(0,Ei.c)(72),{showCodeFont:n,showTranslucentSidebarToggle:r,variant:i}=e`,
      "52044 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[ue,de,fe,ge,Se]",
      "children:[ue,...CPXAppearanceRows(i),de,fe,ge,Se]",
      "52044 user bubble settings row anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      ...
      `${appearanceSettingsHook("{React:ei,jsx:Y.jsx,SettingRow:R,ColorInput:Vr,Switch:He}")}function Ir({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){`,
      "81509 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[E.map(e=>(0,Y.jsx)(R,{size:`compact`,control:(0,Y.jsx)(Vr,{ariaLabel:e.ariaLabel,value:b[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),D.map",
      "children:[E.map(e=>(0,Y.jsx)(R,{size:`compact`,control:(0,Y.jsx)(Vr,{ariaLabel:e.ariaLabel,value:b[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),...CPXAppearanceRows(n),D.map",
      "81509 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function Ir({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){",
      `${appearanceSettingsHook("{React:ei,jsx:Y.jsx,SettingRow:I,ColorInput:Vr,Switch:ze}")}function Ir({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){`,
      "41515 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[E.map(e=>(0,Y.jsx)(I,{size:`compact`,control:(0,Y.jsx)(Vr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),D.map",
      "children:[E.map(e=>(0,Y.jsx)(I,{size:`compact`,control:(0,Y.jsx)(Vr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),...CPXAppearanceRows(n),D.map",
      "41515 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${appearanceSettingsHook("{React:Jr,jsx:Y.jsx,SettingRow:W,ColorInput:Fr,Switch:Wt}")}function Ar({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){`,
      "61309 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      ...
      "children:[E.map(e=>(0,Y.jsx)(W,{size:`compact`,control:(0,Y.jsx)(Fr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),...CPXAppearanceRows(n),D.map",
      "61309 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function Ar({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){",
      `${appearanceSettingsHook("{React:Jr,jsx:J.jsx,SettingRow:U,ColorInput:Fr,Switch:Xe}")}function Ar({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){`,
      "40816 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[E.map(e=>(0,J.jsx)(U,{size:`compact`,control:(0,J.jsx)(Fr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),D.map",
      "children:[E.map(e=>(0,J.jsx)(U,{size:`compact`,control:(0,J.jsx)(Fr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{O(e.role,t)}}),label:e.label},e.role)),...CPXAppearanceRows(n),D.map",
      "40816 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      ...
      "function Mr({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){",
      `${appearanceSettingsHook("{React:Xr,jsx:Y.jsx,SettingRow:U,ColorInput:Lr,Switch:ar}")}function Mr({showCodeFont:e,showTranslucentSidebarToggle:t,variant:n}){`,
      "30844 user bubble settings helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "children:[E.map(e=>(0,Y.jsx)(U,{size:`compact`,control:(0,Y.jsx)(Lr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{k(e.role,t)}}),label:e.label},e.role)),D.map",
      "children:[E.map(e=>(0,Y.jsx)(U,{size:`compact`,control:(0,Y.jsx)(Lr,{ariaLabel:e.ariaLabel,value:y[e.role],onChange:t=>{k(e.role,t)}}),label:e.label},e.role)),...CPXAppearanceRows(n),D.map",
      "30844 user bubble settings row anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31925")) {
    let patched = replaceOnce(
...
function patchUserMessageAttachmentsBubbleColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function pma(e){let t=(0,rY.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e",
      `${messageComposerHook()}function pma(e){let t=(0,rY.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e`,
      "26.901.20858 user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      '"data-user-message-bubble":p,className:',
      '"data-user-message-bubble":p,...CPXBubbleProps({}),className:',
      "26.901.20858 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      text,
      "function Ema(e){let t=(0,rY.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e",
      `${messageComposerHook()}function Ema(e){let t=(0,rY.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e`,
      "26.901.22334 user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      '"data-user-message-bubble":p,className:',
      '"data-user-message-bubble":p,...CPXBubbleProps({}),className:',
      "26.901.22334 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "function Uma(e){let t=(0,GJ.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e",
      `${messageComposerHook()}function Uma(e){let t=(0,GJ.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e`,
      "26.901.31953 user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      '"data-user-message-bubble":p,className:',
      '"data-user-message-bubble":p,...CPXBubbleProps({}),className:',
      "26.901.31953 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "function Kma(e){let t=(0,GJ.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e",
      `${messageComposerHook()}function Kma(e){let t=(0,GJ.c)(26),{id:n,initialMessageRef:r,isInitialUserMessage:i,message:a,userImageAlt:o}=e`,
      "26.901.41600 user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      '"data-user-message-bubble":p,className:',
      '"data-user-message-bubble":p,...CPXBubbleProps({}),className:',
      "26.901.41600 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function vh(e){let t=(0,yh.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e", `${messageComposerHook("Sh")}function vh(e){let t=(0,yh.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e`, "41651 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "pe=(0,xh.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:B,children:fe})", "pe=(0,xh.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:B,children:fe})", "41651 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "41651 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:s,onSubmit:c}=e", `${messageComposerHook("p_")}function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:s,onSubmit:c}=e`, "22352 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "de=(0,m_.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:V,children:ue})", "de=(0,m_.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:V,children:ue})", "22352 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "22352 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:s,onSubmit:c}=e", `${messageComposerHook("p_")}function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:s,onSubmit:c}=e`, "32112 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "de=(0,m_.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:V,children:ue})", "de=(0,m_.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:V,children:ue})", "32112 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "32112 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e", `${messageComposerHook("p_")}function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e`, "41705 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "de=(0,m_.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:B,children:ue})", "de=(0,m_.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:B,children:ue})", "41705 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "41705 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e", `${messageComposerHook("p_")}function d_(e){let t=(0,f_.c)(98),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e`, "21641 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "Y=(0,m_.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:z,children:J})", "Y=(0,m_.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:z,children:J})", "21641 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "21641 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function w_(e){let t=(0,T_.c)(91),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:c}=e", `${messageComposerHook("E_")}function w_(e){let t=(0,T_.c)(91),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:c}=e`, "41407 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "le=(0,D_.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:I,children:ce})", "le=(0,D_.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:I,children:ce})", "41407 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "41407 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function Qh(e){let t=(0,$h.c)(91),{cwd:n,hostId:i,initialMessage:a,onCancel:s,onDraftChange:c,onSubmit:l}=e", `${messageComposerHook("eg")}function Qh(e){let t=(0,$h.c)(91),{cwd:n,hostId:i,initialMessage:a,onCancel:s,onDraftChange:c,onSubmit:l}=e`, "26.810.41047 user bubble helper insertion anchor");
    patched = replaceOnce(patched, "de=(0,tg.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:L,children:ue})", "de=(0,tg.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:L,children:ue})", "26.810.41047 edit user message entry marker anchor");
    return replaceOnce(patched, "\"data-user-message-bubble\":!0,className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "26.810.41047 user bubble marker attribute anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function Qh(e){let t=(0,$h.c)(91),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e",
      `${messageComposerHook("eg")}function Qh(e){let t=(0,$h.c)(91),{cwd:n,hostId:r,initialMessage:i,onCancel:a,onDraftChange:o,onSubmit:s}=e`,
      "52044 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "le=(0,tg.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:I,children:ce})",
      "le=(0,tg.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-text/5`,onSubmit:I,children:ce})",
      "52044 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:",
      "52044 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function Oh({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){",
      `${messageComposerHook("kh")}function Oh({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "41515 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "return(0,Ah.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "return(0,Ah.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "41515 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "41515 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function Cal({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){",
      `${messageComposerHook("b4")}function Cal({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "61639 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "return(0,x4.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "61639 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "61639 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${messageComposerHook("b4")}function wal({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "61309 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "return(0,x4.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "return(0,x4.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "61309 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "61309 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function psl({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){",
      `${messageComposerHook("u4")}function psl({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "51351 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "return(0,d4.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "return(0,d4.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "51351 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "51351 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function fsl({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){",
      `${messageComposerHook("d4")}function fsl({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "40816 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "return(0,f4.jsx)(`form`,{className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "return(0,f4.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "40816 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "40816 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function cJc({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){",
      `${messageComposerHook("b5o")}function cJc({cwd:e,hostId:t,initialMessage:n,onCancel:r,onDraftChange:i,onSubmit:a}){`,
      "30844 user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "return(0,M4.jsx)(`form`,{\"data-codex-plus-user-entry\":!0,className:`relative flex w-full flex-col rounded-3xl bg-token-foreground/5`,onSubmit:e=>{e.preventDefault(),v()},children:",
      "30844 edit user message entry marker anchor",
    );
    return replaceOnce(
      patched,
      "\"data-user-message-bubble\":!0,tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "30844 user bubble marker attribute anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) {
...
function patchUserMessageAttachmentsProjectColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    return replaceOnce(
      text,
      '"data-user-message-bubble":p,...CPXBubbleProps({}),className:',
      '"data-user-message-bubble":p,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),className:',
      "26.901.41600 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    return replaceOnce(text, "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),className:", "41651 user bubble canonical project context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    return replaceOnce(text, "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),className:", "22352 user bubble canonical project context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(text, "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:", "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),className:", "41407 user bubble canonical project context anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    return replaceOnce(
      text,
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),className:",
      "52044 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    return replaceOnce(
      text,
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),tabIndex:0,className:",
      "41515 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    return replaceOnce(
      ...
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),tabIndex:0,className:",
      "61309 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    return replaceOnce(
      ...
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),tabIndex:0,className:",
      "40816 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    return replaceOnce(
      ...
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({}),tabIndex:0,className:",
      "\"data-user-message-bubble\":!0,...CPXBubbleProps({project:globalThis.CodexPlusHost.adapters.context.active()}),tabIndex:0,className:",
      "30844 user bubble canonical project context anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) {
    return replaceOnce(
...
function patchComposerBubbleColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,XV.jsx)", "YV")}function m1t(e){let t=(0,JV.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`,
      "26.901.20858 composer user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "M=(0,XV.jsx)(vi.div,{className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "M=(0,XV.jsx)(CPXComposerSurface,{native:vi.div,className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "26.901.20858 composer user entry marker render anchor",
    );
    return replaceOnce(
      patched,
      'Xt=(0,R9.jsxs)(`div`,{className:Pt,"data-codex-composer-root":``,"data-composer-placement":ue.kind,children:[It,Yt]})',
      'Xt=(0,R9.jsxs)(CPXComposerSurface,{native:`div`,className:Pt,"data-codex-composer-root":``,"data-composer-placement":ue.kind,children:[It,Yt]})',
      "26.901.20858 active thread composer user entry marker anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,JV.jsx)", "qV")}function b1t(e){let t=(0,KV.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`,
      "26.901.22334 composer user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "M=(0,JV.jsx)(_a.div,{className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "M=(0,JV.jsx)(CPXComposerSurface,{native:_a.div,className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "26.901.22334 composer user entry marker render anchor",
    );
    return replaceOnce(
      patched,
      'Jt=(0,L9.jsxs)(`div`,{className:Nt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[Ft,qt]})',
      'Jt=(0,L9.jsxs)(CPXComposerSurface,{native:`div`,className:Nt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[Ft,qt]})',
      "26.901.22334 active thread composer user entry marker anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "function e$t(e){let t=(0,gU.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,",
      `${composerSurfaceElementHook("(0,vU.jsx)", "_U")}function e$t(e){let t=(0,gU.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`,
      "26.901.31953 composer user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "M=(0,vU.jsx)(Pp.div,{className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "M=(0,vU.jsx)(CPXComposerSurface,{native:Pp.div,className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "26.901.31953 composer user entry marker render anchor",
    );
    return replaceOnce(
      patched,
      'Yt=(0,R9.jsxs)(`div`,{className:Pt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[It,Jt]})',
      'Yt=(0,R9.jsxs)(CPXComposerSurface,{native:`div`,className:Pt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[It,Jt]})',
      "26.901.31953 active thread composer user entry marker anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "function f$t(e){let t=(0,gU.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,",
      `${composerSurfaceElementHook("(0,vU.jsx)", "_U")}function f$t(e){let t=(0,gU.c)(24),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`,
      "26.901.41600 composer user bubble helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "M=(0,vU.jsx)(Ol.div,{className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "M=(0,vU.jsx)(CPXComposerSurface,{native:Ol.div,className:k,inert:o,\"data-composer-dark\":A,\"data-composer-drag-active\":j,",
      "26.901.41600 composer user entry marker render anchor",
    );
    return replaceOnce(
      patched,
      'qt=(0,R9.jsxs)(`div`,{className:Mt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[Pt,Kt]})',
      'qt=(0,R9.jsxs)(CPXComposerSurface,{native:`div`,className:Mt,"data-codex-composer-root":``,"data-composer-placement":le.kind,children:[Pt,Kt]})',
      "26.901.41600 active thread composer user entry marker anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function lio(e){let t=(0,PX.c)(21),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,", `${composerSurfaceElementHook("(0,FX.jsx)", "Tio")}function lio(e){let t=(0,PX.c)(21),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`, "41651 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "k=(0,FX.jsx)(Md.div,{className:E,inert:o,\"data-composer-dark\":D,\"data-composer-drag-active\":O,", "k=(0,FX.jsx)(CPXComposerSurface,{native:Md.div,className:E,inert:o,\"data-composer-dark\":D,\"data-composer-drag-active\":O,", "41651 composer user entry marker render anchor");
    return replaceOnce(patched, "Ht=(0,z3.jsxs)(`div`,{className:Dt,\"data-codex-composer-root\":``,\"data-composer-placement\":se.kind,children:[kt,Vt]})", "Ht=(0,z3.jsxs)(CPXComposerSurface,{native:`div`,className:Dt,\"data-codex-composer-root\":``,\"data-composer-placement\":se.kind,children:[kt,Vt]})", "41651 active thread composer user entry marker anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function p_a(e){let t=(0,oV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,", `${composerSurfaceElementHook("(0,sV.jsx)", "k_a")}function p_a(e){let t=(0,oV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`, "61809 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "D=(0,sV.jsx)(Tf.div,{className:T,inert:o,\"data-composer-drag-active\":E,", "D=(0,sV.jsx)(CPXComposerSurface,{native:Tf.div,className:T,inert:o,\"data-composer-drag-active\":E,", "61809 composer user entry marker render anchor");
    return replaceOnce(patched, "jt=(0,i6.jsxs)(`div`,{className:ht,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,_t,At]})", "jt=(0,i6.jsxs)(CPXComposerSurface,{native:`div`,className:ht,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,_t,At]})", "61809 active thread composer user entry marker anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function WWc(e){let t=(0,GWc.c)(55),", `${composerSurfaceElementHook("(0,KWc.jsx)", "W4")}function WWc(e){let t=(0,GWc.c)(55),`, "22352 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "v=(0,KWc.jsx)(t8s,{className:n,inert:r,isDragActive:a,", "v=(0,KWc.jsx)(CPXComposerSurface,{native:t8s,className:n,inert:r,isDragActive:a,", "22352 home composer user entry marker render anchor");
    patched = replaceOnce(patched, "k=(0,KWc.jsx)(rV,{...f,className:S,inert:C,isDragActive:w,", "k=(0,KWc.jsx)(CPXComposerSurface,{native:rV,...f,className:S,inert:C,isDragActive:w,", "22352 composer user entry marker render anchor");
    return replaceOnce(patched, "xt=(0,a6.jsxs)(`div`,{className:ct,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,ut,bt]})", "xt=(0,a6.jsxs)(CPXComposerSurface,{native:`div`,className:ct,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,ut,bt]})", "22352 active thread composer user entry marker anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function ZWc(e){let t=(0,QWc.c)(55),", `${composerSurfaceElementHook("(0,$Wc.jsx)", "W4")}function ZWc(e){let t=(0,QWc.c)(55),`, "31338 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "v=(0,$Wc.jsx)(c8s,{className:n,inert:r,isDragActive:a,", "v=(0,$Wc.jsx)(CPXComposerSurface,{native:c8s,className:n,inert:r,isDragActive:a,", "31338 home composer user entry marker render anchor");
    patched = replaceOnce(patched, "k=(0,$Wc.jsx)(cV,{...f,className:S,inert:C,isDragActive:w,", "k=(0,$Wc.jsx)(CPXComposerSurface,{native:cV,...f,className:S,inert:C,isDragActive:w,", "31338 composer user entry marker render anchor");
    return replaceOnce(patched, "Et=(0,a6.jsxs)(`div`,{className:dt,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,pt,Tt]})", "Et=(0,a6.jsxs)(CPXComposerSurface,{native:`div`,className:dt,\"data-codex-composer-root\":``,\"data-composer-placement\":K.kind,children:[o,pt,Tt]})", "31338 active thread composer user entry marker anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function Kha(e){let t=(0,$B.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,", `${composerSurfaceElementHook("(0,eV.jsx)", "cga")}function Kha(e){let t=(0,$B.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`, "32112 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "D=(0,eV.jsx)(Tf.div,{className:T,inert:o,\"data-composer-drag-active\":E,", "D=(0,eV.jsx)(CPXComposerSurface,{native:Tf.div,className:T,inert:o,\"data-composer-drag-active\":E,", "32112 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function d_a(e){let t=(0,oV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,", `${composerSurfaceElementHook("(0,sV.jsx)", "D_a")}function d_a(e){let t=(0,oV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`, "41705 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "D=(0,sV.jsx)(Ef.div,{className:T,inert:o,\"data-composer-drag-active\":E,", "D=(0,sV.jsx)(CPXComposerSurface,{native:Ef.div,className:T,inert:o,\"data-composer-drag-active\":E,", "41705 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function Iha(e){let t=(0,aV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,", `${composerSurfaceElementHook("(0,oV.jsx)", "Qha")}function Iha(e){let t=(0,aV.c)(20),{children:n,className:r,animateRadius:i,utilityBarVariant:a,inert:o,isDragActive:s,layout:c,radiusVariant:l,surfaceOverflow:u,surfaceVariant:d,onDragEnter:f,onDragLeave:p,onDragOver:m,onDrop:h}=e,`, "21641 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "D=(0,oV.jsx)(Ef.div,{className:T,inert:o,\"data-composer-drag-active\":E,", "D=(0,oV.jsx)(CPXComposerSurface,{native:Ef.div,className:T,inert:o,\"data-composer-drag-active\":E,", "21641 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function dda(e){let t=(0,LV.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,", `${composerSurfaceElementHook("(0,RV.jsx)", "Dda")}function dda(e){let t=(0,LV.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`, "41407 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "w=(0,RV.jsx)(Af.div,{className:S,inert:a,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,role:`presentation`,onMouseDown:Eda,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})", "w=(0,RV.jsx)(CPXComposerSurface,{native:Af.div,className:S,inert:a,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,role:`presentation`,onMouseDown:Eda,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})", "41407 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function njo(e){let t=(0,aX.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,", `${composerSurfaceElementHook("(0,oX.jsx)", "GAo")}function njo(e){let t=(0,aX.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`, "26.810.41047 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "w=(0,oX.jsx)(np.div,{inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:_jo,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})", "w=(0,oX.jsx)(CPXComposerSurface,{native:np.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:_jo,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})", "26.810.41047 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function hgo(e){let t=(0,yX.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,", `${composerSurfaceElementHook("(0,bX.jsx)", "ego")}function hgo(e){let t=(0,yX.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`, "26.803.61601 composer user bubble helper insertion anchor");
    return replaceOnce(patched, "(w=(0,bX.jsx)(dp.div,{inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:Ago,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)", "(w=(0,bX.jsx)(CPXComposerSurface,{native:dp.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:Ago,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)", "26.803.61601 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function Ujo(e){let t=(0,yY.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,",
      `${composerSurfaceElementHook("(0,bY.jsx)", "aMo")}function Ujo(e){let t=(0,yY.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "52044 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "w=(0,bY.jsx)(zf.div,{inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:iMo,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})",
      "w=(0,bY.jsx)(CPXComposerSurface,{native:zf.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:iMo,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})",
      "52044 composer user entry marker render anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,EX.jsx)", "$ho")}function ugo(e){let t=(0,TX.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "81509 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      ...
      "(w=(0,EX.jsx)(CPXComposerSurface,{native:$f.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:Tgo,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "81509 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function f_o(e){let t=(0,SY.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,",
      `${composerSurfaceElementHook("(0,CY.jsx)", "t_o")}function f_o(e){let t=(0,SY.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "41515 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(w=(0,CY.jsx)(rp.div,{inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:D_o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "(w=(0,CY.jsx)(CPXComposerSurface,{native:rp.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:D_o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "41515 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function Uls(e){let t=(0,EJ.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,",
      `${composerSurfaceElementHook("(0,DJ.jsx)", "aus")}function Uls(e){let t=(0,EJ.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "61639 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(w=(0,DJ.jsx)(nf.div,{inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:ius,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "(w=(0,DJ.jsx)(CPXComposerSurface,{native:nf.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:ius,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "61639 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,OJ.jsx)", "YQ")}function Vls(e){let t=(0,DJ.c)(19),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "61309 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      ...
      "(w=(0,OJ.jsx)(CPXComposerSurface,{native:$d.div,inert:a,className:S,\"data-composer-drag-active\":C,\"data-composer-layout\":_,\"data-composer-radius-variant\":v,\"data-composer-surface-overflow\":y,\"data-composer-surface-variant\":b,\"data-composer-utility-bar-variant\":h,onMouseDown:nus,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[2]=n,t[3]=a,t[4]=_,t[5]=d,t[6]=f,t[7]=p,t[8]=m,t[9]=v,t[10]=y,t[11]=b,t[12]=S,t[13]=C,t[14]=h,t[15]=w)",
      "61309 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function bds(e){let t=(0,QJ.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,",
      `${composerSurfaceElementHook("(0,$J.jsx)", "Ids")}function bds(e){let t=(0,QJ.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "51351 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(k=(0,$J.jsx)(S,{inert:E,className:D,onMouseDown:Fds,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
      "(k=(0,$J.jsx)(CPXComposerSurface,{native:S,inert:E,className:D,onMouseDown:Fds,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
      "51351 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function yds(e){let t=(0,$J.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,",
      `${composerSurfaceElementHook("(0,eY.jsx)", "Fds")}function yds(e){let t=(0,$J.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "40816 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(k=(0,eY.jsx)(S,{inert:E,className:D,onMouseDown:Pds,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
      "(k=(0,eY.jsx)(CPXComposerSurface,{native:S,inert:E,className:D,onMouseDown:Pds,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
      "40816 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,nX.jsx)", "x5o")}function a5o(e){let t=(0,tX.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
    ...
    return replaceOnce(
      ...
      "(k=(0,nX.jsx)(CPXComposerSurface,{native:S,inert:E,className:D,onMouseDown:b5o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.31836")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,rX.jsx)", "x5o")}function a5o(e){let t=(0,nX.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
    ...
    return replaceOnce(
      ...
      "(k=(0,rX.jsx)(CPXComposerSurface,{native:S,inert:E,className:D,onMouseDown:b5o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n}),t[19]=S,t[20]=n,t[21]=d,t[22]=f,t[23]=p,t[24]=m,t[25]=E,t[26]=D,t[27]=k)",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      ...
      `${composerSurfaceElementHook("(0,rX.jsx)", "U8o")}function i5o(e){let t=(0,nX.c)(36),{children:n,className:r,utilityBarVariant:i,inert:a,isDragActive:o,layout:s,radiusVariant:c,surfaceOverflow:l,surfaceVariant:u,onDragEnter:d,onDragLeave:f,onDragOver:p,onDrop:m}=e,`,
      "30844 composer user bubble helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "k=(0,rX.jsx)(S,{inert:E,className:D,onMouseDown:y5o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})",
      "k=(0,rX.jsx)(CPXComposerSurface,{native:S,inert:E,className:D,onMouseDown:y5o,onDragEnter:d,onDragOver:p,onDragLeave:f,onDrop:m,children:n})",
      "30844 composer user entry marker render anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72028")) {
    let patched = replaceOnce(text, "function qk(e){let t=(0,Jk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Yk.jsx)", "Wk")}function qk(e){let t=(0,Jk.c)(55),`, "72028 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Yk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Yk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "72028 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Yk.jsx)(Ag,{className:n,inert:r,", "y=(0,Yk.jsx)(CPXComposerSurface,{native:Ag,className:n,inert:r,", "72028 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Yk.jsx)(Gy,{...p,className:C,", "A=(0,Yk.jsx)(CPXComposerSurface,{native:Gy,...p,className:C,", "72028 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72359")) {
    let patched = replaceOnce(text, "function qk(e){let t=(0,Jk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Yk.jsx)", "Wk")}function qk(e){let t=(0,Jk.c)(55),`, "72359 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Yk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Yk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "72359 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Yk.jsx)(Ag,{className:n,inert:r,", "y=(0,Yk.jsx)(CPXComposerSurface,{native:Ag,className:n,inert:r,", "72359 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Yk.jsx)(Gy,{...p,className:C,", "A=(0,Yk.jsx)(CPXComposerSurface,{native:Gy,...p,className:C,", "72359 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31925")) {
    let patched = replaceOnce(text, "function qk(e){let t=(0,Jk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Yk.jsx)", "Wk")}function qk(e){let t=(0,Jk.c)(55),`, "31925 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Yk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Yk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "31925 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Yk.jsx)(Mg,{className:n,inert:r,", "y=(0,Yk.jsx)(CPXComposerSurface,{native:Mg,className:n,inert:r,", "31925 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Yk.jsx)(Gy,{...p,className:C,", "A=(0,Yk.jsx)(CPXComposerSurface,{native:Gy,...p,className:C,", "31925 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31251")) {
    let patched = replaceOnce(text, "function qk(e){let t=(0,Jk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Yk.jsx)", "Wk")}function qk(e){let t=(0,Jk.c)(55),`, "31251 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Yk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Yk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "31251 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Yk.jsx)(Ag,{className:n,inert:r,", "y=(0,Yk.jsx)(CPXComposerSurface,{native:Ag,className:n,inert:r,", "31251 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Yk.jsx)(Gy,{...p,className:C,", "A=(0,Yk.jsx)(CPXComposerSurface,{native:Gy,...p,className:C,", "31251 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.21425")) {
    let patched = replaceOnce(text, "function Kk(e){let t=(0,qk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Jk.jsx)", "Uk")}function Kk(e){let t=(0,qk.c)(55),`, "21425 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Jk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Jk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "21425 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Jk.jsx)(Ag,{className:n,inert:r,", "y=(0,Jk.jsx)(CPXComposerSurface,{native:Ag,className:n,inert:r,", "21425 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Jk.jsx)(Uy,{...p,className:C,", "A=(0,Jk.jsx)(CPXComposerSurface,{native:Uy,...p,className:C,", "21425 composer user entry marker render anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) {
    let patched = replaceOnce(text, "function Wk(e){let t=(0,Gk.c)(55),", `${messageComposerHook()}${composerSurfaceElementHook("(0,Kk.jsx)", "Bk")}function Wk(e){let t=(0,Gk.c)(55),`, "21316 composer user bubble helper insertion anchor");
    patched = replaceOnce(patched, "p=(0,Kk.jsx)(`div`,{className:n,onDragEnter:r,", "p=(0,Kk.jsx)(CPXComposerSurface,{native:`div`,className:n,onDragEnter:r,", "21316 composer external surface marker anchor");
    patched = replaceOnce(patched, "y=(0,Kk.jsx)(Fg,{className:n,inert:r,", "y=(0,Kk.jsx)(CPXComposerSurface,{native:Fg,className:n,inert:r,", "21316 composer home surface marker anchor");
    return replaceOnce(patched, "A=(0,Kk.jsx)(Oy,{...p,className:C,", "A=(0,Kk.jsx)(CPXComposerSurface,{native:Oy,...p,className:C,", "21316 composer user entry marker render anchor");
  }
  if (
...
function patchComposerProjectColors(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      ...
      "re=(0,r8.jsx)(CPXComposerScope,{native:_br,project:m??globalThis.CodexPlusHost.adapters.context.active(),newChat:i==null,bridge:!0,ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "26.901.20858 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Uo=(e,t)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:J})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>HE({scope:J,path:e,cwd:t.workspaceRoot??Vn,hostId:t.hostId||globalThis.CodexPlusHost.adapters.context.active()?.hostId||Er||`local`,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Uo=(e,t)=>{let n=e.fsPath||e.path;",
      "26.901.20858 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      ...
      "re=(0,n8.jsx)(CPXComposerScope,{native:Hbr,project:m??globalThis.CodexPlusHost.adapters.context.active(),newChat:i==null,bridge:!0,ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "26.901.22334 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Bo=(e,t)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:K})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>GE({scope:K,path:e,cwd:t.workspaceRoot??Ln,hostId:t.hostId||globalThis.CodexPlusHost.adapters.context.active()?.hostId||Sr||`local`,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Bo=(e,t)=>{let n=e.fsPath||e.path;",
      "26.901.22334 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "re=(0,n8.jsx)(Kbr,{ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "re=(0,n8.jsx)(CPXComposerScope,{native:Kbr,project:m??globalThis.CodexPlusHost.adapters.context.active(),newChat:i==null,bridge:!0,ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "26.901.31953 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Bo=(e,t)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:q})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>fE({scope:q,path:e,cwd:t.workspaceRoot??zn,hostId:t.hostId??Or,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Bo=(e,t)=>{let n=e.fsPath||e.path;",
      "26.901.31953 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "re=(0,r8.jsx)(Bbr,{ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "re=(0,r8.jsx)(CPXComposerScope,{native:Bbr,project:m??globalThis.CodexPlusHost.adapters.context.active(),newChat:i==null,bridge:!0,ref:n,...h,composerLayoutMode:K,conversationId:i,",
      "26.901.41600 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Ho=(e,t)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:q})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>TS({scope:q,path:e,cwd:t.workspaceRoot??Bn,hostId:t.hostId??Ar,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Ho=(e,t)=>{let n=e.fsPath||e.path;",
      "26.901.41600 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "(0,R3.jsx)(ZEs,{animateRadius:e,className:j,utilityBarVariant:te,hasDropTargetPortal:oe!=null,", "(0,R3.jsx)(CPXComposerScope,{native:ZEs,project:bn||nt?null:{projectId:cte,cwd:yn,hostId:yr},newChat:W.value.kind===`new`,bridge:!0,animateRadius:e,className:j,utilityBarVariant:te,hasDropTargetPortal:oe!=null,", "41651 composer project surface anchor");
    return replaceOnce(patched, "cee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:W})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>YP({scope:W,path:e,cwd:t.workspaceRoot??xn,hostId:t.hostId??yr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),cee=(e,t)=>{let n=e.fsPath||e.path;", "41651 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "(0,r6.jsx)(eKc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,r6.jsx)(CPXComposerScope,{native:eKc,project:dn?null:{projectId:$ee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "61809 composer project surface anchor");
    patched = replaceOnce(patched, "kt=(0,i6.jsx)(orl,{aboveComposerHeaderContent:wt,", "kt=(0,i6.jsx)(CPXComposerScope,{native:orl,project:N,newChat:!1,bridge:!0,aboveComposerHeaderContent:wt,", "61809 active thread composer project scope anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>VN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "61809 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "(0,i6.jsx)(WWc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,i6.jsx)(CPXComposerScope,{native:WWc,project:dn?null:{projectId:$ee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "22352 composer project surface anchor");
    patched = replaceOnce(patched, "yt=(0,a6.jsx)(Xtl,{aboveComposerHeaderContent:ht,", "yt=(0,a6.jsx)(CPXComposerScope,{native:Xtl,project:N,newChat:!1,bridge:!0,aboveComposerHeaderContent:ht,", "22352 active thread composer project scope anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>LN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "22352 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "(0,i6.jsx)(ZWc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,i6.jsx)(CPXComposerScope,{native:ZWc,project:dn?null:{projectId:$ee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "31338 composer project surface anchor");
    patched = replaceOnce(patched, "wt=(0,a6.jsx)(rnl,{aboveComposerHeaderContent:bt,misalignmentPolicyViolationBanner:je,safetyBufferingBanner:s,disabled:Oe,activeCollaborationMode:Be,browserConversationId:n,collaborationModes:Ve,serviceTier:$e.serviceTierForRequest,", "wt=(0,a6.jsx)(CPXComposerScope,{native:rnl,project:N,newChat:!1,bridge:!0,aboveComposerHeaderContent:bt,misalignmentPolicyViolationBanner:je,safetyBufferingBanner:s,disabled:Oe,activeCollaborationMode:Be,browserConversationId:n,collaborationModes:Ve,serviceTier:$e.serviceTierForRequest,", "31338 active thread composer project scope anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>IN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "31338 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "(0,r6.jsx)(QWc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,r6.jsx)(CPXComposerScope,{native:QWc,project:dn?null:{projectId:$ee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "32112 composer project surface anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>PN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "32112 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "(0,r6.jsx)(QGc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,r6.jsx)(CPXComposerScope,{native:QGc,project:dn?null:{projectId:Qee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "41705 composer project surface anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>VN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "41705 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "(0,i6.jsx)(JUc,{className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "(0,i6.jsx)(CPXComposerScope,{native:JUc,project:dn?null:{projectId:$ee,cwd:un,hostId:ur},newChat:L.value.kind===`new`,bridge:!0,className:k,utilityBarVariant:B,hasDropTargetPortal:K!=null,", "21641 composer project surface anchor");
    return replaceOnce(patched, "iee=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:L})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>VN({scope:L,path:e,cwd:t.workspaceRoot??fn,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t)=>{let n=e.fsPath||e.path;", "21641 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "z=Y(Kb),B=Y(aP),V=!C||B?.type===`local`?B:null,", "z=Y(Kb),B=Y(aP),V=z??(B?.type===`local`?B:null),", "41407 home composer selected project anchor");
    patched = replaceOnce(patched, "(0,i6.jsx)(BAc,{className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,", "(0,i6.jsx)(CPXComposerScope,{native:BAc,project:b,newChat:F.value.kind===`new`,bridge:!0,className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,", "41407 composer project surface anchor");
    return replaceOnce(patched, "Za=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>_N({scope:F,path:e,cwd:t.workspaceRoot??ln,hostId:t.hostId??sr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Za=(e,t)=>{let n=e.fsPath||e.path;", "41407 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "(0,w3.jsx)(Q8s,{className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,", "(0,w3.jsx)(CPXComposerScope,{native:Q8s,project:ko==null?null:{projectId:ko},newChat:F.value.kind===`new`,className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,", "26.810.41047 composer project surface anchor");
    return replaceOnce(patched, "Va=(e,t)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>gI({scope:F,path:e,cwd:t.workspaceRoot??tn,hostId:t.hostId??$n,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Va=(e,t)=>{let n=e.fsPath||e.path;", "26.810.41047 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "(0,E3.jsx)(aWs,{className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,", "(0,E3.jsx)(CPXComposerScope,{native:aWs,project:un?null:{cwd:ln,hostId:lr},newChat:F.value.kind===`new`,className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,", "26.803.61601 composer project surface anchor");
    return replaceOnce(patched, "Ya=(e,t=lr)=>{let n=e.fsPath||e.path;", "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>yF({scope:F,path:e,cwd:t.workspaceRoot??dn,hostConfig:ur,hostId:t.hostId??lr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Ya=(e,t=lr)=>{let n=e.fsPath||e.path;", "26.803.61601 composer-native file opener adapter anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "(0,C3.jsx)(m5s,{className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,",
      "(0,C3.jsx)(CPXComposerScope,{native:m5s,project:b,newChat:F.value.kind===`new`,className:D,utilityBarVariant:R,hasDropTargetPortal:W!=null,",
      "52044 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Va=(e,t)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>$F({scope:F,path:e,cwd:t.workspaceRoot??tn,hostId:t.hostId??$n,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Va=(e,t)=>{let n=e.fsPath||e.path;",
      "52044 composer-native file opener adapter anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "(0,D3.jsx)(wWs,{className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "(0,D3.jsx)(CPXComposerScope,{native:wWs,project:Po==null?null:{projectId:Po},newChat:F.value.kind===`new`,className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "81509 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Xa=(e,t=lr)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>TF({scope:F,path:e,cwd:t.workspaceRoot??dn,hostConfig:ur,hostId:t.hostId??lr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Xa=(e,t=lr)=>{let n=e.fsPath||e.path;",
      "81509 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      ...
      "(0,D3.jsx)(CPXComposerScope,{native:iWs,project:ko==null?null:{projectId:ko},newChat:F.value.kind===`new`,className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "41515 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Ka=(e,t=lr)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>wF({scope:F,path:e,cwd:t.workspaceRoot??dn,hostConfig:ur,hostId:t.hostId??lr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),Ka=(e,t=lr)=>{let n=e.fsPath||e.path;",
      "41515 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "(0,XQ.jsx)(SXs,{className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "(0,XQ.jsx)(CPXComposerScope,{native:SXs,project:y,newChat:F.value.kind===`new`,className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "61639 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "lee=(e,t=ur)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>AM({scope:F,path:e,cwd:t.workspaceRoot??ln,hostConfig:dr,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),lee=(e,t=ur)=>{let n=e.fsPath||e.path;",
      "61639 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      "(0,XQ.jsx)(CPXComposerScope,{native:CXs,project:y,newChat:F.value.kind===`new`,className:E,utilityBarVariant:L,hasDropTargetPortal:W!=null,",
      "61309 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "uee=(e,t=ur)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>EM({scope:F,path:e,cwd:t.workspaceRoot??ln,hostConfig:dr,hostId:t.hostId??ur,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),uee=(e,t=ur)=>{let n=e.fsPath||e.path;",
      "61309 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      ...
      "(0,JQ.jsx)(CPXComposerScope,{native:XXs,project:y,newChat:P.value.kind===`new`,className:E,utilityBarVariant:I,hasDropTargetPortal:U!=null,",
      "51351 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "iee=(e,t=sr)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:P})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>Wj({scope:P,path:e,cwd:t.workspaceRoot??sn,hostConfig:cr,hostId:t.hostId??sr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t=sr)=>{let n=e.fsPath||e.path;",
      "51351 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      ...
      "(0,YQ.jsx)(CPXComposerScope,{native:YXs,project:y,newChat:P.value.kind===`new`,className:E,utilityBarVariant:I,hasDropTargetPortal:U!=null,",
      "40816 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "iee=(e,t=sr)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:P})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>Gj({scope:P,path:e,cwd:t.workspaceRoot??sn,hostConfig:cr,hostId:t.hostId??sr,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),iee=(e,t=sr)=>{let n=e.fsPath||e.path;",
      "40816 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
      ...
      "(0,R$.jsx)(CPXComposerScope,{native:bPs,project:y,newChat:F.value.kind===`new`,className:D,utilityBarVariant:L,hasDropTargetPortal:Xee,",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.31836")) {
    let patched = replaceOnce(
      ...
      "(0,z$.jsx)(CPXComposerScope,{native:YNs,project:y,newChat:F.value.kind===`new`,className:D,utilityBarVariant:L,hasDropTargetPortal:tte,",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      ...
      "(0,R$.jsx)(CPXComposerScope,{native:YNs,project:y,newChat:F.value.kind===`new`,className:D,utilityBarVariant:L,hasDropTargetPortal:Xee,",
      "30844 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "$a=(e,t=or)=>{let n=e.fsPath||e.path;",
      "CPXSP=globalThis.CodexPlusHost.adapters.threadSidePanel,CPXM=CPXSP.bindMount(()=>({scope:F})),CPXOpenFile=CPXSP.bindOpenFile((e,t={})=>RM({scope:F,path:e,cwd:t.workspaceRoot??on,hostConfig:sr,hostId:t.hostId??or,line:t.line,endLine:t.endLine,isPreview:t.isPreview,title:t.title,openInSidePanel:!0})),$a=(e,t=or)=>{let n=e.fsPath||e.path;",
      "30844 composer-native file opener adapter anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72028")) {
    let patched = replaceOnce(
      text,
      "ol??(0,bW.jsx)(qk,{className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "ol??(0,bW.jsx)(CPXComposerScope,{native:qk,project:Y==null?T:null,newChat:Y==null,className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "72028 composer project surface anchor",
    );
    return replaceOnce(
      patched,
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72359")) {
    let patched = replaceOnce(
      ...
      "ol??(0,bW.jsx)(qk,{className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "ol??(0,bW.jsx)(CPXComposerScope,{native:qk,project:Y==null?T:null,newChat:Y==null,className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "72359 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Qo=(e,t=Ir)=>{let n=e.fsPath||e.path;",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31925")) {
    let patched = replaceOnce(
      text,
      "al??(0,bW.jsx)(qk,{className:P,utilityBarVariant:ne,hasDropTargetPortal:Hc,",
      "al??(0,bW.jsx)(CPXComposerScope,{native:qk,project:Y==null?T:null,newChat:Y==null,className:P,utilityBarVariant:ne,hasDropTargetPortal:Hc,",
      "31925 composer project surface anchor",
    );
    return replaceOnce(
      patched,
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.31251")) {
    let patched = replaceOnce(
      text,
      "sl??(0,bW.jsx)(qk,{className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "sl??(0,bW.jsx)(CPXComposerScope,{native:qk,project:Y==null?T:null,newChat:Y==null,className:P,utilityBarVariant:ne,hasDropTargetPortal:Wc,",
      "31251 composer project surface anchor",
    );
    return replaceOnce(
      patched,
      "Qo=(e,t=Ir)=>{let n=e.fsPath||e.path;",
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.21425")) {
    let patched = replaceOnce(
      text,
      "cl??(0,yW.jsx)(Kk,{className:P,utilityBarVariant:ne,hasDropTargetPortal:Gc,",
      "cl??(0,yW.jsx)(CPXComposerScope,{native:Kk,project:J==null?T:null,newChat:J==null,className:P,utilityBarVariant:ne,hasDropTargetPortal:Gc,",
      "21425 composer project surface anchor",
    );
    return replaceOnce(
      patched,
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) {
    let patched = replaceOnce(
      text,
      "Wl??(0,xW.jsx)(Wk,{className:P,utilityBarVariant:W,hasDropTargetPortal:Cl,",
      "Wl??(0,xW.jsx)(CPXComposerScope,{native:Wk,project:Y==null?T:null,newChat:Y==null,className:P,utilityBarVariant:W,hasDropTargetPortal:Cl,",
      "21316 composer project surface anchor",
    );
    return replaceOnce(
      patched,
  ...
  if (text.includes("(0,tJ.jsx)(Zq,{...CPXSurfaceProps({}),className:w,utilityBarVariant:C,hasDropTargetPortal:Hc,")) {
    let patched = replaceOnce(
      text,
      "(0,tJ.jsx)(Zq,{...CPXSurfaceProps({}),className:w,utilityBarVariant:C,hasDropTargetPortal:Hc,",
      "(0,tJ.jsx)(Zq,{key:CPXSurfaceProps({project:H==null?(rn??(gn?null:{cwd:hn,hostId:jr})):globalThis.CodexPlusHost.adapters.context.active(),newChat:H==null})?.[`data-codex-plus-project-color`]??``,codexPlusProps:CPXSurfaceProps({project:H==null?(rn??(gn?null:{cwd:hn,hostId:jr})):globalThis.CodexPlusHost.adapters.context.active(),newChat:H==null}),className:w,utilityBarVariant:C,hasDropTargetPortal:Hc,",
  ...
  if (
    ...
    let patched = replaceOnce(
      ...
      "):(0,E$.jsx)(PUe,{key:CPXSurfaceProps({project:N.value.kind===`new`?(Bt??(tn?null:{cwd:en,hostId:K.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:N.value.kind===`new`})?.[`data-codex-plus-project-color`]??``,codexPlusProps:CPXSurfaceProps({project:N.value.kind===`new`?(Bt??(tn?null:{cwd:en,hostId:K.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:N.value.kind===`new`}),className:C,utilityBarVariant:S,hasDropTargetPortal:_s,",
      "61608 composer canonical project context anchor",
    );
    return replaceOnce(
      patched,
  ...
  if (
    ...
    let patched = replaceOnce(
      ...
      "):(0,Eq.jsx)(Sq,{key:CPXSurfaceProps({project:B.value.kind===`new`?(un??(kn?null:{cwd:On,hostId:Q.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:B.value.kind===`new`})?.[`data-codex-plus-project-color`]??``,codexPlusProps:CPXSurfaceProps({project:B.value.kind===`new`?(un??(kn?null:{cwd:On,hostId:Q.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:B.value.kind===`new`}),className:k,utilityBarVariant:D,hasDropTargetPortal:Qc,",
  ...
  if (text.includes("clientThreadId:R,interactionsDisabled:B}){let V=ri(No),") && text.includes("):(0,m5.jsx)(u5,{className:E,utilityBarVariant:T,hasDropTargetPortal:zc,")) {
    let patched = replaceOnce(
      ...
      "):(0,m5.jsx)(u5,{key:CPXSurfaceProps({project:V.value.kind===`new`?(hn??(On?null:{cwd:Dn,hostId:le.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:V.value.kind===`new`})?.[`data-codex-plus-project-color`]??``,codexPlusProps:CPXSurfaceProps({project:V.value.kind===`new`?(hn??(On?null:{cwd:Dn,hostId:le.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:V.value.kind===`new`}),className:E,utilityBarVariant:T,hasDropTargetPortal:zc,",
  ...
  if (text.includes("clientThreadId:j,interactionsDisabled:M}){let N=ia(Db),") && text.includes("):(0,QY.jsx)(JY,{className:w,utilityBarVariant:C,hasDropTargetPortal:kc,")) {
    return replaceOnce(
      ...
      "):(0,QY.jsx)(JY,{key:CPXSurfaceProps({project:N.value.kind===`new`?(fn??(Dn?null:{cwd:En,hostId:K.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:N.value.kind===`new`})?.[`data-codex-plus-project-color`]??``,codexPlusProps:CPXSurfaceProps({project:N.value.kind===`new`?(fn??(Dn?null:{cwd:En,hostId:K.hostId})):globalThis.CodexPlusHost.adapters.context.active(),newChat:N.value.kind===`new`}),className:w,utilityBarVariant:C,hasDropTargetPortal:kc,",
...
function patchElectronMenuShortcuts(text) {
  const currentToggleSidebar = "{id:`toggleSidebar`,titleIntlId:`codex.command.toggleSidebar`,descriptionIntlId:`codex.commandDescription.toggleSidebar`,commandMenuGroupKey:`panels`,commandMenu:!0,browser:{defaultKeybindings:[{key:`CmdOrCtrl+Shift+S`}]},electron:{menuTitle:`Toggle Sidebar`,menuTitleIntlId:`codex.commandMenuTitle.toggleSidebar`,defaultKeybindings:[{key:`CmdOrCtrl+B`}]}}";
  if (text.includes(currentToggleSidebar)) {
    return replaceOnce(
      text,
      `${currentToggleSidebar},{id:\`toggleBottomPanel\`,`,
      `${currentToggleSidebar},{id:\`codexPlus.focusProjectSelector\`,title:\`Focus project selector\`,description:\`Focus or open the new chat project selector\`,commandMenuGroupKey:\`workspace\`,commandMenu:!0,electron:{menuTitle:\`Focus project selector\`,defaultKeybindings:[{key:\`CmdOrCtrl+.\`}]}},{id:\`codexPlusToggleSidebarNameBlur\`,title:\`Toggle sidebar blur\`,description:\`Blur or show sidebar chat and project names\`,commandMenuGroupKey:\`panels\`,commandMenu:!0,electron:{menuTitle:\`Toggle sidebar blur\`,defaultKeybindings:[]}},{id:\`toggleBottomPanel\`,`,
      "current sidebar blur command palette metadata anchor",
    );
  }
  return replaceOnce(
    text,
...
function patchKeyboardShortcutsSearchInput(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    return replaceOnce(
      text,
      "function Nqo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(Iqo):e.id===`composer.captureAppshot`?Cqo(t).title:`titleIntlId`in e?Fqo(Lqo,e.titleIntlId)?t.formatMessage(Lqo[e.titleIntlId]):Eqo(t,e.id):t.formatMessage(Rqo[e.electron.menuTitleIntlId])}",
      "function Nqo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(Iqo):e.id===`composer.captureAppshot`?Cqo(t).title:`titleIntlId`in e?Fqo(Lqo,e.titleIntlId)?t.formatMessage(Lqo[e.titleIntlId]):Eqo(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Rqo[e.electron.menuTitleIntlId])}",
      "26.901.20858 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    return replaceOnce(
      text,
      "function Kqo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(Yqo):e.id===`composer.captureAppshot`?Iqo(t).title:`titleIntlId`in e?Jqo(Xqo,e.titleIntlId)?t.formatMessage(Xqo[e.titleIntlId]):zqo(t,e.id):t.formatMessage(Zqo[e.electron.menuTitleIntlId])}",
      "function Kqo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(Yqo):e.id===`composer.captureAppshot`?Iqo(t).title:`titleIntlId`in e?Jqo(Xqo,e.titleIntlId)?t.formatMessage(Xqo[e.titleIntlId]):zqo(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Zqo[e.electron.menuTitleIntlId])}",
      "26.901.22334 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    return replaceOnce(
      text,
      "function fJo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(hJo):e.id===`composer.captureAppshot`?nJo(t).title:`titleIntlId`in e?mJo(gJo,e.titleIntlId)?t.formatMessage(gJo[e.titleIntlId]):aJo(t,e.id):t.formatMessage(_Jo[e.electron.menuTitleIntlId])}",
      "function fJo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(hJo):e.id===`composer.captureAppshot`?nJo(t).title:`titleIntlId`in e?mJo(gJo,e.titleIntlId)?t.formatMessage(gJo[e.titleIntlId]):aJo(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(_Jo[e.electron.menuTitleIntlId])}",
      "26.901.31953 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    return replaceOnce(
      text,
      "function RJo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(VJo):e.id===`composer.captureAppshot`?OJo(t).title:`titleIntlId`in e?BJo(HJo,e.titleIntlId)?t.formatMessage(HJo[e.titleIntlId]):jJo(t,e.id):t.formatMessage(UJo[e.electron.menuTitleIntlId])}",
      "function RJo(e,t,n=!1){return e.id===`openAvatarOverlay`&&n?t.formatMessage(VJo):e.id===`composer.captureAppshot`?OJo(t).title:`titleIntlId`in e?BJo(HJo,e.titleIntlId)?t.formatMessage(HJo[e.titleIntlId]):jJo(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(UJo[e.electron.menuTitleIntlId])}",
      "26.901.41600 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    return replaceOnce(text, "function Erl(e,t){return e.id===`composer.captureAppshot`?vrl(t).title:`titleIntlId`in e?Orl(krl,e.titleIntlId)?t.formatMessage(krl[e.titleIntlId]):xrl(t,e.id):t.formatMessage(Arl[e.electron.menuTitleIntlId])}", "function Erl(e,t){return e.id===`composer.captureAppshot`?vrl(t).title:`titleIntlId`in e?Orl(krl,e.titleIntlId)?t.formatMessage(krl[e.titleIntlId]):xrl(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Arl[e.electron.menuTitleIntlId])}", "26.825.41651 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    return replaceOnce(text, "function q7l(e,t){return e.id===`composer.captureAppshot`?z7l(t).title:`titleIntlId`in e?Y7l(X7l,e.titleIntlId)?t.formatMessage(X7l[e.titleIntlId]):H7l(t,e.id):t.formatMessage(Z7l[e.electron.menuTitleIntlId])}", "function q7l(e,t){return e.id===`composer.captureAppshot`?z7l(t).title:`titleIntlId`in e?Y7l(X7l,e.titleIntlId)?t.formatMessage(X7l[e.titleIntlId]):H7l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Z7l[e.electron.menuTitleIntlId])}", "26.818.61809 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    return replaceOnce(text, "function M5l(e,t){return e.id===`composer.captureAppshot`?w5l(t).title:`titleIntlId`in e?P5l(F5l,e.titleIntlId)?t.formatMessage(F5l[e.titleIntlId]):D5l(t,e.id):t.formatMessage(I5l[e.electron.menuTitleIntlId])}", "function M5l(e,t){return e.id===`composer.captureAppshot`?w5l(t).title:`titleIntlId`in e?P5l(F5l,e.titleIntlId)?t.formatMessage(F5l[e.titleIntlId]):D5l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(I5l[e.electron.menuTitleIntlId])}", "26.818.22352 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    return replaceOnce(text, "function z5l(e,t){return e.id===`composer.captureAppshot`?j5l(t).title:`titleIntlId`in e?V5l(H5l,e.titleIntlId)?t.formatMessage(H5l[e.titleIntlId]):P5l(t,e.id):t.formatMessage(U5l[e.electron.menuTitleIntlId])}", "function z5l(e,t){return e.id===`composer.captureAppshot`?j5l(t).title:`titleIntlId`in e?V5l(H5l,e.titleIntlId)?t.formatMessage(H5l[e.titleIntlId]):P5l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(U5l[e.electron.menuTitleIntlId])}", "26.818.31338 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    return replaceOnce(text, "function B5l(e,t){return e.id===`composer.captureAppshot`?M5l(t).title:`titleIntlId`in e?H5l(U5l,e.titleIntlId)?t.formatMessage(U5l[e.titleIntlId]):F5l(t,e.id):t.formatMessage(W5l[e.electron.menuTitleIntlId])}", "function B5l(e,t){return e.id===`composer.captureAppshot`?M5l(t).title:`titleIntlId`in e?H5l(U5l,e.titleIntlId)?t.formatMessage(U5l[e.titleIntlId]):F5l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(W5l[e.electron.menuTitleIntlId])}", "26.818.32112 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    return replaceOnce(text, "function G7l(e,t){return e.id===`composer.captureAppshot`?L7l(t).title:`titleIntlId`in e?q7l(J7l,e.titleIntlId)?t.formatMessage(J7l[e.titleIntlId]):B7l(t,e.id):t.formatMessage(Y7l[e.electron.menuTitleIntlId])}", "function G7l(e,t){return e.id===`composer.captureAppshot`?L7l(t).title:`titleIntlId`in e?q7l(J7l,e.titleIntlId)?t.formatMessage(J7l[e.titleIntlId]):B7l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Y7l[e.electron.menuTitleIntlId])}", "26.818.41705 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    return replaceOnce(text, "function R8l(e,t){return e.id===`composer.captureAppshot`?A8l(t).title:`titleIntlId`in e?B8l(V8l,e.titleIntlId)?t.formatMessage(V8l[e.titleIntlId]):N8l(t,e.id):t.formatMessage(H8l[e.electron.menuTitleIntlId])}", "function R8l(e,t){return e.id===`composer.captureAppshot`?A8l(t).title:`titleIntlId`in e?B8l(V8l,e.titleIntlId)?t.formatMessage(V8l[e.titleIntlId]):N8l(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(H8l[e.electron.menuTitleIntlId])}", "26.818.21641 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(text, "function kZl(e,t){return e.id===`composer.captureAppshot`?xZl(t).title:`titleIntlId`in e?jZl(MZl,e.titleIntlId)?t.formatMessage(MZl[e.titleIntlId]):wZl(t,e.id):t.formatMessage(NZl[e.electron.menuTitleIntlId])}", "function kZl(e,t){return e.id===`composer.captureAppshot`?xZl(t).title:`titleIntlId`in e?jZl(MZl,e.titleIntlId)?t.formatMessage(MZl[e.titleIntlId]):wZl(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(NZl[e.electron.menuTitleIntlId])}", "26.814.41407 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    return replaceOnce(text, "function Del(e,t){return e.id===`composer.captureAppshot`?yel(t).title:`titleIntlId`in e?kel(Ael,e.titleIntlId)?t.formatMessage(Ael[e.titleIntlId]):Sel(t,e.id):t.formatMessage(jel[e.electron.menuTitleIntlId])}", "function Del(e,t){return e.id===`composer.captureAppshot`?yel(t).title:`titleIntlId`in e?kel(Ael,e.titleIntlId)?t.formatMessage(Ael[e.titleIntlId]):Sel(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(jel[e.electron.menuTitleIntlId])}", "26.803.61601 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    return replaceOnce(text, "function SCl(e,t){return e.id===`composer.captureAppshot`?mCl(t).title:`titleIntlId`in e?wCl(TCl,e.titleIntlId)?t.formatMessage(TCl[e.titleIntlId]):_Cl(t,e.id):t.formatMessage(ECl[e.electron.menuTitleIntlId])}", "function SCl(e,t){return e.id===`composer.captureAppshot`?mCl(t).title:`titleIntlId`in e?wCl(TCl,e.titleIntlId)?t.formatMessage(TCl[e.titleIntlId]):_Cl(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(ECl[e.electron.menuTitleIntlId])}", "26.810.41047 generic command metadata title fallback anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715")) return text;
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    return replaceOnce(
      text,
      "function wCl(e,t){return e.id===`composer.captureAppshot`?gCl(t).title:`titleIntlId`in e?ECl(DCl,e.titleIntlId)?t.formatMessage(DCl[e.titleIntlId]):yCl(t,e.id):t.formatMessage(OCl[e.electron.menuTitleIntlId])}",
      "function wCl(e,t){return e.id===`composer.captureAppshot`?gCl(t).title:`titleIntlId`in e?ECl(DCl,e.titleIntlId)?t.formatMessage(DCl[e.titleIntlId]):yCl(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(OCl[e.electron.menuTitleIntlId])}",
      "52044 generic command metadata title fallback anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    return replaceOnce(
      text,
      "function Kel(e,t){return e.id===`composer.captureAppshot`?Rel(t).title:`titleIntlId`in e?Jel(Yel,e.titleIntlId)?t.formatMessage(Yel[e.titleIntlId]):Vel(t,e.id):t.formatMessage(Xel[e.electron.menuTitleIntlId])}",
      "function Kel(e,t){return e.id===`composer.captureAppshot`?Rel(t).title:`titleIntlId`in e?Jel(Yel,e.titleIntlId)?t.formatMessage(Yel[e.titleIntlId]):Vel(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Xel[e.electron.menuTitleIntlId])}",
      "81509 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    return replaceOnce(
      text,
      "function Tel(e,t){return e.id===`composer.captureAppshot`?_el(t).title:`titleIntlId`in e?Del(Oel,e.titleIntlId)?t.formatMessage(Oel[e.titleIntlId]):bel(t,e.id):t.formatMessage(kel[e.electron.menuTitleIntlId])}",
      "function Tel(e,t){return e.id===`composer.captureAppshot`?_el(t).title:`titleIntlId`in e?Del(Oel,e.titleIntlId)?t.formatMessage(Oel[e.titleIntlId]):bel(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(kel[e.electron.menuTitleIntlId])}",
      "41515 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    return replaceOnce(
      text,
      "function xLu(e,t){return e.id===`composer.captureAppshot`?pLu(t).title:`titleIntlId`in e?CLu(wLu,e.titleIntlId)?t.formatMessage(wLu[e.titleIntlId]):gLu(t,e.id):t.formatMessage(TLu[e.electron.menuTitleIntlId])}",
      "function xLu(e,t){return e.id===`composer.captureAppshot`?pLu(t).title:`titleIntlId`in e?CLu(wLu,e.titleIntlId)?t.formatMessage(wLu[e.titleIntlId]):gLu(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(TLu[e.electron.menuTitleIntlId])}",
      "61639 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    return replaceOnce(
      text,
      "function SLu(e,t){return e.id===`composer.captureAppshot`?mLu(t).title:`titleIntlId`in e?wLu(TLu,e.titleIntlId)?t.formatMessage(TLu[e.titleIntlId]):_Lu(t,e.id):t.formatMessage(ELu[e.electron.menuTitleIntlId])}",
      "function SLu(e,t){return e.id===`composer.captureAppshot`?mLu(t).title:`titleIntlId`in e?wLu(TLu,e.titleIntlId)?t.formatMessage(TLu[e.titleIntlId]):_Lu(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(ELu[e.electron.menuTitleIntlId])}",
      "61309 generic command metadata title fallback anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    return replaceOnce(
      text,
      "function Vku(e,t){return e.id===`composer.captureAppshot`?Nku(t).title:`titleIntlId`in e?Uku(Wku,e.titleIntlId)?t.formatMessage(Wku[e.titleIntlId]):Iku(t,e.id):t.formatMessage(Gku[e.electron.menuTitleIntlId])}",
      "function Vku(e,t){return e.id===`composer.captureAppshot`?Nku(t).title:`titleIntlId`in e?Uku(Wku,e.titleIntlId)?t.formatMessage(Wku[e.titleIntlId]):Iku(t,e.id):e.title??e.electron?.menuTitle??t.formatMessage(Gku[e.electron.menuTitleIntlId])}",
      "40816 generic command metadata title fallback anchor",
    );
  }
...
function patchCommandMenuRuntimeCommands(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function tQo(e){\"use forget\";let t=(0,s8.c)(181),",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,l8.jsx)(lQo,{command:e,close:t,description:r,title:n},e.id)}function tQo(e){\"use forget\";let t=(0,s8.c)(181),",
      "26.901.20858 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "let N=M;ae=[];let I=r.filter(cQo);",
      "let N=M;ae=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,l8.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let I=r.filter(cQo);",
      "26.901.20858 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "d=()=>{r.id===`searchChats`&&a(),uU(r.id,`command_menu`),r.id!==`searchChats`&&n()}",
      "d=()=>{r.id===`searchChats`&&a();let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(uU(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}",
      "26.901.20858 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      text,
      "function mQo(e){\"use forget\";let t=(0,c8.c)(181),",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,u8.jsx)(SQo,{command:e,close:t,description:r,title:n},e.id)}function mQo(e){\"use forget\";let t=(0,c8.c)(181),",
      "26.901.22334 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "let N=M;ae=[];let I=r.filter(xQo);",
      "let N=M;ae=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,u8.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let I=r.filter(xQo);",
      "26.901.22334 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "d=()=>{r.id===`searchChats`&&a(),uU(r.id,`command_menu`),r.id!==`searchChats`&&n()}",
      "d=()=>{r.id===`searchChats`&&a();let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(uU(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}",
      "26.901.22334 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "function PQo(e){\"use forget\";let t=(0,q6.c)(181),",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,Y6.jsx)(HQo,{command:e,close:t,description:r,title:n},e.id)}function PQo(e){\"use forget\";let t=(0,q6.c)(181),",
      "26.901.31953 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "let N=M;ae=[];let I=r.filter(VQo);",
      "let N=M;ae=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,Y6.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let I=r.filter(VQo);",
      "26.901.31953 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "d=()=>{r.id===`searchChats`&&a(),aU(r.id,`command_menu`),r.id!==`searchChats`&&n()}",
      "d=()=>{r.id===`searchChats`&&a();let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(aU(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}",
      "26.901.31953 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "function o$o(e){\"use forget\";let t=(0,q6.c)(181),",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,Y6.jsx)(m$o,{command:e,close:t,description:r,title:n},e.id)}function o$o(e){\"use forget\";let t=(0,q6.c)(181),",
      "26.901.41600 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "let N=M;ae=[];let I=r.filter(p$o);",
      "let N=M;ae=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,Y6.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let I=r.filter(p$o);",
      "26.901.41600 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "d=()=>{r.id===`searchChats`&&a(),iU(r.id,`command_menu`),r.id!==`searchChats`&&n()}",
      "d=()=>{r.id===`searchChats`&&a();let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(iU(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}",
      "26.901.41600 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function iil(e){let t=(0,q7.c)(153),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,Y7.jsx)(cZ,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function iil(e){let t=(0,q7.c)(153),", "26.825.41651 command palette plugin item anchor");
    patched = replaceOnce(patched, "let W=N;H=[];let G=r.filter(dil);", "let W=N;H=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,Y7.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let G=r.filter(dil);", "26.825.41651 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{RM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(RM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.825.41651 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function T9l(e){let t=(0,t9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(M1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function T9l(e){let t=(0,t9.c)(146),", "26.818.61809 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(M9l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(M9l);", "26.818.61809 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{eN(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(eN(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.61809 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function u7l(e){let t=(0,t9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(k1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function u7l(e){let t=(0,t9.c)(146),", "26.818.22352 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(_7l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(_7l);", "26.818.22352 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{XM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(XM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.22352 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function _7l(e){let t=(0,t9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(k1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function _7l(e){let t=(0,t9.c)(146),", "26.818.31338 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(w7l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(w7l);", "26.818.31338 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{KM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(KM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.31338 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function v7l(e){let t=(0,e9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,n9.jsx)(O1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function v7l(e){let t=(0,e9.c)(146),", "26.818.32112 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(T7l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,n9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(T7l);", "26.818.32112 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{qM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(qM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.32112 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function C9l(e){let t=(0,t9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(M1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function C9l(e){let t=(0,t9.c)(146),", "26.818.41705 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(A9l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(A9l);", "26.818.41705 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{eN(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(eN(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.41705 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function g5l(e){let t=(0,t9.c)(146),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(O1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function g5l(e){let t=(0,t9.c)(146),", "26.818.21641 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(C5l);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(C5l);", "26.818.21641 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{ZM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(ZM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.818.21641 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function hQl(e){let t=(0,t9.c)(16),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,r9.jsx)(i1,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function hQl(e){let t=(0,t9.c)(16),", "26.814.41407 command palette plugin item anchor");
    patched = replaceOnce(patched, "let H=V;L=[];let U=r.filter(mQl);", "let H=V;L=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,r9.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let U=r.filter(mQl);", "26.814.41407 command palette plugin item mount anchor");
    return replaceOnce(patched, "u=()=>{xM(r.id,`command_menu`),r.id!==`searchChats`&&n()}", "u=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(xM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()}", "26.814.41407 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function ttl({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,q7.jsx)(E1,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function ttl({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){", "26.803.61601 command palette plugin item anchor");
    patched = replaceOnce(patched, "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=Oel(t,o,UEr(m,t.id)),i=n?o.formatMessage(J7.tuckAwayPet):r.title;return(0,q7.jsx)(ntl,{command:t,close:e,description:n?o.formatMessage(J7.tuckAwayPetDescription):r.description,title:i},t.id)},F=[],I=", "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=Oel(t,o,UEr(m,t.id)),i=n?o.formatMessage(J7.tuckAwayPet):r.title;return(0,q7.jsx)(ntl,{command:t,close:e,description:n?o.formatMessage(J7.tuckAwayPetDescription):r.description,title:i},t.id)},F=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,q7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),I=", "26.803.61601 command palette plugin item mount anchor");
    return replaceOnce(patched, "c=()=>{SM(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];", "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(SM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];", "26.803.61601 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function ewl(e){let t=(0,G7.c)(143),", "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,q7.jsx)(q$,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function ewl(e){let t=(0,G7.c)(143),", "26.810.41047 command palette plugin item anchor");
    patched = replaceOnce(patched, "let V=B;F=[];let H=r.filter(swl);", "let V=B;F=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,q7.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let H=r.filter(swl);", "26.810.41047 command palette plugin item mount anchor");
    return replaceOnce(patched, "c=()=>{UN(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];", "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(UN(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];", "26.810.41047 command menu stable dispatch anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function nwl(e){let t=(0,G7.c)(143),",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,q7.jsx)(HQ,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function nwl(e){let t=(0,G7.c)(143),",
      "52044 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "let V=B;F=[];let H=r.filter(lwl);",
      "let V=B;F=globalThis.CodexPlusHost.adapters.commands.metadata().map(e=>(0,q7.jsx)(CPXCommandPaletteItem,{command:e,close:n},e.id));let H=r.filter(lwl);",
      "52044 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{vN(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(vN(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "52044 command menu stable dispatch anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function btl({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,J7.jsx)(E1,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function btl({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "81509 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=qel(t,o,AEr(m,t.id)),i=n?o.formatMessage(Y7.tuckAwayPet):r.title;return(0,J7.jsx)(xtl,{command:t,close:e,description:n?o.formatMessage(Y7.tuckAwayPetDescription):r.description,title:i},t.id)},F=[],I=",
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=qel(t,o,AEr(m,t.id)),i=n?o.formatMessage(Y7.tuckAwayPet):r.title;return(0,J7.jsx)(xtl,{command:t,close:e,description:n?o.formatMessage(Y7.tuckAwayPetDescription):r.description,title:i},t.id)},F=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,J7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),I=",
      "81509 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{IM(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(IM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "81509 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function $el({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,J7.jsx)(G$,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function $el({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "41515 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=Eel(t,o,WEr(m,t.id)),i=n?o.formatMessage(Y7.tuckAwayPet):r.title;return(0,J7.jsx)(etl,{command:t,close:e,description:n?o.formatMessage(Y7.tuckAwayPetDescription):r.description,title:i},t.id)},F=[],I=",
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=Eel(t,o,WEr(m,t.id)),i=n?o.formatMessage(Y7.tuckAwayPet):r.title;return(0,J7.jsx)(etl,{command:t,close:e,description:n?o.formatMessage(Y7.tuckAwayPetDescription):r.description,title:i},t.id)},F=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,J7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),I=",
      "41515 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{xM(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(xM(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "41515 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function lRu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,l9.jsx)(NJ,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function lRu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "61639 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=SLu(t,o,ZLr(m,t.id)),i=n?o.formatMessage(u9.tuckAwayPet):r.title;return(0,l9.jsx)(uRu,{command:t,close:e,description:n?o.formatMessage(u9.tuckAwayPetDescription):r.description,title:i},t.id)},F=[],I=",
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=SLu(t,o,ZLr(m,t.id)),i=n?o.formatMessage(u9.tuckAwayPet):r.title;return(0,l9.jsx)(uRu,{command:t,close:e,description:n?o.formatMessage(u9.tuckAwayPetDescription):r.description,title:i},t.id)},F=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,l9.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),I=",
      "61639 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{nA(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(nA(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "61639 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,l9.jsx)(PJ,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function uRu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "61309 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      ...
      "P=t=>{let n=t.id===`openAvatarOverlay`&&C,r=CLu(t,o,nRr(m,t.id)),i=n?o.formatMessage(u9.tuckAwayPet):r.title;return(0,l9.jsx)(dRu,{command:t,close:e,description:n?o.formatMessage(u9.tuckAwayPetDescription):r.description,title:i},t.id)},F=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,l9.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),I=",
      "61309 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{Zk(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(Zk(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "61309 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function MAu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,Z7.jsx)(aY,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function MAu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "51351 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "R=t=>{let n=t.id===`openAvatarOverlay`&&w,r=Hku(t,o,XFr(h,t.id)),i=n?o.formatMessage(Q7.tuckAwayPet):r.title;return(0,Z7.jsx)(NAu,{command:t,close:e,description:n?o.formatMessage(Q7.tuckAwayPetDescription):r.description,title:i},t.id)},z=[],B=",
      "R=t=>{let n=t.id===`openAvatarOverlay`&&w,r=Hku(t,o,XFr(h,t.id)),i=n?o.formatMessage(Q7.tuckAwayPet):r.title;return(0,Z7.jsx)(NAu,{command:t,close:e,description:n?o.formatMessage(Q7.tuckAwayPetDescription):r.description,title:i},t.id)},z=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,Z7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),B=",
      "51351 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{Fk(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(Fk(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "51351 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function MAu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,Z7.jsx)(oY,{value:n,keywords:[r,e.id],title:n,description:r,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function MAu({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "40816 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "R=t=>{let n=t.id===`openAvatarOverlay`&&w,r=Hku(t,o,JFr(h,t.id)),i=n?o.formatMessage(Q7.tuckAwayPet):r.title;return(0,Z7.jsx)(NAu,{command:t,close:e,description:n?o.formatMessage(Q7.tuckAwayPetDescription):r.description,title:i},t.id)},z=[],B=",
      "R=t=>{let n=t.id===`openAvatarOverlay`&&w,r=Hku(t,o,JFr(h,t.id)),i=n?o.formatMessage(Q7.tuckAwayPet):r.title;return(0,Z7.jsx)(NAu,{command:t,close:e,description:n?o.formatMessage(Q7.tuckAwayPetDescription):r.description,title:i},t.id)},z=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,Z7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),B=",
      "40816 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{Lk(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(Lk(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "40816 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function cru({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "function CPXCommandPaletteItem({command:e,close:t}){let n=e.title??e.id,r=e.description??``;return(0,X7.jsx)(lX,{value:n,keywords:[r,e.id],title:n,onSelect:()=>{globalThis.CodexPlusHost.adapters.commands.dispatch(e.id),t()}},e.id)}function cru({close:e,inputRef:t,rootChatSearchIntent:n,search:r,setSearch:i}){",
      "30844 command palette plugin item anchor",
    );
    patched = replaceOnce(
      patched,
      "I=t=>{let n=t.id===`openAvatarOverlay`&&S,r=vnu(t,o,XPr(p,t.id)),i=n?o.formatMessage(Z7.tuckAwayPet):r.title;return(0,X7.jsx)(lru,{command:t,close:e,description:n?o.formatMessage(Z7.tuckAwayPetDescription):r.description,title:i},t.id)},L=[],R=",
      "I=t=>{let n=t.id===`openAvatarOverlay`&&S,r=vnu(t,o,XPr(p,t.id)),i=n?o.formatMessage(Z7.tuckAwayPet):r.title;return(0,X7.jsx)(lru,{command:t,close:e,description:n?o.formatMessage(Z7.tuckAwayPetDescription):r.description,title:i},t.id)},L=globalThis.CodexPlusHost.adapters.commands.metadata().map(t=>(0,X7.jsx)(CPXCommandPaletteItem,{command:t,close:e},t.id)),R=",
      "30844 command palette plugin item mount anchor",
    );
    return replaceOnce(
      patched,
      "c=()=>{Cj(r.id,`command_menu`),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "c=()=>{let e=globalThis.CodexPlusHost.adapters.commands;e.bindNativeDispatch(e=>(Cj(e,`command_menu`),!0)),e.dispatch(r.id),r.id!==`searchChats`&&n()},t[2]=n,t[3]=r.id,t[4]=c):c=t[4];",
      "30844 command menu stable dispatch anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72028")) {
    let patched = replaceOnce(
...
function patchLocalTaskRow(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(
      text,
      "function Ljn(e){let t=(0,dQ.c)(174),{entry:n,",
      `${projectColorHook()}function Ljn(e){let t=(0,dQ.c)(174),{entry:n,`,
      "26.901.20858 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:vo.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label})",
      "dataAttributes:{...vo.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}",
      "26.901.20858 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:vo.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``})",
      "dataAttributes:{...vo.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``}),...CPXPR({hostId:null,threadId:t,title:e.task.title??``})}",
      "26.901.20858 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:vo.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0})",
      "dataAttributes:{...vo.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0}),...CPXPR({projectId:je,label:Ae,path:N,cwd:N,hostId:m,threadId:d,title:c??``,projectless:h})}",
      "26.901.20858 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(
      text,
      "function lMn(e){let t=(0,hQ.c)(174),{entry:n,",
      `${projectColorHook()}function lMn(e){let t=(0,hQ.c)(174),{entry:n,`,
      "26.901.22334 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:je.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label})",
      "dataAttributes:{...je.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}",
      "26.901.22334 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:je.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``})",
      "dataAttributes:{...je.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``}),...CPXPR({hostId:null,threadId:t,title:e.task.title??``})}",
      "26.901.22334 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:je.sidebarThreadRow({active:l,hostId:h,id:f,kind:`local`,pinned:i,selected:a,title:void 0})",
      "dataAttributes:{...je.sidebarThreadRow({active:l,hostId:h,id:f,kind:`local`,pinned:i,selected:a,title:void 0}),...CPXPR({projectId:Ne,label:Me,path:P,cwd:P,hostId:h,threadId:f,title:c??``,projectless:g})}",
      "26.901.22334 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(
      text,
      "function nMn(e){let t=(0,EQ.c)(174),{entry:n,",
      `${projectColorHook()}function nMn(e){let t=(0,EQ.c)(174),{entry:n,`,
      "26.901.31953 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:os.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label})",
      "dataAttributes:{...os.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}",
      "26.901.31953 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:os.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``})",
      "dataAttributes:{...os.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``}),...CPXPR({hostId:null,threadId:t,title:e.task.title??``})}",
      "26.901.31953 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:os.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0})",
      "dataAttributes:{...os.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0}),...CPXPR({projectId:je,label:Ae,path:N,cwd:N,hostId:m,threadId:d,title:c??``,projectless:h})}",
      "26.901.31953 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "function lMn(e){let t=(0,jQ.c)(174),{entry:n,",
      `${projectColorHook()}function lMn(e){let t=(0,jQ.c)(174),{entry:n,`,
      "26.901.41600 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:xd.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label})",
      "dataAttributes:{...xd.sidebarThreadRow({active:l,hostId:t.hostId,id:n,kind:`local`,pinned:i,selected:a,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}",
      "26.901.41600 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:xd.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``})",
      "dataAttributes:{...xd.sidebarThreadRow({active:l,hostId:null,id:t,kind:`remote`,pinned:i,selected:a,title:e.task.title??``}),...CPXPR({hostId:null,threadId:t,title:e.task.title??``})}",
      "26.901.41600 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:xd.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0})",
      "dataAttributes:{...xd.sidebarThreadRow({active:l,hostId:m,id:d,kind:`local`,pinned:i,selected:a,title:void 0}),...CPXPR({projectId:je,label:Ae,path:N,cwd:N,hostId:m,threadId:d,title:c??``,projectless:h})}",
      "26.901.41600 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function EBc(e){let t=(0,PBc.c)(165),{entry:n,", `${projectColorHook()}function EBc(e){let t=(0,PBc.c)(165),{entry:n,`, "41651 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:px.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...px.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "41651 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:px.sidebarThreadRow({active:c,hostId:null,id:t,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...px.sidebarThreadRow({active:c,hostId:null,id:t,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:t,title:e.task.title??``})}", "41651 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:px.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...px.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "41651 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    let patched = replaceOnce(text, "function JNl(e){let t=(0,rPl.c)(165),{entry:n,", `${projectColorHook()}function JNl(e){let t=(0,rPl.c)(165),{entry:n,`, "61809 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "61809 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "61809 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "61809 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function NMl(e){let t=(0,HMl.c)(165),{entry:n,", `${projectColorHook()}function NMl(e){let t=(0,HMl.c)(165),{entry:n,`, "22352 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "22352 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "22352 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "22352 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    let patched = replaceOnce(text, "function BMl(e){let t=(0,YMl.c)(165),{entry:n,", `${projectColorHook()}function BMl(e){let t=(0,YMl.c)(165),{entry:n,`, "31338 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "31338 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "31338 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "31338 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function VMl(e){let t=(0,XMl.c)(165),{entry:n,", `${projectColorHook()}function VMl(e){let t=(0,XMl.c)(165),{entry:n,`, "32112 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "32112 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "32112 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Ep.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "32112 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function KNl(e){let t=(0,tPl.c)(165),{entry:n,", `${projectColorHook()}function KNl(e){let t=(0,tPl.c)(165),{entry:n,`, "41705 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "41705 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "41705 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "41705 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function Ijl(e){let t=(0,Gjl.c)(165),{entry:n,", `${projectColorHook()}function Ijl(e){let t=(0,Gjl.c)(165),{entry:n,`, "21641 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "21641 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "21641 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Dp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "21641 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function WSl(e){let t=(0,ZSl.c)(164),{entry:n,", `${projectColorHook()}function WSl(e){let t=(0,ZSl.c)(164),{entry:n,`, "41407 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:Mp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...Mp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "41407 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:Mp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...Mp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "41407 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:Mp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...Mp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:ke,label:Oe,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "41407 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function u6c(e){let t=(0,_6c.c)(161),{entry:n,", `${projectColorHook()}function u6c(e){let t=(0,_6c.c)(161),{entry:n,`, "26.810.41047 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:am.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})", "dataAttributes:{...am.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}", "26.810.41047 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:am.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})", "dataAttributes:{...am.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}", "26.810.41047 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:am.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})", "dataAttributes:{...am.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:De,label:Ee,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}", "26.810.41047 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function wRc({entry:e,", `${projectColorHook()}function wRc({entry:e,`, "26.803.61601 local task row project color helper insertion anchor");
    patched = replaceOnce(patched, "dataAttributes:mm.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label})", "dataAttributes:{...mm.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label}),...CPXPR({projectId:r.projectId,label:r.label,path:r.worktreeGitRoot??r.worktreeWorkspaceRoot,cwd:r.worktreeGitRoot??r.worktreeWorkspaceRoot,hostId:r.hostId,threadId:i,title:r.label,projectKind:r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot)})}", "26.803.61601 local pending task row project color attributes anchor");
    patched = replaceOnce(patched, "dataAttributes:mm.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``})", "dataAttributes:{...mm.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``}),...CPXPR({hostId:null,threadId:i,title:e.task.title??``})}", "26.803.61601 remote sidebar row project color attributes anchor");
    return replaceOnce(patched, "dataAttributes:mm.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K})", "dataAttributes:{...mm.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K}),...CPXPR({projectId:de,label:ue,path:O??ae,cwd:O??ae,hostId:F,threadId:g,title:K,projectless:d})}", "26.803.61601 local sidebar row project color attributes anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function p6c(e){let t=(0,b6c.c)(161),{entry:n,",
      `${projectColorHook()}function p6c(e){let t=(0,b6c.c)(161),{entry:n,`,
      "52044 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:Rp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label})",
      "dataAttributes:{...Rp.sidebarThreadRow({active:c,hostId:t.hostId,id:n,kind:`local`,pinned:r,selected:i,title:t.label}),...CPXPR({projectId:t.projectId,label:t.label,path:t.worktreeGitRoot??t.worktreeWorkspaceRoot,cwd:t.worktreeGitRoot??t.worktreeWorkspaceRoot,hostId:t.hostId,threadId:n,title:t.label,projectKind:t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(t.projectId||t.worktreeGitRoot||t.worktreeWorkspaceRoot)})}",
      "52044 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:Rp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``})",
      "dataAttributes:{...Rp.sidebarThreadRow({active:c,hostId:null,id:n,kind:`remote`,pinned:r,selected:i,title:e.task.title??``}),...CPXPR({hostId:null,threadId:n,title:e.task.title??``})}",
      "52044 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:Rp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k})",
      "dataAttributes:{...Rp.sidebarThreadRow({active:c,hostId:m,id:u,kind:`local`,pinned:r,selected:i,title:k}),...CPXPR({projectId:De,label:Ee,path:A,cwd:A,hostId:m,threadId:u,title:k,projectless:p})}",
      "52044 local sidebar row project color attributes anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function URc({entry:e,",
      `${projectColorHook()}function URc({entry:e,`,
      "81509 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:im.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label})",
      "dataAttributes:{...im.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label}),...CPXPR({projectId:r.projectId,label:r.label,path:r.worktreeGitRoot??r.worktreeWorkspaceRoot,cwd:r.worktreeGitRoot??r.worktreeWorkspaceRoot,hostId:r.hostId,threadId:i,title:r.label,projectKind:r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot)})}",
      "81509 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:im.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``})",
      "dataAttributes:{...im.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``}),...CPXPR({hostId:null,threadId:i,title:e.task.title??``})}",
      "81509 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:im.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K})",
      "dataAttributes:{...im.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K}),...CPXPR({projectId:de,label:ue,path:O??ae,cwd:O??ae,hostId:F,threadId:g,title:K,projectless:d})}",
      "81509 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function SRc({entry:e,",
      `${projectColorHook()}function SRc({entry:e,`,
      "41515 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:cm.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label})",
      "dataAttributes:{...cm.sidebarThreadRow({active:o,hostId:r.hostId,id:i,kind:`local`,pinned:t,selected:n,title:r.label}),...CPXPR({projectId:r.projectId,label:r.label,path:r.worktreeGitRoot??r.worktreeWorkspaceRoot,cwd:r.worktreeGitRoot??r.worktreeWorkspaceRoot,hostId:r.hostId,threadId:i,title:r.label,projectKind:r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(r.projectId||r.worktreeGitRoot||r.worktreeWorkspaceRoot)})}",
      "41515 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:cm.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``})",
      "dataAttributes:{...cm.sidebarThreadRow({active:o,hostId:null,id:i,kind:`remote`,pinned:t,selected:n,title:e.task.title??``}),...CPXPR({hostId:null,threadId:i,title:e.task.title??``})}",
      "41515 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:cm.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K})",
      "dataAttributes:{...cm.sidebarThreadRow({active:o,hostId:F,id:T,kind:`local`,pinned:t,selected:n,title:K}),...CPXPR({projectId:de,label:ue,path:O??ae,cwd:O??ae,hostId:F,threadId:g,title:K,projectless:d})}",
      "41515 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function BHc({entry:e,",
      `${projectColorHook()}function BHc({entry:e,`,
      "61639 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label}),...CPXPR({projectId:n.projectId,label:n.label,path:n.worktreeGitRoot??n.worktreeWorkspaceRoot,cwd:n.worktreeGitRoot??n.worktreeWorkspaceRoot,hostId:n.hostId,threadId:r,title:n.label,projectKind:n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot)})}",
      "61639 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``}),...CPXPR({hostId:null,threadId:r,title:e.task.title??``})}",
      "61639 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:P,id:w,kind:`local`,pinned:t,title:U})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:P,id:w,kind:`local`,pinned:t,title:U}),...CPXPR({projectId:ce,label:se,path:D,cwd:D,hostId:P,threadId:h,title:U,projectless:u})}",
      "61639 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      text,
      "function VHc({entry:e,",
      `${projectColorHook()}function VHc({entry:e,`,
      "61309 local task row project color helper insertion anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:Qf.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label})",
      "dataAttributes:{...Qf.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label}),...CPXPR({projectId:n.projectId,label:n.label,path:n.worktreeGitRoot??n.worktreeWorkspaceRoot,cwd:n.worktreeGitRoot??n.worktreeWorkspaceRoot,hostId:n.hostId,threadId:r,title:n.label,projectKind:n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot)})}",
      "61309 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:Qf.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``})",
      "dataAttributes:{...Qf.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``}),...CPXPR({hostId:null,threadId:r,title:e.task.title??``})}",
      "61309 remote sidebar row project color attributes anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:Qf.sidebarThreadRow({active:a,hostId:P,id:w,kind:`local`,pinned:t,title:U})",
      "dataAttributes:{...Qf.sidebarThreadRow({active:a,hostId:P,id:w,kind:`local`,pinned:t,title:U}),...CPXPR({projectId:ce,label:se,path:D,cwd:D,hostId:P,threadId:h,title:U,projectless:u})}",
      "61309 local sidebar row project color attributes anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function vru({entry:e,",
      `${projectColorHook()}function vru({entry:e,`,
      "40816 local task row project color helper insertion anchor",
    );
    const projectRowAnchor = "A=tp.sidebarProjectRow({collapsed:a,label:g,projectId:b})";
    const patchedProjectRowAnchor = "A={...tp.sidebarProjectRow({collapsed:a,label:g,projectId:b}),...CPXPR({projectId:b,label:g})}";
    patched = patched.includes(projectRowAnchor)
      ? replaceOnce(patched, projectRowAnchor, patchedProjectRowAnchor, "40816 native project row color attributes anchor")
      : replaceOnce(patched, patchedProjectRowAnchor, patchedProjectRowAnchor, "40816 prepatched native project row color attributes anchor");
    patched = replaceOnce(
      patched,
      "Ge=r?Se:void 0,Ke=",
      "Ge={...(r?Se:void 0),...CPXPR({projectId:E,label:P,path:n.path,cwd:n.path,hostId:n.hostId,projectKind:n.projectKind})},Ke=",
      "40816 native local project identity anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:n.hostId,id:r,kind:`local`,pinned:t,title:n.label}),...CPXPR({projectId:n.projectId,label:n.label,path:n.worktreeGitRoot??n.worktreeWorkspaceRoot,cwd:n.worktreeGitRoot??n.worktreeWorkspaceRoot,hostId:n.hostId,threadId:r,title:n.label,projectKind:n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot?void 0:`chat`,projectless:!(n.projectId||n.worktreeGitRoot||n.worktreeWorkspaceRoot)})}",
      "40816 local pending task row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:null,id:r,kind:`remote`,pinned:t,title:e.task.title??``}),...CPXPR({hostId:null,threadId:r,title:e.task.title??``})}",
      "40816 remote sidebar row project color attributes anchor",
    );
    patched = replaceOnce(
      patched,
      "K={onActivateGroup:z,onStartNewConversation:o,isGrouped:!0,hideRemoteHostEnvIcon:!0,hideTimestamp:l,locationId:y,floatStatusIconsEnd:c,showPinActionOnHover:s}",
      "K={onActivateGroup:z,onStartNewConversation:o,isGrouped:!0,hideRemoteHostEnvIcon:!0,hideTimestamp:l,locationId:y,floatStatusIconsEnd:c,showPinActionOnHover:s,hoverCardProjectId:a.projectId,hoverCardProjectLabel:a.label,displayCwd:a.path}",
      "40816 grouped project thread identity anchor",
    );
    return replaceOnce(
      patched,
      "dataAttributes:tp.sidebarThreadRow({active:a,hostId:M,id:S,kind:`local`,pinned:t,title:B})",
      "dataAttributes:{...tp.sidebarThreadRow({active:a,hostId:M,id:S,kind:`local`,pinned:t,title:B}),...CPXPR({projectId:ae,label:ie,path:T,cwd:T,hostId:M,threadId:S,title:B,projectKind:u?`chat`:void 0,projectless:u})}",
      "40816 local sidebar row project color attributes anchor",
    );
  }
...
function patchMermaidDiagramShell(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(text, "function C(e){let t=(0,xe.c)(81),{blockRef:n,code:i,isCodeFenceOpen:s,isDark:l,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:ne,renderKey:p}=e,", `${mermaidDiagramHook()}function C(e){let t=(0,xe.c)(81),{blockRef:n,code:i,isCodeFenceOpen:s,isDark:l,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:ne,renderKey:p}=e,`, "26.901.20858 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, '$=(0,P.jsxs)(`div`,{className:`relative`,"data-markdown-copy":De,"data-markdown-copy-text":Oe,children:[J,X,Z,Q]})', '$=(0,P.jsxs)(`div`,{...CPXMermaidDiagramProps({code:i}),className:`relative`,"data-markdown-copy":De,"data-markdown-copy-text":Oe,children:[J,X,Z,Q]})', "26.901.20858 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.22334")) {
    let patched = replaceOnce(text, "function w(e){let t=(0,be.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:c,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:p,renderKey:m}=e,", `${mermaidDiagramHook()}function w(e){let t=(0,be.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:c,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:p,renderKey:m}=e,`, "26.901.22334 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, 'Me=(0,F.jsxs)(`div`,{className:`relative`,"data-markdown-copy":Ee,"data-markdown-copy-text":De,children:[Y,Z,Q,$]})', 'Me=(0,F.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,"data-markdown-copy":Ee,"data-markdown-copy-text":De,children:[Y,Z,Q,$]})', "26.901.22334 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.31953")) {
    let patched = replaceOnce(text, "function w(e){let t=(0,be.c)(81),{blockRef:n,code:r,isCodeFenceOpen:o,isDark:c,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:p,renderKey:m}=e,", `${mermaidDiagramHook()}function w(e){let t=(0,be.c)(81),{blockRef:n,code:r,isCodeFenceOpen:o,isDark:c,isVisible:u,onCopy:d,onDownload:f,onError:ee,onRendered:p,renderKey:m}=e,`, "26.901.31953 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,F.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "$=(0,F.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "26.901.31953 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(text, "function S(e){let t=(0,Se.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:s,isVisible:l,onCopy:u,onDownload:d,onError:te,onRendered:f,renderKey:p}=e,", `${mermaidDiagramHook()}function S(e){let t=(0,Se.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:s,isVisible:l,onCopy:u,onDownload:d,onError:te,onRendered:f,renderKey:p}=e,`, "26.901.41600 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,N.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "$=(0,N.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "26.901.41600 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "function T(e){let t=(0,ye.c)(81),{blockRef:o,code:c,isCodeFenceOpen:l,isDark:u,isVisible:d,onCopy:f,onDownload:p,onError:m,onRendered:ee,renderKey:h}=e,", `${mermaidDiagramHook()}function T(e){let t=(0,ye.c)(81),{blockRef:o,code:c,isCodeFenceOpen:l,isDark:u,isVisible:d,onCopy:f,onDownload:p,onError:m,onRendered:ee,renderKey:h}=e,`, "41651 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "Me=(0,I.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":Ee,\"data-markdown-copy-text\":De,children:[Y,Z,Q,$]})", "Me=(0,I.jsxs)(`div`,{...CPXMermaidDiagramProps({code:c}),className:`relative`,\"data-markdown-copy\":Ee,\"data-markdown-copy-text\":De,children:[Y,Z,Q,$]})", "41651 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    let patched = replaceOnce(text, "function C(e){let t=(0,xe.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:s,onCopy:c,onDownload:l,onError:u,onRendered:f,renderKey:p}=e,", `${mermaidDiagramHook()}function C(e){let t=(0,xe.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:s,onCopy:c,onDownload:l,onError:u,onRendered:f,renderKey:p}=e,`, "22352 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,P.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "$=(0,P.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "22352 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    let patched = replaceOnce(text, "function C(e){let t=(0,xe.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:s,onCopy:c,onDownload:l,onError:u,onRendered:f,renderKey:p}=e,", `${mermaidDiagramHook()}function C(e){let t=(0,xe.c)(81),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:s,onCopy:c,onDownload:l,onError:u,onRendered:f,renderKey:p}=e,`, "32112 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,P.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "$=(0,P.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "32112 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    let patched = replaceOnce(text, "function T(e){let t=(0,ye.c)(81),{blockRef:i,code:o,isCodeFenceOpen:s,isDark:d,isVisible:f,onCopy:p,onDownload:m,onError:ne,onRendered:re,renderKey:h}=e,", `${mermaidDiagramHook()}function T(e){let t=(0,ye.c)(81),{blockRef:i,code:o,isCodeFenceOpen:s,isDark:d,isVisible:f,onCopy:p,onDownload:m,onError:ne,onRendered:re,renderKey:h}=e,`, "41705 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "Me=(0,I.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":Ee,\"data-markdown-copy-text\":De,children:[Y,Z,Q,$]})", "Me=(0,I.jsxs)(`div`,{...CPXMermaidDiagramProps({code:o}),className:`relative`,\"data-markdown-copy\":Ee,\"data-markdown-copy-text\":De,children:[Y,Z,Q,$]})", "41705 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "function S(e){let t=(0,Se.c)(81),{blockRef:n,code:r,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:l,onDownload:u,onError:d,onRendered:te,renderKey:f}=e,", `${mermaidDiagramHook()}function S(e){let t=(0,Se.c)(81),{blockRef:n,code:r,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:l,onDownload:u,onError:d,onRendered:te,renderKey:f}=e,`, "21641 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,N.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "$=(0,N.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":De,\"data-markdown-copy-text\":Oe,children:[J,X,Z,Q]})", "21641 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(text, "function w(e){let t=(0,Se.c)(78),{blockRef:i,code:a,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:l,onDownload:d,onError:ee,onRendered:f,renderKey:p}=e,", `${mermaidDiagramHook()}function w(e){let t=(0,Se.c)(78),{blockRef:i,code:a,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:l,onDownload:d,onError:ee,onRendered:f,renderKey:p}=e,`, "41407 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,F.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":Te,\"data-markdown-copy-text\":Ee,children:[J,X,Z,Q]})", "$=(0,F.jsxs)(`div`,{...CPXMermaidDiagramProps({code:a}),className:`relative`,\"data-markdown-copy\":Te,\"data-markdown-copy-text\":Ee,children:[J,X,Z,Q]})", "41407 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function w(e){let t=(0,Se.c)(78),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:o,onCopy:u,onDownload:d,onError:f,onRendered:ee,renderKey:p}=e,", `${mermaidDiagramHook()}function w(e){let t=(0,Se.c)(78),{blockRef:n,code:r,isCodeFenceOpen:i,isDark:a,isVisible:o,onCopy:u,onDownload:d,onError:f,onRendered:ee,renderKey:p}=e,`, "26.810.41047 mermaid diagram shell helper insertion anchor");
    return replaceOnce(patched, "$=(0,F.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":Te,\"data-markdown-copy-text\":Ee,children:[J,X,Z,Q]})", "$=(0,F.jsxs)(`div`,{...CPXMermaidDiagramProps({code:r}),className:`relative`,\"data-markdown-copy\":Te,\"data-markdown-copy-text\":Ee,children:[J,X,Z,Q]})", "26.810.41047 mermaid diagram shell host props anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function T(e){let t=(0,xe.c)(78),{blockRef:i,code:a,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:d,onDownload:f,onError:ne,onRendered:re,renderKey:p}=e,",
      `${mermaidDiagramHook()}function T(e){let t=(0,xe.c)(78),{blockRef:i,code:a,isCodeFenceOpen:o,isDark:s,isVisible:c,onCopy:d,onDownload:f,onError:ne,onRendered:re,renderKey:p}=e,`,
      "26.810.52044 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "Ae=(0,I.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":we,\"data-markdown-copy-text\":Te,children:[Y,Z,Q,$]})",
      "Ae=(0,I.jsxs)(`div`,{...CPXMermaidDiagramProps({code:a}),className:`relative`,\"data-markdown-copy\":we,\"data-markdown-copy-text\":Te,children:[Y,Z,Q,$]})",
      "26.810.52044 mermaid diagram shell host props anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function me({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:a,onRendered:u,renderKey:f}){",
      `${mermaidDiagramHook()}function me({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:a,onRendered:u,renderKey:f}){`,
      "26.803.81509 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(0,U.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":w,children:[",
      "(0,U.jsxs)(`div`,{...CPXMermaidDiagramProps({code:t}),className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":w,children:[",
      "26.803.81509 mermaid diagram shell host props anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function me({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:o,onRendered:s,renderKey:d}){",
      `${mermaidDiagramHook()}function me({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:o,onRendered:s,renderKey:d}){`,
      "26.803.41515 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(0,H.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":T,children:[",
      "(0,H.jsxs)(`div`,{...CPXMermaidDiagramProps({code:t}),className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":T,children:[",
      "26.803.41515 mermaid diagram shell host props anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${mermaidDiagramHook()}function me({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:a,onRendered:s,renderKey:c}){`,
      "26.730.61309 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(0,U.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":S,children:[",
      "(0,U.jsxs)(`div`,{...CPXMermaidDiagramProps({code:t}),className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":S,children:[",
      "26.730.61309 mermaid diagram shell host props anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function k({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:a,onRendered:o,renderKey:s}){",
      `${mermaidDiagramHook()}function k({blockRef:e,code:t,isCodeFenceOpen:n,isDark:r,isVisible:i,onError:a,onRendered:o,renderKey:s}){`,
      "26.727.40816 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(0,z.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":x,children:[",
      "(0,z.jsxs)(`div`,{...CPXMermaidDiagramProps({code:t}),className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":x,children:[",
      "26.727.40816 mermaid diagram shell host props anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      ...
      `${mermaidDiagramHook()}function pr({blockRef:e,code:t,isCodeFenceOpen:i,isDark:a,isVisible:s,onError:l,onRendered:u,renderKey:d}){`,
      "26.721.30844 mermaid diagram shell helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "(0,Y.jsxs)(`div`,{className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":S,children:[",
      "(0,Y.jsxs)(`div`,{...CPXMermaidDiagramProps({code:t}),className:`relative`,\"data-markdown-copy\":`code-block`,\"data-markdown-copy-text\":S,children:[",
      "26.721.30844 mermaid diagram shell host props anchor",
    );
  }
...
function patchPreloadNativeBridge(text, context = {}) {
  if (
    patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858") ||
    patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")
  ) {
    return replaceOnce(
      text,
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,b),e.contextBridge.exposeInMainWorld(`electronBridge`,F),typeof window<`u`",
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,b),e.contextBridge.exposeInMainWorld(`electronBridge`,F),e.contextBridge.exposeInMainWorld(`codexPlusHostBridge`,{request:(t,n)=>e.ipcRenderer.invoke(`codex_plus:native-request`,{method:t,params:n})}),typeof window<`u`",
      "41651 codex plus native preload bridge anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(
      text,
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,x),e.contextBridge.exposeInMainWorld(`electronBridge`,L),typeof window<`u`",
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,x),e.contextBridge.exposeInMainWorld(`electronBridge`,L),e.contextBridge.exposeInMainWorld(`codexPlusHostBridge`,{request:(t,n)=>e.ipcRenderer.invoke(`codex_plus:native-request`,{method:t,params:n})}),typeof window<`u`",
      "26.814.41407 codex plus native preload bridge anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    return replaceOnce(
      ...
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,x),e.contextBridge.exposeInMainWorld(`electronBridge`,L),typeof window<`u`",
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,x),e.contextBridge.exposeInMainWorld(`electronBridge`,L),e.contextBridge.exposeInMainWorld(`codexPlusHostBridge`,{request:(t,n)=>e.ipcRenderer.invoke(`codex_plus:native-request`,{method:t,params:n})}),typeof window<`u`",
      "26.803.41515 codex plus native preload bridge anchor",
    );
  }
  if (text.includes("e.contextBridge.exposeInMainWorld(`codexWindowType`,C),e.contextBridge.exposeInMainWorld(`electronBridge`,B),typeof window<`u`")) {
    return replaceOnce(
      text,
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,C),e.contextBridge.exposeInMainWorld(`electronBridge`,B),typeof window<`u`",
      "e.contextBridge.exposeInMainWorld(`codexWindowType`,C),e.contextBridge.exposeInMainWorld(`electronBridge`,B),e.contextBridge.exposeInMainWorld(`codexPlusHostBridge`,{request:(t,n)=>e.ipcRenderer.invoke(`codex_plus:native-request`,{method:t,params:n})}),typeof window<`u`",
...
function patchMainNativeBridge(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.20858")) {
    let patched = replaceOnce(text, "async function dze(){", `${nativeMainHook({ electronName: "l" })}async function dze(){`, "26.901.20858 codex plus native main helper insertion anchor");
    return replaceOnce(
      patched,
      "getTrayController:J9,onAppEntrySource:ge,isTrustedIpcEvent:Se}),new oh",
      "getTrayController:J9,onAppEntrySource:ge,isTrustedIpcEvent:Se}),CPXNative.registerNativeRequest({isTrustedIpcEvent:Se}),new oh",
      "26.901.20858 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(text, "async function uze(){", `${nativeMainHook({ electronName: "l" })}async function uze(){`, "26.901.41600 codex plus native main helper insertion anchor");
    return replaceOnce(
      patched,
      "getTrayController:J9,onAppEntrySource:ge,isTrustedIpcEvent:Se}),new oh",
      "getTrayController:J9,onAppEntrySource:ge,isTrustedIpcEvent:Se}),CPXNative.registerNativeRequest({isTrustedIpcEvent:Se}),new oh",
      "26.901.41600 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(text, "async function pPe(){s.i(),r.n(J9);", `${nativeMainHook({ electronName: "l" })}async function pPe(){s.i(),r.n(J9);`, "41651 codex plus native main helper insertion anchor");
    return replaceOnce(
      patched,
      "pre({chunkedMessageSender:le,isTrustedIpcEvent:xe}),$ke({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:xe}),l.ipcMain.on",
      "pre({chunkedMessageSender:le,isTrustedIpcEvent:xe}),$ke({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:xe}),CPXNative.registerNativeRequest({isTrustedIpcEvent:xe}),l.ipcMain.on",
      "41651 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41509")) {
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    ...
    return replaceOnce(
      patched,
      "lre({chunkedMessageSender:ce,isTrustedIpcEvent:be}),jDe({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:be}),l.ipcMain.on",
      "lre({chunkedMessageSender:ce,isTrustedIpcEvent:be}),jDe({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:be}),CPXNative.registerNativeRequest({isTrustedIpcEvent:be}),l.ipcMain.on",
      "26.818.41705 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    let patched = replaceOnce(text, "async function OMe(){s.i(),r.n(q9);", `${nativeMainHook({ electronName: "l" })}async function OMe(){s.i(),r.n(q9);`, "26.818.21641 codex plus native main helper insertion anchor");
    return replaceOnce(
      patched,
      "ure({chunkedMessageSender:ce,isTrustedIpcEvent:be}),kDe({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:be}),l.ipcMain.on",
      "ure({chunkedMessageSender:ce,isTrustedIpcEvent:be}),kDe({buildFlavor:c,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:be}),CPXNative.registerNativeRequest({isTrustedIpcEvent:be}),l.ipcMain.on",
      "26.818.21641 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41957")) {
    let patched = replaceOnce(text, "async function mMe(){r.n(q9);", `${nativeMainHook({ electronName: "l" })}async function mMe(){r.n(q9);`, "26.814.41957 codex plus native main helper insertion anchor");
    return replaceOnce(
      patched,
      "bne({chunkedMessageSender:se,isTrustedIpcEvent:ye}),fDe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ye}),l.ipcMain.on",
      "bne({chunkedMessageSender:se,isTrustedIpcEvent:ye}),fDe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ye}),CPXNative.registerNativeRequest({isTrustedIpcEvent:ye}),l.ipcMain.on",
      "26.814.41957 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(
      text,
      "async function rMe(){r.n(q9);",
      `${nativeMainHook({ electronName: "l" })}async function rMe(){r.n(q9);`,
      "26.814.41407 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "lre({chunkedMessageSender:se,isTrustedIpcEvent:ye}),nDe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ye}),l.ipcMain.on",
      "lre({chunkedMessageSender:se,isTrustedIpcEvent:ye}),nDe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ye}),CPXNative.registerNativeRequest({isTrustedIpcEvent:ye}),l.ipcMain.on",
      "26.814.41407 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "async function cje(){r.n(q9);",
      `${nativeMainHook({ electronName: "l" })}async function cje(){r.n(q9);`,
      "26.810.52044 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "Xne({chunkedMessageSender:oe,isTrustedIpcEvent:ge}),mEe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ge}),l.ipcMain.on",
      "Xne({chunkedMessageSender:oe,isTrustedIpcEvent:ge}),mEe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ge}),CPXNative.registerNativeRequest({isTrustedIpcEvent:ge}),l.ipcMain.on",
      "26.810.52044 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "async function NEe(){r.n(q9);",
      `${nativeMainHook({ electronName: "l" })}async function NEe(){r.n(q9);`,
      "26.803.41515 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "fre({chunkedMessageSender:z,isTrustedIpcEvent:_e}),mSe({buildFlavor:s,getContextForWebContents:B.getContextForWebContents,isTrustedIpcEvent:_e}),l.ipcMain.on",
      "fre({chunkedMessageSender:z,isTrustedIpcEvent:_e}),mSe({buildFlavor:s,getContextForWebContents:B.getContextForWebContents,isTrustedIpcEvent:_e}),CPXNative.registerNativeRequest({isTrustedIpcEvent:_e}),l.ipcMain.on",
      "26.803.41515 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      `${nativeMainHook({ electronName: "l" })}async function eEe(){r.n(q9);`,
      "26.730.61309 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      ...
      "are({chunkedMessageSender:B,isTrustedIpcEvent:ge}),Fxe({buildFlavor:s,getContextForWebContents:V.getContextForWebContents,isTrustedIpcEvent:ge}),CPXNative.registerNativeRequest({isTrustedIpcEvent:ge}),l.ipcMain.on",
      "26.730.61309 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "async function pTe(){r.n(q9);",
      `${nativeMainHook({ electronName: "l" })}async function pTe(){r.n(q9);`,
      "26.727.40816 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "jne({chunkedMessageSender:oe,isTrustedIpcEvent:ge}),Wbe({buildFlavor:s,getContextForWebContents:R.getContextForWebContents,isTrustedIpcEvent:ge}),l.ipcMain.on",
      "jne({chunkedMessageSender:oe,isTrustedIpcEvent:ge}),Wbe({buildFlavor:s,getContextForWebContents:R.getContextForWebContents,isTrustedIpcEvent:ge}),CPXNative.registerNativeRequest({isTrustedIpcEvent:ge}),l.ipcMain.on",
      "26.727.40816 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "async function cxe(){a.n(q9);",
      `${nativeMainHook({ electronName: "l" })}async function cxe(){a.n(q9);`,
      "26.721.30844 codex plus native main helper insertion anchor",
    );
    return replaceOnce(
      patched,
      "Bge({buildFlavor:s,getContextForWebContents:R.getContextForWebContents,isTrustedIpcEvent:le}),l.ipcMain.on",
      "Bge({buildFlavor:s,getContextForWebContents:R.getContextForWebContents,isTrustedIpcEvent:le}),CPXNative.registerNativeRequest({isTrustedIpcEvent:le}),l.ipcMain.on",
      "26.721.30844 codex plus native main registration anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.52143")) {
...
function patchMainMenuDiagnostics(text, context = {}) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.901.41600")) {
    let patched = replaceOnce(
      text,
      "nt={...A(`toggleSidePanel`),click:async()=>{let e=await k();e&&y.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},rt=",
      "nt={...A(`toggleSidePanel`),click:async()=>{let e=await k();e&&y.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},rt=",
      "26.901.41600 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(patched, "Pt=[Me,Ne,Pe,Fe,V,...u.browserPane||u.unifiedTabStrip?[Ie]:[],nt,...u.browserPane?", "Pt=[Me,Ne,Pe,Fe,V,...u.browserPane||u.unifiedTabStrip?[Ie]:[],nt,...CPXNative.templateItems(`view-menu`),...u.browserPane?", "26.901.41600 codex plus view menu template items anchor");
    return replaceOnce(patched, "j=()=>{A.refresh()};return{applicationMenuManager:A,", "j=()=>{A.refresh()};CPXNative.setRefreshApplicationMenu(j),CPXNative.logMenuDiagnostics();return{applicationMenuManager:A,", "26.901.41600 codex plus menu diagnostics refresh anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.825.41651")) {
    let patched = replaceOnce(
      text,
      "et={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&y.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},tt=",
      "et={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&y.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},tt=",
      "41651 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(patched, "Mt=[Ae,je,Me,Ne,H,...u.browserPane?[Pe]:[],et,...u.browserPane?", "Mt=[Ae,je,Me,Ne,H,...u.browserPane?[Pe]:[],et,...CPXNative.templateItems(`view-menu`),...u.browserPane?", "41651 codex plus view menu template items anchor");
    return replaceOnce(patched, "A=()=>{k.refresh()};return{applicationMenuManager:k,", "A=()=>{k.refresh()};CPXNative.setRefreshApplicationMenu(A),CPXNative.logMenuDiagnostics();return{applicationMenuManager:k,", "41651 codex plus menu diagnostics refresh anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    let patched = replaceOnce(
      text,
      "it={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},at=",
      "it={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},at=",
      "26.814.41407 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(
      patched,
      "It=[Me,Ne,Pe,Fe,Ie,...c.browserPane?[Le]:[],it,...c.browserPane?",
      "It=[Me,Ne,Pe,Fe,Ie,...c.browserPane?[Le]:[],it,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.814.41407 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "O=()=>{D.refresh()};return{applicationMenuManager:D,",
      "O=()=>{D.refresh()};CPXNative.setRefreshApplicationMenu(O),CPXNative.logMenuDiagnostics();return{applicationMenuManager:D,",
      "26.814.41407 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "rt={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},at=",
      "rt={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},at=",
      "26.810.52044 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(
      patched,
      "It=[Me,Ne,Pe,Fe,Ie,...c.browserPane?[Le]:[],rt,...c.browserPane?",
      "It=[Me,Ne,Pe,Fe,Ie,...c.browserPane?[Le]:[],rt,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.810.52044 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "O=()=>{D.refresh()};return{applicationMenuManager:D,",
      "O=()=>{D.refresh()};CPXNative.setRefreshApplicationMenu(O),CPXNative.logMenuDiagnostics();return{applicationMenuManager:D,",
      "26.810.52044 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "rt={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},it=",
      "rt={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},it=",
      "26.803.41515 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(
      patched,
      "Ft=[je,Me,Ne,Pe,Fe,...c.browserPane?[Ie]:[],rt,...c.browserPane?",
      "Ft=[je,Me,Ne,Pe,Fe,...c.browserPane?[Ie]:[],rt,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.803.41515 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "O=()=>{D.refresh()};return{applicationMenuManager:D,",
      "O=()=>{D.refresh()};CPXNative.setRefreshApplicationMenu(O),CPXNative.logMenuDiagnostics();return{applicationMenuManager:D,",
      "26.803.41515 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      "nt={...k(`toggleSidePanel`),click:async()=>{let e=await O();e&&v.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},rt=",
      "26.730.61309 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(
      patched,
      "Nt=[Ae,je,Me,Ne,Pe,...c.browserPane?[Fe]:[],nt,...c.browserPane?",
      "Nt=[Ae,je,Me,Ne,Pe,...c.browserPane?[Fe]:[],nt,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.730.61309 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "E=()=>{T.refresh()};return{applicationMenuManager:T,",
      "E=()=>{T.refresh()};CPXNative.setRefreshApplicationMenu(E),CPXNative.logMenuDiagnostics();return{applicationMenuManager:T,",
      "26.730.61309 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "at={...O(`toggleSidePanel`),click:async()=>{let e=await D();e&&_.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},ot=",
      "at={...O(`toggleSidePanel`),click:async()=>{let e=await D();e&&_.sendMessageToWindow(e,{type:`toggle-diff-panel`})}},ot=",
      "26.727.40816 codex plus menu template helper presence anchor",
    );
    patched = replaceOnce(
      patched,
      "Ft=[Ne,Pe,Fe,Ie,Le,...c.browserPane?[Re]:[],at,...c.browserPane?",
      "Ft=[Ne,Pe,Fe,Ie,Le,...c.browserPane?[Re]:[],at,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.727.40816 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "Te=Ne.refreshApplicationMenu,P.add(",
      "Te=Ne.refreshApplicationMenu,CPXNative.setRefreshApplicationMenu(()=>Ne.refreshApplicationMenu()),CPXNative.logMenuDiagnostics(),P.add(",
      "26.727.40816 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "Ne,...c.browserPane?[Pe]:[],et,...c.browserPane?",
      "Ne,...c.browserPane?[Pe]:[],et,...CPXNative.templateItems(`view-menu`),...c.browserPane?",
      "26.721.30844 codex plus view menu template items anchor",
    );
    return replaceOnce(
      patched,
      "ve=Te.refreshApplicationMenu;let Ee=",
      "ve=Te.refreshApplicationMenu,CPXNative.setRefreshApplicationMenu(()=>Te.refreshApplicationMenu()),CPXNative.logMenuDiagnostics();let Ee=",
      "26.721.30844 codex plus menu diagnostics refresh anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.52143")) {
    let patched = replaceOnce(
...
function patchStatsigDevFallback(text) {
  text = patchLocalThreadCatalogBootstrap(text);
  const avatarPrewarmAnchor = "shouldPrewarmAvatarOverlay:!a&&fe";
  if (text.includes(avatarPrewarmAnchor)) {
    text = replaceOnce(
      text,
      avatarPrewarmAnchor,
      "shouldPrewarmAvatarOverlay:globalThis.__CodexPlusRuntimeConfig?.devModeStatsigFallback===true?!1:!a&&fe",
      "dev-mode avatar overlay prewarm anchor",
    );
  }
  const cuaPipAnchor = "cuaPIP:_";
  if (text.includes(cuaPipAnchor)) {
    text = replaceOnce(
      text,
      cuaPipAnchor,
      "cuaPIP:globalThis.__CodexPlusRuntimeConfig?.devModeStatsigFallback===true?!1:_",
      "dev-mode computer-use picture-in-picture anchor",
    );
  }
  ...
  if (!match) {
    const asyncProviderPattern =
      /function ([A-Za-z0-9_$]+)\(e\)\{let t=\(0,([A-Za-z0-9_$]+)\.c\)\((\d+)\),\{appSessionId:n,appVersion:r,auth:i,browserLocale:a,hostBuildFlavor:o,preloadAttribution:s,stableId:c,statsigClientKey:l,systemName:u,systemVersion:d,children:f\}=e,/;
    const asyncMatch = text.match(asyncProviderPattern);
    if (asyncMatch) {
      const [asyncAnchor, functionName, cacheName, cacheSize] = asyncMatch;
      const providerStart = asyncMatch.index ?? text.indexOf(asyncAnchor);
      const providerBody = text.slice(providerStart, providerStart + 8000);
      const statsigClientMatch = providerBody.match(
        /new ([A-Za-z0-9_$]+)\.StatsigClient\(l,t\.user,[A-Za-z0-9_$]+===!0\?[A-Za-z0-9_$]+:([A-Za-z0-9_$]+)\)/,
      );
      const readyProviderMatch = providerBody.match(
        /\(0,([A-Za-z0-9_$]+)\.jsxs\)\(([A-Za-z0-9_$]+),\{appVersion:r,authMethod:i\.authMethod,client:y,deviceId:c,hostBuildFlavor:o,preloadAttribution:s,children:\[[A-Za-z0-9_$]+,f\]\}\)/,
      );
      if (!statsigClientMatch || !readyProviderMatch) {
        throw new Error("Could not find async post-login Statsig provider dependencies");
      }
      const replacement =
        `function ${functionName}(e){let t=(0,${cacheName}.c)(${cacheSize}),{appSessionId:n,appVersion:r,auth:i,browserLocale:a,hostBuildFlavor:o,preloadAttribution:s,stableId:c,statsigClientKey:l,systemName:u,systemVersion:d,children:f}=e;if(globalThis.__CodexPlusRuntimeConfig?.devModeStatsigFallback===true){let CPXStatsigClient=new ${statsigClientMatch[1]}.StatsigClient(l,{userID:i.userId??i.accountUserId??c,email:i.email??void 0,locale:a,customIDs:{...c==null?{}:{stableID:c},...i.accountId==null?{}:{account_id:i.accountId}},appVersion:r},${statsigClientMatch[2]});CPXStatsigClient.initializeSync();return(0,${readyProviderMatch[1]}.jsx)(${readyProviderMatch[2]},{appVersion:r,authMethod:i.authMethod,client:CPXStatsigClient,deviceId:c,hostBuildFlavor:o,preloadAttribution:s,children:f})}let `;
      return replaceOnce(text, asyncAnchor, replacement, "async post-login Statsig dev fallback provider anchor");
    }
...
function patchChatGptStartupAnnouncements(text, context) {
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.61809")) {
    return replaceOnce(text, "function Dul({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Pl.ChatGPT&&t!=null&&t!==Kl.Agent&&t!==Kl.Dev}", "function Dul({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.61809 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.22352")) {
    return replaceOnce(text, "function _ll({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Nl.ChatGPT&&t!=null&&t!==Kl.Agent&&t!==Kl.Dev}", "function _ll({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.22352 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.31338")) {
    return replaceOnce(text, "function wll({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Pl.ChatGPT&&t!=null&&t!==Kl.Agent&&t!==Kl.Dev}", "function wll({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.31338 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.32112")) {
    return replaceOnce(text, "function Tll({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Pl.ChatGPT&&t!=null&&t!==ql.Agent&&t!==ql.Dev}", "function Tll({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.32112 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.41705")) {
    return replaceOnce(text, "function Tul({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Fl.ChatGPT&&t!=null&&t!==ql.Agent&&t!==ql.Dev}", "function Tul({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.41705 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.818.21641")) {
    return replaceOnce(text, "function bcl({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Fl.ChatGPT&&t!=null&&t!==ql.Agent&&t!==ql.Dev}", "function bcl({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.818.21641 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.814.41407")) {
    return replaceOnce(text, "function x9c({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Hl.ChatGPT&&t!=null&&t!==eu.Agent&&t!==eu.Dev}", "function x9c({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.814.41407 ChatGPT migration announcement eligibility anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.41047")) {
    let patched = replaceOnce(text, "function LMc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===tu.ChatGPT&&t!=null&&t!==mu.Agent&&t!==mu.Dev}", "function LMc({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.810.41047 ChatGPT migration announcement eligibility anchor");
    return replaceOnce(patched, "function PNc(e){let t=(0,FNc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,", "function PNc(e){return null;let t=(0,FNc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,", "26.810.41047 ChatGPT model upgrade announcement modal anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.61601")) {
    let patched = replaceOnce(text, "function Efc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===iu.ChatGPT&&t!=null&&t!==_u.Agent&&t!==_u.Dev}", "function Efc({appBrand:e,buildFlavor:t,platform:n}){return false}", "26.803.61601 ChatGPT migration announcement eligibility anchor");
    return replaceOnce(patched, "function jpc(e){let t=(0,Mpc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,", "function jpc(e){return null;let t=(0,Mpc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,", "26.803.61601 ChatGPT model upgrade announcement modal anchor");
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.810.52044")) {
    let patched = replaceOnce(
      text,
      "function BMc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Gl.ChatGPT&&t!=null&&t!==nu.Agent&&t!==nu.Dev}",
      "function BMc({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.810.52044 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function LNc(e){let t=(0,RNc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function LNc(e){return null;let t=(0,RNc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.810.52044 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (context.patchSetId === "chatgpt-26.803.81509-6415") {
    let patched = replaceOnce(
      text,
      "function Gfc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===au.ChatGPT&&t!=null&&t!==vu.Agent&&t!==vu.Dev}",
      "function Gfc({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.803.81509 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function Xpc(e){let t=(0,Zpc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function Xpc(e){return null;let t=(0,Zpc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.803.81509 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.803.41515")) {
    let patched = replaceOnce(
      text,
      "function wfc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===ru.ChatGPT&&t!=null&&t!==gu.Agent&&t!==gu.Dev}",
      "function wfc({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.803.41515 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function kpc(e){let t=(0,Apc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function kpc(e){return null;let t=(0,Apc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.803.41515 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61639")) {
    let patched = replaceOnce(
      text,
      "function nyc({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Sl.ChatGPT&&t!=null&&t!==Ml.Agent&&t!==Ml.Dev}",
      "function nyc({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.730.61639 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function sbc(e){let t=(0,cbc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function sbc(e){return null;let t=(0,cbc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.730.61639 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.730.61309")) {
    let patched = replaceOnce(
      ...
      "function ryc({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.730.61309 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      ...
      "function cbc(e){return null;let t=(0,lbc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.730.61309 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.51351")) {
    let patched = replaceOnce(
      text,
      "function F_c({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Dl.ChatGPT&&t!=null&&t!==Fl.Agent&&t!==Fl.Dev}",
      "function F_c({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.727.51351 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function Bvc(e){let t=(0,Vvc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function Bvc(e){return null;let t=(0,Vvc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.727.51351 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.727.40816")) {
    let patched = replaceOnce(
      text,
      "function P_c({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Dl.ChatGPT&&t!=null&&t!==Fl.Agent&&t!==Fl.Dev}",
      "function P_c({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.727.40816 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function zvc(e){let t=(0,Bvc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function zvc(e){return null;let t=(0,Bvc.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.727.40816 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.41059")) {
    let patched = replaceOnce(
  ...
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.721.30844")) {
    let patched = replaceOnce(
      text,
      "function c9s({appBrand:e,buildFlavor:t,platform:n}){return(n===`macOS`||n===`windows`)&&e===Dl.ChatGPT&&t!=null&&t!==Ll.Agent&&t!==Ll.Dev}",
      "function c9s({appBrand:e,buildFlavor:t,platform:n}){return false}",
      "26.721.30844 ChatGPT migration announcement eligibility anchor",
    );
    return replaceOnce(
      patched,
      "function pec(e){let t=(0,mec.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "function pec(e){return null;let t=(0,mec.c)(26),{announcementSource:n,body:r,dismissAnnouncement:i,model:a,modelName:o,onTryModel:s,showSecondaryAction:c}=e,",
      "26.721.30844 ChatGPT model upgrade announcement modal anchor",
    );
  }
  if (patchSetOwnsTransformVariant(context.patchSetId, "chatgpt-26.715.72028")) {
    return replaceOnce(
