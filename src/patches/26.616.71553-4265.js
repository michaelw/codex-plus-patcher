...
const appMainFile = "webview/assets/app-main-DzXBOHD4.js";
const appShellFile = "webview/assets/app-shell-0b-x_r3Z.js";
const errorBoundaryFile = "webview/assets/error-boundary-BOla93vo.js";
const generalSettingsFile = "webview/assets/general-settings-U7DFIZBC.js";
const sidebarProjectHoverCardSourceRowsFile = "webview/assets/sidebar-project-hover-card-source-rows-DtE7St1r.js";
const threadSidePanelTabsFile = "webview/assets/thread-side-panel-tabs-CLuB2SaS.js";
const userMessageAttachmentsFile = "webview/assets/user-message-attachments-5G1ZKim-.js";
const composerFile = "webview/assets/composer-DlMDPaCL.js";
const localTaskRowFile = "webview/assets/local-task-row-CoPNn6SW.js";
const electronMenuShortcutsFile = "webview/assets/electron-menu-shortcuts-j6UKqTX5.js";
const keyboardShortcutsSearchInputFile = "webview/assets/keyboard-shortcuts-search-input-C1dmntOi.js";
...
function patchThreadSidePanelTabs(text) {
  let patched = replaceOnce(
    ...
    "import{r as vi,t as yi}from\"./dropdown-CTBRoADH.js\";import{t as CPXBranchPickerDropdownContent}from\"./git-branch-picker-dropdown-content-tZj3VhUw.js\";",
...
function patchUserMessageAttachmentsProjectColors(text) {
  let patched = replaceOnce(
    text,
    'import{Aa as x,Ta as S}from"./src-l0hbMZ-p.js";',
    'import{Aa as x,Ta as S}from"./src-l0hbMZ-p.js";import{t as CPX_localThreadKey}from"./sidebar-thread-keys-Ch_amVKz.js";import{s as CPX_threadProjectId}from"./sidebar-thread-row-signals-ZqNv-_WT.js";',
...
function patchComposerProjectColors(text) {
  let patched = replaceOnce(
    text,
    '}from"./thread-context-inputs-B6tQCr7t.js";',
    '}from"./thread-context-inputs-B6tQCr7t.js";import{t as CPX_localThreadKey}from"./sidebar-thread-keys-Ch_amVKz.js";import{s as CPX_threadProjectId}from"./sidebar-thread-row-signals-ZqNv-_WT.js";',
  ...
  patched = replaceOnce(
    ...
    "Rl=(0,Q.jsx)(_n,{onOpen:()=>{Uc.prepare(),X.toggleContextSuggestions()}}),CPX_composerThreadProjectId=a(CPX_threadProjectId,G==null?null:CPX_localThreadKey(G)),CPX_composerProjectStyle=CPX_projectColorStyle(G==null?On?{hostId:On.hostId,path:On.remotePath,projectId:kn,label:On.label??On.name}:x??void 0:CPX_composerThreadProjectId);return",
  ...
  return replaceOnce(
    ...
    "):(0,Q.jsxs)(ah,{className:A,externalFooterVariant:k,inert:Y,isDragActive:Po,layout:Fl,style:!Ge&&!Hn?CPX_composerProjectStyle:void 0,onDragEnter:Ml?void 0:sl,onDragOver:Ml?void 0:dl,onDragLeave:Ml?void 0:ll,onDrop:Ml?void 0:fl,children:",
