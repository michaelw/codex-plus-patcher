...
function patchThreadSidePanelTabs(text) {
  ...
  return replaceOnce(
    patched,
    "children:d&&!u&&c==null?(0,$.jsx)(Oa,{}):(0,$.jsx)(of,{diffRefs:t,diffMode:e,isCappedMode:d,reviewDiffMetrics:g,showReviewGitActions:v})",
    "children:d&&!u&&c==null?(0,$.jsx)(Oa,{}):(0,$.jsx)(CPXReviewMux,{diffRefs:t,diffMode:e,isCappedMode:d,reviewDiffMetrics:g,showReviewGitActions:v})",
    "review diff list mux anchor",
  );
}
